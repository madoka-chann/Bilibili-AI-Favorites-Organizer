...
(function() {
    ...
    if (!_cssLoaded) {
        ...
        fallbackCSS.textContent = `
            :root{--ai-primary:#e06898;--ai-primary-dark:#cf4a80;--ai-primary-light:#f2a5c4;--ai-primary-bg:rgba(224,104,152,0.06);--ai-primary-shadow:rgba(224,104,152,0.2);--ai-success:#10b981;--ai-error:#f43f5e;--ai-info:#6366f1;--ai-warning:#f59e0b;--ai-text:#0f172a;--ai-text-secondary:#334155;--ai-text-muted:#94a3b8;--ai-text-light:#cbd5e1;--ai-border:#e2e8f0;--ai-border-light:#f1f5f9;--ai-border-lighter:#f8fafc;--ai-bg:#fff;--ai-bg-secondary:#f8fafc;--ai-bg-tertiary:#f1f5f9;--ai-bg-hover:rgba(224,104,152,0.04);--ai-header-gradient:linear-gradient(135deg,#e06898,#a78bfa);--ai-modal-backdrop:rgba(2,6,23,0.48);--ai-input-bg:#fff;--ai-font:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;--ai-z-float:2147483640;--ai-z-panel:2147483641;--ai-z-modal:2147483645;--ai-z-particle:2147483646;--ai-radius-xs:6px;--ai-radius-sm:8px;--ai-radius-md:10px;--ai-radius-lg:14px;--ai-radius-xl:18px;--ai-transition:0.25s cubic-bezier(0.4,0,0.2,1);--ai-transition-slow:0.4s cubic-bezier(0.16,1,0.3,1);--ai-scrollbar:#cbd5e1;--ai-scrollbar-hover:#94a3b8;--ai-cat-detail-bg:#f8fafc;--ai-separator:#e2e8f0;--ai-glow-color:rgba(224,104,152,0.06);--ai-badge-new-bg:#f43f5e;--ai-badge-existing-bg:#10b981;--ai-vid-odd-bg:rgba(0,0,0,0.012);--ai-vid-hover-bg:rgba(99,102,241,0.04);--ai-spring:cubic-bezier(0.34,1.56,0.64,1);--ai-spring-gentle:cubic-bezier(0.22,1.1,0.46,1);--ai-spring-bouncy:cubic-bezier(0.175,0.885,0.32,1.275);--ai-ease-out-expo:cubic-bezier(0.16,1,0.3,1);--ai-ease-smooth:cubic-bezier(0.4,0,0,1);--ai-ease-fluid:cubic-bezier(0.25,0.8,0.25,1);--ai-ease-ios:cubic-bezier(0.23,1,0.32,1);}
            #ai-float-btn{position:fixed;bottom:30px;left:30px;z-index:var(--ai-z-float);background:linear-gradient(135deg,#e06898,#c084fc,#818cf8,#38bdf8);background-size:400% 400%;color:#fff;width:56px;height:56px;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 0 16px rgba(224,104,152,0.28),0 0 32px rgba(167,139,250,0.14);border:2px solid rgba(255,255,255,0.25);transition:transform 0.65s var(--ai-spring);}
            #ai-float-btn [data-lucide]{width:24px;height:24px;}
            #ai-sort-wrapper{position:fixed;bottom:30px;left:30px;z-index:var(--ai-z-panel);width:min(396px,calc(100vw - 60px));flex-direction:column;box-shadow:0 20px 60px rgba(0,0,0,0.1),0 8px 24px rgba(0,0,0,0.06);border-radius:24px;overflow:hidden;max-height:85vh;font-family:var(--ai-font);}
            #ai-sort-wrapper [data-lucide]{width:16px;height:16px;stroke-width:2;vertical-align:middle;display:inline-block;}
            .ai-panel-content{background:var(--ai-bg)!important;padding:0;overflow-y:auto;max-height:calc(85vh - 46px);border-bottom-left-radius:24px;border-bottom-right-radius:24px;}
            .ai-header{background:linear-gradient(135deg,#e06898,#a78bfa,#818cf8);background-size:500% 500%;color:#fff;padding:16px 18px;font-weight:600;font-size:14px;display:flex;justify-content:space-between;align-items:center;position:relative;overflow:hidden;}
            ...
            .ai-input:focus{border-color:var(--ai-primary);box-shadow:0 0 0 3px rgba(224,104,152,0.12);}
            ...
            .ai-btn:active{transform:scale(0.94);transition-duration:0.08s;}
            .ai-btn:disabled{opacity:0.4;cursor:not-allowed;}
            .ai-btn-primary{background:linear-gradient(135deg,#e06898,#a78bfa,#818cf8)!important;background-size:400% 400%;color:#fff!important;border:none;font-weight:700;position:relative;overflow:hidden;}
            .ai-btn-primary:hover{box-shadow:0 10px 30px rgba(224,104,152,0.3),0 4px 14px rgba(192,132,252,0.16);}
            .ai-btn-tool{background:var(--ai-bg-tertiary);color:var(--ai-text-secondary);font-size:11px;font-weight:500;}
            .ai-btn-tool:hover{transform:translateY(-2px) scale(1.03);box-shadow:0 6px 20px rgba(224,104,152,0.1);}
            ...
            .ai-modal-backdrop{position:fixed;inset:0;background:var(--ai-modal-backdrop)!important;z-index:var(--ai-z-modal);display:flex;align-items:center;justify-content:center;font-family:var(--ai-font);backdrop-filter:blur(14px) saturate(1.4);}
            .ai-modal{background:var(--ai-bg)!important;color:var(--ai-text)!important;border-radius:26px;box-shadow:0 40px 100px rgba(0,0,0,0.18),0 16px 40px rgba(0,0,0,0.1);width:min(600px,90vw);max-height:70vh;display:flex;flex-direction:column;overflow:hidden;}
            .ai-modal-header{padding:18px 22px;display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid rgba(255,255,255,0.06);background:linear-gradient(135deg,#e06898,#a78bfa,#818cf8);background-size:500% 500%;color:#fff;position:relative;overflow:hidden;}
            ...
            .ai-cat-block{animation:ai-slide-in 0.5s var(--ai-ease-ios) both;animation-delay:calc(var(--i,0)*0.04s);}
            .ai-cat-row{display:flex;align-items:center;gap:10px;padding:13px 20px;border-bottom:1px solid var(--ai-border-lighter);border-left:3px solid var(--ai-primary);cursor:pointer;position:relative;overflow:hidden;transition:all 0.4s var(--ai-ease-ios);}
            .ai-cat-row:hover{background:var(--ai-bg-hover);transform:translateX(2px);}
            ...
            .ai-cat-badge{font-size:10px;color:#fff;background:linear-gradient(135deg,#f43f5e,#e11d48);padding:2px 10px;border-radius:10px;font-weight:600;}
            ...
            @keyframes ai-slide-in{0%{transform:translateX(28px) scale(0.96);opacity:0}50%{transform:translateX(-3px) scale(1.008);opacity:1}100%{transform:translateX(0) scale(1);opacity:1}}
