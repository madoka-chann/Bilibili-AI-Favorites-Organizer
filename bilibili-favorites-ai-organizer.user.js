...
(function() {
    ...
    if (!_cssLoaded) {
        ...
        fallbackCSS.textContent = `
            :root{--ai-primary:#7B93FF;--ai-primary-dark:#5B6FE6;--ai-primary-light:#B4C2FF;--ai-primary-bg:rgba(123,147,255,0.06);--ai-primary-shadow:rgba(123,147,255,0.22);--ai-success:#34d399;--ai-error:#f472b6;--ai-info:#818cf8;--ai-warning:#fbbf24;--ai-text:#0f172a;--ai-text-secondary:#334155;--ai-text-muted:#94a3b8;--ai-text-light:#cbd5e1;--ai-border:#e2e8f0;--ai-border-light:#f1f5f9;--ai-border-lighter:#f8fafc;--ai-bg:#fff;--ai-bg-secondary:#f8fafc;--ai-bg-tertiary:#f1f5f9;--ai-bg-hover:rgba(123,147,255,0.04);--ai-header-gradient:linear-gradient(135deg,#7B93FF,#A78BFA);--ai-modal-backdrop:rgba(15,23,42,0.55);--ai-input-bg:#fff;--ai-font:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;--ai-z-float:2147483640;--ai-z-panel:2147483641;--ai-z-modal:2147483645;--ai-z-particle:2147483646;--ai-radius-xs:6px;--ai-radius-sm:8px;--ai-radius-md:10px;--ai-radius-lg:14px;--ai-radius-xl:18px;--ai-transition:0.25s cubic-bezier(0.4,0,0.2,1);--ai-transition-slow:0.4s cubic-bezier(0.16,1,0.3,1);--ai-scrollbar:#cbd5e1;--ai-scrollbar-hover:#94a3b8;--ai-cat-detail-bg:#f8fafc;--ai-separator:#e2e8f0;--ai-glow-color:rgba(123,147,255,0.07);--ai-badge-new-bg:#f472b6;--ai-badge-existing-bg:#34d399;--ai-vid-odd-bg:rgba(15,23,42,0.012);--ai-vid-hover-bg:rgba(123,147,255,0.05);--ai-spring:cubic-bezier(0.32,1.48,0.62,1);--ai-spring-gentle:cubic-bezier(0.20,1.04,0.42,1);--ai-spring-bouncy:cubic-bezier(0.165,0.84,0.28,1.18);--ai-ease-out-expo:cubic-bezier(0.14,1,0.28,1);--ai-ease-smooth:cubic-bezier(0.38,0,0,1);--ai-ease-fluid:cubic-bezier(0.22,0.78,0.22,1);--ai-ease-ios:cubic-bezier(0.2,0.98,0.28,1);--ai-ease-magnetic:cubic-bezier(0.18,0.88,0.28,1.08);}
            #ai-float-btn{position:fixed;bottom:30px;left:30px;z-index:var(--ai-z-float);background:linear-gradient(135deg,#7B93FF,#A78BFA,#818cf8,#67e8f9,#6ee7b7,#c4b5fd);background-size:500% 500%;color:#fff;width:56px;height:56px;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 0 20px rgba(123,147,255,0.28),0 0 40px rgba(167,139,250,0.14);border:2px solid rgba(255,255,255,0.28);transition:transform 0.7s var(--ai-spring);}
            ...
            .ai-header{background:linear-gradient(135deg,#7B93FF,#c4b5fd,#A78BFA,#67e8f9,#818cf8,#6ee7b7,#c4b5fd);background-size:700% 700%;color:#fff;padding:16px 18px;font-weight:600;font-size:14px;display:flex;justify-content:space-between;align-items:center;position:relative;overflow:hidden;}
            ...
            .ai-group-header:hover{background:linear-gradient(135deg,var(--ai-primary-bg),rgba(167,139,250,0.05));color:var(--ai-primary);}
            ...
            .ai-input:focus{border-color:var(--ai-primary);box-shadow:0 0 0 3px rgba(123,147,255,0.12);}
            ...
            .ai-btn-primary{background:linear-gradient(135deg,#7B93FF,#c4b5fd,#A78BFA,#818cf8)!important;background-size:500% 500%;color:#fff!important;border:none;font-weight:700;position:relative;overflow:hidden;}
            .ai-btn-primary:hover{box-shadow:0 12px 32px rgba(123,147,255,0.30),0 5px 16px rgba(167,139,250,0.16);}
            .ai-btn-tool{background:var(--ai-bg-tertiary);color:var(--ai-text-secondary);font-size:11px;font-weight:500;}
            .ai-btn-tool:hover{transform:translateY(-3px) scale(1.045);box-shadow:0 10px 28px rgba(123,147,255,0.12);}
            ...
            .ai-modal-header{padding:18px 22px;display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid rgba(255,255,255,0.08);background:linear-gradient(135deg,#7B93FF,#c4b5fd,#A78BFA,#818cf8);background-size:600% 600%;color:#fff;position:relative;overflow:hidden;}
            ...
            .ai-cat-badge{font-size:10px;color:#fff;background:linear-gradient(135deg,#f472b6,#ec4899);padding:2px 11px;border-radius:10px;font-weight:600;}
            .ai-cat-existing{font-size:10px;color:#fff;background:linear-gradient(135deg,#34d399,#6ee7b7);padding:2px 11px;border-radius:10px;font-weight:600;}
            ...
            .ai-filter-btn.active{background:linear-gradient(135deg,#7B93FF,#c4b5fd,#A78BFA);color:#fff;border-color:transparent;box-shadow:0 5px 18px rgba(123,147,255,0.22);}
            ...
            .ai-ripple-dot{position:absolute;width:20px;height:20px;border-radius:50%;background:rgba(123,147,255,0.22);pointer-events:none;z-index:2;}
            ...
            @keyframes ai-breathe{0%,100%{box-shadow:0 4px 14px var(--ai-primary-shadow)}50%{box-shadow:0 4px 28px rgba(123,147,255,0.45)}}
            ...
            .ai-countdown-bubble{position:fixed;z-index:2147483647;background:linear-gradient(135deg,#7B93FF,#c4b5fd,#A78BFA);color:#fff;font-size:11px;font-weight:bold;padding:4px 12px;border-radius:14px;white-space:nowrap;pointer-events:none;animation:ai-bubble-pop 0.45s cubic-bezier(0.175,0.885,0.32,1.275) forwards;box-shadow:0 4px 16px rgba(123,147,255,0.32),0 0 0 2px rgba(255,255,255,0.5);line-height:1.4;letter-spacing:0.5px;}
...
h1{text-align:center;color:#7B93FF;margin-bottom:4px;}
...
.summary-card .num{font-size:28px;font-weight:bold;color:#7B93FF;}
.summary-card .label{font-size:11px;color:#999;margin-top:4px;}
.section{margin-bottom:30px;}
.section h2{font-size:16px;border-bottom:2px solid #7B93FF;padding-bottom:6px;margin-bottom:12px;}
    ...
    function renderPreview(allCategories, existingFoldersMap, videoIdMap, sourceMediaId, biliData, crossFolderDups) {
        return new Promise(resolve => {
            ...
            for (const [catName, vids] of catEntries) {
                ...
                <div class="ai-cat-block" data-catname="${safeKey}" data-isnew="${isNew}" style="${animSettings.animEnabled ? '--i:' + catIdx : 'animation:none'}">
                    <div class="ai-cat-row">
                        ...
                        <input type="checkbox" class="ai-mc-check" data-cat="${safeKey}" data-count="${vids.length}" checked style="width:16px;height:16px;cursor:pointer;accent-color:#7B93FF;">
            ...
            <div class="ai-modal">
                ...
                <div class="ai-modal-toolbar" style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
                    ...
                    <label style="display:flex;align-items:center;gap:4px;font-size:12px;color:#666;white-space:nowrap;cursor:pointer;">
                        <input type="checkbox" id="ai-mc-selectall" checked style="width:15px;height:15px;accent-color:#7B93FF;"> 全选
                    </label>
            ...
            function spawnParticles(x, y) {
                if (!animSettings.animEnabled) return;
                const colors = ['#7B93FF', '#A78BFA', '#818cf8', '#67e8f9', '#6ee7b7', '#fbbf24', '#c4b5fd', '#34d399', '#a5b4fc', '#f9a8d4'];
                const count = 36;
...
其中 conf 是你对该分类的置信度(0-1)，1表示非常确定，0.5表示不太确定。`;
    ...
    function resetMainButton() {
        ...
        if (btn) {
            ...
            if (typeof lucide !== 'undefined') lucide.createIcons({nodes:[btn]});
            btn.style.background = 'linear-gradient(135deg, #7B93FF, #A78BFA)';
            btn.disabled = false;
    ...
    function launchConfetti(x, y, count = 60) {
        const colors = ['#7B93FF', '#A78BFA', '#818cf8', '#67e8f9', '#6ee7b7', '#fbbf24', '#f472b6', '#c4b5fd', '#34d399', '#f9a8d4', '#a5b4fc', '#6366f1'];
            ...
            <div class="ai-panel-content">
                ...
                <div id="ai-settings-area" class="ai-settings">
                    ...
                    <div class="ai-group-header" data-group="ai-group-1">
                        <span class="ai-group-icon" style="background:rgba(123,147,255,0.08);color:#7B93FF;"><i data-lucide="cpu" style="width:13px;height:13px;"></i></span>
                            ...
                            <div style="flex:1;position:relative;">
                                ...
                                <div id="ai-model-dropdown" style="display:none;position:absolute;left:0;right:0;top:100%;margin-top:4px;border:1px solid var(--ai-primary);border-radius:6px;background:var(--ai-bg);overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,0.15);z-index:10;">
                                    <div style="display:flex;border-bottom:1px solid #eee;">
                                        ...
                                        <button id="ai-model-custom-confirm" class="ai-btn" style="border:none;border-radius:0;padding:6px 10px;font-size:11px;color:#7B93FF;">确定</button>
                                    </div>
