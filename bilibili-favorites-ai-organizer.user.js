...
(function() {
    ...
    if (!_cssLoaded) {
        ...
        fallbackCSS.textContent = `
            :root{--ai-primary:#e0628e;--ai-primary-dark:#d14578;--ai-primary-light:#f4a3be;--ai-primary-bg:rgba(224,98,142,0.06);--ai-primary-shadow:rgba(224,98,142,0.22);--ai-success:#10b981;--ai-error:#f43f5e;--ai-info:#7c6df6;--ai-warning:#f59e0b;--ai-text:#0c1220;--ai-text-secondary:#2d3a4e;--ai-text-muted:#8694a8;--ai-text-light:#c1cad6;--ai-border:#dfe5ed;--ai-border-light:#eef2f7;--ai-border-lighter:#f6f8fb;--ai-bg:#fff;--ai-bg-secondary:#f7f9fc;--ai-bg-tertiary:#eef2f7;--ai-bg-hover:rgba(224,98,142,0.04);--ai-header-gradient:linear-gradient(135deg,#e0628e,#9f7aea);--ai-modal-backdrop:rgba(6,10,28,0.52);--ai-input-bg:#fff;--ai-font:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;--ai-z-float:2147483640;--ai-z-panel:2147483641;--ai-z-modal:2147483645;--ai-z-particle:2147483646;--ai-radius-xs:6px;--ai-radius-sm:8px;--ai-radius-md:10px;--ai-radius-lg:14px;--ai-radius-xl:18px;--ai-transition:0.25s cubic-bezier(0.4,0,0.2,1);--ai-transition-slow:0.4s cubic-bezier(0.16,1,0.3,1);--ai-scrollbar:#c1cad6;--ai-scrollbar-hover:#8694a8;--ai-cat-detail-bg:#f7f9fc;--ai-separator:#dfe5ed;--ai-glow-color:rgba(224,98,142,0.07);--ai-badge-new-bg:#f43f5e;--ai-badge-existing-bg:#10b981;--ai-vid-odd-bg:rgba(0,0,0,0.014);--ai-vid-hover-bg:rgba(124,109,246,0.045);--ai-spring:cubic-bezier(0.34,1.56,0.64,1);--ai-spring-gentle:cubic-bezier(0.22,1.08,0.44,1);--ai-spring-bouncy:cubic-bezier(0.175,0.885,0.32,1.275);--ai-ease-out-expo:cubic-bezier(0.16,1,0.3,1);--ai-ease-smooth:cubic-bezier(0.4,0,0,1);--ai-ease-fluid:cubic-bezier(0.25,0.8,0.25,1);--ai-ease-ios:cubic-bezier(0.23,1,0.32,1);--ai-ease-magnetic:cubic-bezier(0.2,0.9,0.3,1.1);}
            #ai-float-btn{position:fixed;bottom:30px;left:30px;z-index:var(--ai-z-float);background:linear-gradient(135deg,#e0628e,#c77dff,#7c6df6,#36b5f4,#2dd4a8);background-size:500% 500%;color:#fff;width:56px;height:56px;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 0 18px rgba(224,98,142,0.3),0 0 36px rgba(159,122,234,0.15);border:2px solid rgba(255,255,255,0.28);transition:transform 0.7s var(--ai-spring);}
            #ai-float-btn [data-lucide]{width:24px;height:24px;}
            #ai-sort-wrapper{position:fixed;bottom:30px;left:30px;z-index:var(--ai-z-panel);width:min(400px,calc(100vw - 60px));flex-direction:column;box-shadow:0 24px 68px rgba(0,0,0,0.11),0 10px 28px rgba(0,0,0,0.07);border-radius:26px;overflow:hidden;max-height:85vh;font-family:var(--ai-font);}
            ...
            .ai-header{background:linear-gradient(135deg,#e0628e,#c77dff,#9f7aea,#7c6df6);background-size:600% 600%;color:#fff;padding:16px 18px;font-weight:600;font-size:14px;display:flex;justify-content:space-between;align-items:center;position:relative;overflow:hidden;}
            ...
            .ai-group-header:hover{background:linear-gradient(135deg,var(--ai-primary-bg),rgba(159,122,234,0.05));color:var(--ai-primary);}
            ...
            .ai-input:focus{border-color:var(--ai-primary);box-shadow:0 0 0 3px rgba(224,98,142,0.12);}
            ...
            .ai-btn-primary{background:linear-gradient(135deg,#e0628e,#c77dff,#9f7aea,#7c6df6)!important;background-size:500% 500%;color:#fff!important;border:none;font-weight:700;position:relative;overflow:hidden;}
            .ai-btn-primary:hover{box-shadow:0 12px 32px rgba(224,98,142,0.32),0 5px 16px rgba(199,125,255,0.18);}
            .ai-btn-tool{background:var(--ai-bg-tertiary);color:var(--ai-text-secondary);font-size:11px;font-weight:500;}
            .ai-btn-tool:hover{transform:translateY(-3px) scale(1.045);box-shadow:0 10px 28px rgba(224,98,142,0.13);}
            ...
            .ai-modal-header{padding:18px 22px;display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid rgba(255,255,255,0.08);background:linear-gradient(135deg,#e0628e,#c77dff,#9f7aea,#7c6df6);background-size:600% 600%;color:#fff;position:relative;overflow:hidden;}
            ...
            .ai-modal-btn-confirm{background:linear-gradient(135deg,#059669,#10b981,#2dd4a8)!important;color:#fff;}
            ...
            .ai-cat-badge{font-size:10px;color:#fff;background:linear-gradient(135deg,#f43f5e,#e11d48);padding:2px 11px;border-radius:10px;font-weight:600;}
            .ai-cat-existing{font-size:10px;color:#fff;background:linear-gradient(135deg,#10b981,#2dd4a8);padding:2px 11px;border-radius:10px;font-weight:600;}
            ...
            .ai-filter-btn.active{background:linear-gradient(135deg,#e0628e,#c77dff,#9f7aea);color:#fff;border-color:transparent;box-shadow:0 5px 18px rgba(224,98,142,0.25);}
            ...
            .ai-ripple-dot{position:absolute;width:20px;height:20px;border-radius:50%;background:rgba(224,98,142,0.25);pointer-events:none;z-index:2;}
            ...
            @keyframes ai-breathe{0%,100%{box-shadow:0 4px 14px var(--ai-primary-shadow)}50%{box-shadow:0 4px 28px rgba(224,98,142,0.48)}}
            ...
            .ai-countdown-bubble{position:fixed;z-index:2147483647;background:linear-gradient(135deg,#e0628e,#c77dff,#9f7aea);color:#fff;font-size:11px;font-weight:bold;padding:4px 12px;border-radius:14px;white-space:nowrap;pointer-events:none;animation:ai-bubble-pop 0.45s cubic-bezier(0.175,0.885,0.32,1.275) forwards;box-shadow:0 4px 16px rgba(224,98,142,0.35),0 0 0 2px rgba(255,255,255,0.5);line-height:1.4;letter-spacing:0.5px;}
            .ai-countdown-bubble::after{content:'';position:absolute;bottom:-6px;left:50%;transform:translateX(-50%);border:6px solid transparent;border-top-color:#9f7aea;}
...
h1{text-align:center;color:#e0628e;margin-bottom:4px;}
...
.summary-card .num{font-size:28px;font-weight:bold;color:#e0628e;}
.summary-card .label{font-size:11px;color:#999;margin-top:4px;}
.section{margin-bottom:30px;}
.section h2{font-size:16px;border-bottom:2px solid #e0628e;padding-bottom:6px;margin-bottom:12px;}
    ...
    function renderPreview(allCategories, existingFoldersMap, videoIdMap, sourceMediaId, biliData, crossFolderDups) {
        return new Promise(resolve => {
            ...
            for (const [catName, vids] of catEntries) {
                ...
                <div class="ai-cat-block" data-catname="${safeKey}" data-isnew="${isNew}" style="${animSettings.animEnabled ? '--i:' + catIdx : 'animation:none'}">
                    <div class="ai-cat-row">
                        ...
                        <input type="checkbox" class="ai-mc-check" data-cat="${safeKey}" data-count="${vids.length}" checked style="width:16px;height:16px;cursor:pointer;accent-color:#e0628e;">
            ...
            <div class="ai-modal">
                ...
                <div class="ai-modal-toolbar" style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
                    ...
                    <label style="display:flex;align-items:center;gap:4px;font-size:12px;color:#666;white-space:nowrap;cursor:pointer;">
                        <input type="checkbox" id="ai-mc-selectall" checked style="width:15px;height:15px;accent-color:#e0628e;"> 全选
                    </label>
            ...
            function spawnParticles(x, y) {
                if (!animSettings.animEnabled) return;
                const colors = ['#e0628e', '#c77dff', '#7c6df6', '#2dd4a8', '#36b5f4', '#ffc04a', '#9f7aea', '#36e0a0', '#9094ff', '#f5a0c8'];
                const count = 36;
...
其中 conf 是你对该分类的置信度(0-1)，1表示非常确定，0.5表示不太确定。`;
    ...
    function resetMainButton() {
        ...
        if (btn) {
            ...
            if (typeof lucide !== 'undefined') lucide.createIcons({nodes:[btn]});
            btn.style.background = 'linear-gradient(135deg, #e0628e, #9f7aea)';
            btn.disabled = false;
    ...
    function launchConfetti(x, y, count = 60) {
        const colors = ['#e0628e', '#c77dff', '#7c6df6', '#2dd4a8', '#36b5f4', '#ffc04a', '#f87088', '#9f7aea', '#36e0a0', '#f5a0c8', '#9094ff', '#7c6df6'];
            ...
            <div class="ai-panel-content">
                ...
                <div id="ai-settings-area" class="ai-settings">
                    ...
                    <div class="ai-group-header" data-group="ai-group-1">
                        <span class="ai-group-icon" style="background:rgba(224,98,142,0.08);color:#e0628e;"><i data-lucide="cpu" style="width:13px;height:13px;"></i></span>
                            ...
                            <div style="flex:1;position:relative;">
                                ...
                                <div id="ai-model-dropdown" style="display:none;position:absolute;left:0;right:0;top:100%;margin-top:4px;border:1px solid var(--ai-primary);border-radius:6px;background:var(--ai-bg);overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,0.15);z-index:10;">
                                    <div style="display:flex;border-bottom:1px solid #eee;">
                                        ...
                                        <button id="ai-model-custom-confirm" class="ai-btn" style="border:none;border-radius:0;padding:6px 10px;font-size:11px;color:#e0628e;">确定</button>
                                    </div>
