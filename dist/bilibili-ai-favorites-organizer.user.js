...
(function (gsap) {
  ...
  importCSS(' .float-btn.svelte-ayaw0q{position:fixed;bottom:30px;left:30px;z-index:2147483640;width:58px;height:58px;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;color:#fff;background:linear-gradient(135deg,var(--ai-primary),var(--ai-gradient-accent),var(--ai-primary-light),var(--ai-primary));background-size:300% 300%;border:2px solid rgba(255,255,255,.28);box-shadow:0 0 14px rgba(var(--ai-primary-rgb),.18),0 0 28px #9b59f614;will-change:transform,box-shadow,border-radius;-webkit-user-select:none;user-select:none;touch-action:none}.float-btn.svelte-ayaw0q:before{content:"";position:absolute;top:-4px;right:-4px;bottom:-4px;left:-4px;border-radius:50%;border:1.5px solid rgba(var(--ai-primary-rgb, 115, 100, 255),.3);animation:svelte-ayaw0q-breathRing 3s ease-in-out infinite;pointer-events:none}.float-btn.svelte-ayaw0q:active{box-shadow:0 0 8px rgba(var(--ai-primary-rgb),.1),inset 0 2px 6px #0003!important;transition:box-shadow .08s ease}.float-btn.svelte-ayaw0q:after{content:"\u70B9\u51FB\u6253\u5F00";position:absolute;bottom:-28px;left:50%;transform:translate(-50%);font-size:10px;color:#fff;background:#000000b3;padding:3px 8px;border-radius:6px;white-space:nowrap;pointer-events:none;opacity:0;animation:svelte-ayaw0q-tooltipFadeIn .4s ease 3s both;-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px)}.float-btn.svelte-ayaw0q:hover:after,.float-btn.svelte-ayaw0q:active:after{opacity:0;animation:none}.float-btn.svelte-ayaw0q svg{transition:transform .3s cubic-bezier(.2,.98,.28,1)}.float-btn.svelte-ayaw0q:hover svg{transform:rotate(12deg) scale(1.1)}.float-btn.svelte-ayaw0q:hover{background-position:100% 100%}@keyframes svelte-ayaw0q-breathRing{0%,to{transform:scale(1);opacity:.4}50%{transform:scale(1.35);opacity:0}}@keyframes svelte-ayaw0q-tooltipFadeIn{0%{opacity:0;transform:translate(-50%) translateY(4px)}to{opacity:1;transform:translate(-50%) translateY(0)}}@media(prefers-reduced-motion:reduce){.float-btn.svelte-ayaw0q:before{animation:none;display:none}.float-btn.svelte-ayaw0q:after{animation:none;display:none}.float-btn.svelte-ayaw0q svg{transition:none}.float-btn.svelte-ayaw0q:hover svg{transform:none}.float-btn.svelte-ayaw0q:active{box-shadow:none!important}}.float-btn.hidden.svelte-ayaw0q{visibility:hidden;opacity:0;pointer-events:none}.orbits.svelte-ayaw0q{position:absolute;top:50%;left:50%;width:0;height:0;pointer-events:none;overflow:visible}.header.svelte-oiwvqb{background:linear-gradient(135deg,var(--ai-primary),var(--ai-gradient-accent),var(--ai-primary));background-size:400% 400%;animation:svelte-oiwvqb-aurora-flow 18s ease-in-out infinite;color:#fff;padding:16px 18px;font-weight:600;font-size:14px;display:flex;justify-content:space-between;align-items:center;position:relative;overflow:hidden;border-top-left-radius:28px;border-top-right-radius:28px;cursor:grab}.header.svelte-oiwvqb:before{content:"";position:absolute;left:50%;bottom:6px;width:18px;height:6px;transform:translate(-50%);background:radial-gradient(circle,rgba(255,255,255,.25) 1px,transparent 1px);background-size:6px 4px;opacity:.4;transition:opacity .25s ease,width .3s cubic-bezier(.2,.98,.28,1);pointer-events:none;z-index:1}.header.svelte-oiwvqb:hover:before{opacity:.7;width:28px}.header.svelte-oiwvqb:active{cursor:grabbing}.header.svelte-oiwvqb:active:before{opacity:1;width:36px}.header-title.svelte-oiwvqb{display:flex;align-items:center;gap:7px}.header-title.svelte-oiwvqb>span:where(.svelte-oiwvqb):first-child{background:linear-gradient(90deg,#fff,#fff 40%,#ffffff80,#fff 60%,#fff);background-size:200% 100%;-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;animation:svelte-oiwvqb-titleShimmer 6s ease-in-out infinite,svelte-oiwvqb-titleGlow 6s ease-in-out infinite;letter-spacing:0;transition:letter-spacing .4s cubic-bezier(.2,.98,.28,1)}.header-title.svelte-oiwvqb>span:where(.svelte-oiwvqb):first-child:hover{letter-spacing:.06em}.version.svelte-oiwvqb{font-size:10px;opacity:.7;background:#ffffff26;padding:1px 6px;border-radius:8px;animation:svelte-oiwvqb-versionPop .4s cubic-bezier(.2,1,.4,1) both;transition:transform .25s ease,opacity .25s ease,letter-spacing .3s ease,box-shadow .25s ease;cursor:default;position:relative;overflow:hidden}.version.svelte-oiwvqb:after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(105deg,transparent 35%,rgba(255,255,255,.25) 50%,transparent 65%);animation:svelte-oiwvqb-versionShimmer 4s ease-in-out 1s infinite;pointer-events:none}.version.svelte-oiwvqb:hover{transform:scale(1.08);opacity:.95;letter-spacing:.03em;box-shadow:0 0 10px #fff3}.header-actions.svelte-oiwvqb{display:flex;gap:8px;align-items:center;position:relative;z-index:1}.header-actions.svelte-oiwvqb:before{content:"";position:absolute;bottom:-2px;left:4px;right:4px;height:1px;background:linear-gradient(90deg,transparent,rgba(255,255,255,.35),transparent);transform:scaleX(0);transition:transform .3s cubic-bezier(.2,.98,.28,1);pointer-events:none}.header-actions.svelte-oiwvqb:hover:before{transform:scaleX(1)}.header-btn.svelte-oiwvqb{padding:5px;border:1px solid rgba(255,255,255,.08);background:#ffffff1f;color:#fff;border-radius:8px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background .2s ease}.header-btn.svelte-oiwvqb:hover{background:#ffffff4d}.header-btn.active.svelte-oiwvqb{background:#ffffff59;box-shadow:inset 0 1px 4px #00000026;position:relative}.header-btn.active.svelte-oiwvqb:after{content:"";position:absolute;bottom:-3px;left:50%;width:4px;height:4px;border-radius:50%;background:#fff;box-shadow:0 0 6px #fff9;transform:translate(-50%);animation:svelte-oiwvqb-dotPop .3s cubic-bezier(.2,.98,.28,1) both}@keyframes svelte-oiwvqb-dotPop{0%{transform:translate(-50%) scale(0)}to{transform:translate(-50%) scale(1)}}.header-btn.svelte-oiwvqb:last-child:hover{background:#ef44444d}.header-btn.svelte-oiwvqb:last-child svg{transition:transform .3s cubic-bezier(.2,.98,.28,1)}.header-btn.svelte-oiwvqb:last-child:hover svg{transform:rotate(90deg)}.settings-icon.svelte-oiwvqb{display:flex;align-items:center;justify-content:center;transition:transform .5s cubic-bezier(.2,1,.4,1)}.settings-icon.open.svelte-oiwvqb{transform:rotate(180deg)}@keyframes svelte-oiwvqb-aurora-flow{0%,to{background-position:0% 50%}25%{background-position:100% 25%}50%{background-position:50% 100%}75%{background-position:0% 75%}}@keyframes svelte-oiwvqb-titleShimmer{0%,to{background-position:200% 0}50%{background-position:-200% 0}}@keyframes svelte-oiwvqb-titleGlow{0%,35%,65%,to{text-shadow:none}50%{text-shadow:var(--ai-glow-title)}}@keyframes svelte-oiwvqb-versionPop{0%{transform:scale(0);opacity:0}70%{transform:scale(1.1)}to{transform:scale(1);opacity:.7}}@keyframes svelte-oiwvqb-versionShimmer{0%,to{transform:translate(-100%)}50%{transform:translate(100%)}}@media(prefers-reduced-motion:reduce){.header-title.svelte-oiwvqb>span:where(.svelte-oiwvqb):first-child{animation:none;-webkit-text-fill-color:#fff;transition:none;text-shadow:none}.header-title.svelte-oiwvqb>span:where(.svelte-oiwvqb):first-child:hover{letter-spacing:0}.header.svelte-oiwvqb:before{display:none}.version.svelte-oiwvqb{animation:none;transition:none}.version.svelte-oiwvqb:after{animation:none;display:none}.version.svelte-oiwvqb:hover{transform:none;letter-spacing:0;box-shadow:none}.settings-icon.svelte-oiwvqb{transition:none}.header-btn.active.svelte-oiwvqb{box-shadow:none}.header-btn.active.svelte-oiwvqb:after{animation:none}.header-actions.svelte-oiwvqb:before{display:none}.header-btn.svelte-oiwvqb:last-child svg{transition:none}.header-btn.svelte-oiwvqb:last-child:hover svg{transform:none}}.group.svelte-w9qm3w{margin-bottom:2px;overflow:hidden}.group-header.svelte-w9qm3w{display:flex;align-items:center;gap:8px;padding:9px 10px;cursor:pointer;font-size:12px;font-weight:600;color:var(--ai-text-secondary);-webkit-user-select:none;user-select:none;border-radius:10px;transition:all .3s cubic-bezier(.2,.98,.28,1);background:transparent;border:none;width:100%;text-align:left;position:relative}.group-header.svelte-w9qm3w:before{content:"";position:absolute;bottom:2px;left:10px;right:10px;height:1.5px;background:var(--ai-divider-gradient);border-radius:1px;transform:scaleX(0);transform-origin:left;transition:transform .3s cubic-bezier(.2,.98,.28,1)}.group-header.svelte-w9qm3w:hover:before{transform:scaleX(1)}.group-header.svelte-w9qm3w:hover{background:var(--ai-primary-bg);color:var(--ai-primary)}.group-header.svelte-w9qm3w:hover .group-icon:where(.svelte-w9qm3w){filter:brightness(1.2)}.group.open.svelte-w9qm3w .group-header:where(.svelte-w9qm3w):after{content:"";position:absolute;bottom:-1px;left:20px;right:20px;height:1px;background:linear-gradient(90deg,transparent,var(--ai-primary-light),transparent);opacity:.4;animation:svelte-w9qm3w-headerRippleExpand .6s cubic-bezier(.2,.98,.28,1) both}@keyframes svelte-w9qm3w-headerRippleExpand{0%{transform:scaleX(0);opacity:.6}70%{transform:scaleX(1.15);opacity:.4}to{transform:scaleX(1);opacity:.4}}.group-icon.svelte-w9qm3w{width:22px;height:22px;border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:filter .25s ease,transform .3s ease,box-shadow .3s ease}.group.open.svelte-w9qm3w .group-icon:where(.svelte-w9qm3w){box-shadow:0 0 8px rgba(var(--ai-primary-rgb),.3);animation:svelte-w9qm3w-iconBreathGlow 3s ease-in-out infinite}@keyframes svelte-w9qm3w-iconBreathGlow{0%,to{box-shadow:0 0 8px rgba(var(--ai-primary-rgb),.3)}50%{box-shadow:var(--ai-glow-icon-breath),0 0 14px rgba(var(--ai-primary-rgb),.15)}}.group-title.svelte-w9qm3w{flex:1;transition:transform .25s cubic-bezier(.2,.98,.28,1)}.group-header.svelte-w9qm3w:hover .group-title:where(.svelte-w9qm3w){transform:translate(2px)}.chevron.svelte-w9qm3w{display:flex;color:var(--ai-text-muted);transition:color .25s ease}.group-header.svelte-w9qm3w:hover .chevron:where(.svelte-w9qm3w){color:var(--ai-primary)}.group-body.svelte-w9qm3w{padding:0 2px 8px;height:0;overflow:hidden;transition:box-shadow .3s ease}.group.open.svelte-w9qm3w .group-body:where(.svelte-w9qm3w){box-shadow:var(--ai-shadow-inset);border-radius:0 0 8px 8px}@media(prefers-reduced-motion:reduce){.group.open.svelte-w9qm3w .group-header:where(.svelte-w9qm3w):after{animation:none;opacity:.5}.group-header.svelte-w9qm3w:before{transition:none}.group-icon.svelte-w9qm3w{transition:none}.group.open.svelte-w9qm3w .group-icon:where(.svelte-w9qm3w){transform:none;box-shadow:none;animation:none}.group-title.svelte-w9qm3w{transition:none}.group-header.svelte-w9qm3w:hover .group-title:where(.svelte-w9qm3w){transform:none}.chevron.svelte-w9qm3w,.group-body.svelte-w9qm3w{transition:none}.group.open.svelte-w9qm3w .group-body:where(.svelte-w9qm3w){box-shadow:none}}.bfao-icon-btn.svelte-1rt0kwk svg{transition:transform .2s cubic-bezier(.2,.98,.28,1)}.bfao-icon-btn.svelte-1rt0kwk:active svg{transform:scale(.8)}.bfao-icon-btn.svelte-1rt0kwk .spinning{animation:svelte-1rt0kwk-spin .8s linear infinite;filter:drop-shadow(0 0 4px rgba(var(--ai-primary-rgb),.5))}@keyframes svelte-1rt0kwk-spin{to{transform:rotate(360deg)}}.bfao-icon-btn.test-success.svelte-1rt0kwk,.bfao-icon-btn.test-error.svelte-1rt0kwk{position:relative;overflow:visible}.bfao-icon-btn.test-success.svelte-1rt0kwk:after,.bfao-icon-btn.test-error.svelte-1rt0kwk:after{content:"";position:absolute;top:-2px;right:-2px;bottom:-2px;left:-2px;width:auto;height:auto;background:none;border-radius:10px;pointer-events:none;transform:scaleX(1);animation:svelte-1rt0kwk-testRadialPulse .6s cubic-bezier(.2,.98,.28,1) both}.bfao-icon-btn.test-success.svelte-1rt0kwk:after{border:2px solid var(--ai-success)}.bfao-icon-btn.test-error.svelte-1rt0kwk:after{border:2px solid var(--ai-error)}@keyframes svelte-1rt0kwk-testRadialPulse{0%{transform:scale(1);opacity:.6}to{transform:scale(1.6);opacity:0}}.bfao-icon-btn.test-success.svelte-1rt0kwk{color:var(--ai-success-dark);background:var(--ai-success-bg);border-color:var(--ai-success);animation:svelte-1rt0kwk-testPop .35s cubic-bezier(.2,1.2,.4,1) both}.bfao-icon-btn.test-error.svelte-1rt0kwk{color:var(--ai-error, #ef4444);background:var(--ai-error-bg, rgba(239, 68, 68, .1));border-color:var(--ai-error, #ef4444);animation:svelte-1rt0kwk-testShake .4s ease both}@keyframes svelte-1rt0kwk-testPop{0%{transform:scale(.5)}70%{transform:scale(1.2)}to{transform:scale(1)}}@keyframes svelte-1rt0kwk-testShake{0%,to{transform:translate(0)}20%{transform:translate(-3px)}40%{transform:translate(3px)}60%{transform:translate(-2px)}80%{transform:translate(1px)}}.model-dropdown.svelte-1rt0kwk{border:1px solid var(--ai-border);border-radius:10px;background:var(--ai-bg);box-shadow:var(--ai-shadow-md);margin-top:4px;animation:svelte-1rt0kwk-dropdownIn .2s cubic-bezier(.2,.98,.28,1) both;transform-origin:top center;padding:4px 0}.model-search.svelte-1rt0kwk{width:calc(100% - 16px);margin:4px 8px;padding:5px 8px;border:1px solid var(--ai-border);border-radius:6px;font-size:11px;background:var(--ai-bg-secondary);color:var(--ai-text);outline:none;box-sizing:border-box}.model-search.svelte-1rt0kwk:focus{border-color:var(--ai-primary);box-shadow:0 0 0 3px var(--ai-primary-shadow),0 1px 0 0 var(--ai-primary);animation:svelte-1rt0kwk-searchFocusRipple .4s cubic-bezier(.2,.98,.28,1)}@keyframes svelte-1rt0kwk-searchFocusRipple{0%{box-shadow:0 0 0 0 var(--ai-focus-ripple)}50%{box-shadow:0 0 0 6px var(--ai-focus-ripple)}to{box-shadow:0 0 0 3px var(--ai-primary-shadow),0 1px 0 0 var(--ai-primary)}}.model-search.svelte-1rt0kwk{transition:border-color .25s ease,box-shadow .25s ease}.model-list.svelte-1rt0kwk{max-height:180px;overflow-y:auto;mask-image:linear-gradient(to bottom,transparent 0%,black 6%,black 94%,transparent 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0%,black 6%,black 94%,transparent 100%)}.model-empty.svelte-1rt0kwk{padding:8px 12px;font-size:11px;color:var(--ai-text-muted);text-align:center;animation:svelte-1rt0kwk-floatIdle 3s ease-in-out infinite}@keyframes svelte-1rt0kwk-floatIdle{0%,to{transform:translateY(0)}50%{transform:translateY(-3px)}}@keyframes svelte-1rt0kwk-dropdownIn{0%{opacity:0;transform:scaleY(.92) scaleX(.98)}75%{opacity:1;transform:scaleY(1.02) scaleX(1)}to{opacity:1;transform:scaleY(1) scaleX(1)}}.model-item.svelte-1rt0kwk{display:block;width:100%;padding:7px 12px;font-size:12px;text-align:left;border:none;background:transparent;color:var(--ai-text);cursor:pointer;transition:background .15s ease,transform .15s ease,box-shadow .2s ease;animation:svelte-1rt0kwk-modelItemSlideIn .2s cubic-bezier(.2,.98,.28,1) both}.model-item.svelte-1rt0kwk:nth-child(1){animation-delay:0s}.model-item.svelte-1rt0kwk:nth-child(2){animation-delay:.03s}.model-item.svelte-1rt0kwk:nth-child(3){animation-delay:.06s}.model-item.svelte-1rt0kwk:nth-child(4){animation-delay:.09s}.model-item.svelte-1rt0kwk:nth-child(5){animation-delay:.12s}.model-item.svelte-1rt0kwk:nth-child(n+6){animation-delay:.15s}@keyframes svelte-1rt0kwk-modelItemSlideIn{0%{opacity:0;transform:translate(8px)}to{opacity:1;transform:translate(0)}}.model-item.svelte-1rt0kwk:hover{background:var(--ai-bg-hover);transform:translate(2px);box-shadow:inset 0 0 12px rgba(var(--ai-primary-rgb),.06)}.model-item.active.svelte-1rt0kwk{background:var(--ai-primary-bg);color:var(--ai-primary);font-weight:600;box-shadow:inset 4px 0 0 var(--ai-primary);animation:svelte-1rt0kwk-activePulse 2.5s ease-in-out infinite}.model-item.active.svelte-1rt0kwk:hover{box-shadow:inset 4px 0 0 var(--ai-primary),inset 0 0 16px rgba(var(--ai-primary-rgb),.1)}@keyframes svelte-1rt0kwk-activePulse{0%,to{box-shadow:inset 4px 0 0 var(--ai-primary)}50%{box-shadow:inset 4px 0 8px rgba(var(--ai-primary-rgb),.2),inset 4px 0 0 var(--ai-primary)}}@media(prefers-reduced-motion:reduce){.bfao-icon-btn.svelte-1rt0kwk svg{transition:none}.bfao-icon-btn.svelte-1rt0kwk .spinning{filter:none}.model-item.active.svelte-1rt0kwk,.model-empty.svelte-1rt0kwk{animation:none}.model-search.svelte-1rt0kwk{transition:none}.model-search.svelte-1rt0kwk:focus{box-shadow:0 1px 0 0 var(--ai-primary);animation:none}.bfao-icon-btn.test-success.svelte-1rt0kwk:after,.bfao-icon-btn.test-error.svelte-1rt0kwk:after{animation:none;opacity:0}}.provider-config.svelte-14s97jl{display:flex;flex-direction:column;gap:10px}.provider-config.svelte-14s97jl .bfao-select:hover{box-shadow:var(--ai-glow-control-hover)}.provider-config.svelte-14s97jl .bfao-input-flex{border-left:2px solid var(--ai-warning);transition:border-color .3s ease,border-left-color .3s ease,box-shadow .25s ease}.provider-config.svelte-14s97jl .bfao-input-flex:not(:placeholder-shown){border-left-color:var(--ai-success)}.link-btn.svelte-14s97jl{padding:6px;border:1.5px solid var(--ai-border);border-radius:8px;background:var(--ai-bg);color:var(--ai-text-muted);display:flex;align-items:center;justify-content:center;transition:all .2s ease;text-decoration:none;flex-shrink:0;position:relative;overflow:visible}.link-btn.svelte-14s97jl:hover{border-color:var(--ai-primary);color:var(--ai-primary);box-shadow:0 0 8px rgba(var(--ai-primary-rgb),.25)}.link-btn.svelte-14s97jl:hover svg{transform:rotate(-12deg);transition:transform .25s cubic-bezier(.2,.98,.28,1)}.link-btn.svelte-14s97jl svg{transition:transform .25s cubic-bezier(.2,.98,.28,1)}.bfao-icon-btn.svelte-14s97jl svg{transition:transform .3s cubic-bezier(.2,.98,.28,1)}.bfao-icon-btn.svelte-14s97jl:hover svg{transform:rotate(15deg) scale(1.05)}.bfao-icon-btn.svelte-14s97jl:hover{box-shadow:var(--ai-glow-control-hover)}.bfao-icon-btn.svelte-14s97jl:active{outline:2px solid rgba(var(--ai-primary-rgb),.3);outline-offset:2px;transition:outline .15s ease}.bfao-icon-btn.svelte-14s97jl:active svg{transform:scale(.8) rotateY(90deg)}.link-btn.svelte-14s97jl:after{content:"";position:absolute;top:-2px;right:-2px;bottom:-2px;left:-2px;border-radius:10px;border:1.5px solid var(--ai-primary);opacity:0;transform:scale(1);pointer-events:none;transition:none}.link-btn.svelte-14s97jl:hover:after{animation:svelte-14s97jl-linkPulseRing .6s cubic-bezier(.2,.98,.28,1) both}@keyframes svelte-14s97jl-linkPulseRing{0%{transform:scale(1);opacity:.5}to{transform:scale(1.35);opacity:0}}.field-slide-in.svelte-14s97jl{animation:svelte-14s97jl-fieldSlideDown .35s cubic-bezier(.34,1.56,.64,1) both}@keyframes svelte-14s97jl-fieldSlideDown{0%{opacity:0;transform:translateY(-10px);max-height:0}70%{transform:translateY(2px)}to{opacity:1;transform:translateY(0);max-height:80px}}@media(prefers-reduced-motion:reduce){.bfao-icon-btn.svelte-14s97jl svg{transition:none}.bfao-icon-btn.svelte-14s97jl:hover svg{transform:none}.bfao-icon-btn.svelte-14s97jl:hover{box-shadow:none}.bfao-icon-btn.svelte-14s97jl:active{outline:none}.provider-config.svelte-14s97jl .bfao-select:hover{box-shadow:none}.provider-config.svelte-14s97jl .bfao-input-flex{border-left:none}.link-btn.svelte-14s97jl:hover:after{animation:none}.link-btn.svelte-14s97jl svg{transition:none}.link-btn.svelte-14s97jl:hover svg{transform:none}.field-slide-in.svelte-14s97jl{animation:none;opacity:1;transform:none}}.liquid-toggle.svelte-4afsks{position:relative;width:38px;height:20px;border-radius:12px;border:none;cursor:pointer;background:var(--ai-bg-tertiary);transition:background .3s ease,box-shadow .3s ease;padding:0;flex-shrink:0}.liquid-toggle.svelte-4afsks:hover{box-shadow:0 0 16px rgba(var(--ai-primary-rgb),.15)}.liquid-toggle.on.svelte-4afsks{background:var(--ai-primary);box-shadow:0 0 10px rgba(var(--ai-primary-rgb),.35);overflow:hidden}.liquid-toggle.on.svelte-4afsks:after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(105deg,transparent 40%,rgba(255,255,255,.25) 50%,transparent 60%);animation:svelte-4afsks-toggleShimmer 3s ease-in-out infinite;pointer-events:none;border-radius:inherit}.liquid-toggle.on.svelte-4afsks:hover{box-shadow:0 0 18px rgba(var(--ai-primary-rgb),.45)}.thumb.svelte-4afsks{position:absolute;top:2px;left:2px;width:16px;height:16px;border-radius:50%;background:#fff;box-shadow:0 1px 3px #0003;will-change:transform;transition:box-shadow .3s ease;display:flex;align-items:center;justify-content:center}.thumb.svelte-4afsks:before{content:"";width:4px;height:4px;border-radius:50%;background:transparent;transition:background .3s ease,box-shadow .3s ease}.liquid-toggle.on.svelte-4afsks .thumb:where(.svelte-4afsks):before{background:#ffffffd9;box-shadow:0 0 4px #fff9}.liquid-toggle.on.svelte-4afsks .thumb:where(.svelte-4afsks){box-shadow:0 1px 3px #0003,0 0 6px #ffffff80;animation:svelte-4afsks-thumbGlow 2.5s ease-in-out infinite}@keyframes svelte-4afsks-toggleShimmer{0%,70%{transform:translate(-100%)}to{transform:translate(100%)}}@keyframes svelte-4afsks-thumbGlow{0%,to{box-shadow:0 1px 3px #0003,0 0 6px #ffffff80}50%{box-shadow:0 1px 3px #0003,0 0 10px #ffffffb3,var(--ai-glow-breath)}}@media(prefers-reduced-motion:reduce){.liquid-toggle.on.svelte-4afsks .thumb:where(.svelte-4afsks){animation:none}.liquid-toggle.on.svelte-4afsks:after{animation:none;display:none}.thumb.svelte-4afsks:before{transition:none}}.settings-panel.svelte-182y78p{padding:10px 15px 12px;background:var(--ai-bg-secondary);border-bottom:1px solid var(--ai-border-light)}.settings-panel.svelte-182y78p>.group+.group{position:relative}.settings-panel.svelte-182y78p>.group+.group:before{content:"";position:absolute;top:0;left:10%;width:80%;height:1px;background:linear-gradient(90deg,transparent 0%,var(--ai-primary-light) 50%,transparent 100%);background-size:200% 100%;animation:svelte-182y78p-dividerFadeIn .5s ease .3s both,svelte-182y78p-dividerSlide 6s ease-in-out .8s infinite}@keyframes svelte-182y78p-dividerFadeIn{0%{opacity:0;transform:scaleX(0)}to{opacity:1;transform:scaleX(1)}}@keyframes svelte-182y78p-dividerSlide{0%,to{background-position:100% 0}50%{background-position:0% 0}}.settings-panel.svelte-182y78p>.group{animation:svelte-182y78p-groupSlideIn .3s cubic-bezier(.2,.98,.28,1) both}.settings-panel.svelte-182y78p>.group:nth-child(1){animation-delay:0s}.settings-panel.svelte-182y78p>.group:nth-child(2){animation-delay:.06s}.settings-panel.svelte-182y78p>.group:nth-child(3){animation-delay:.12s}.settings-panel.svelte-182y78p>.group:nth-child(4){animation-delay:.18s}@keyframes svelte-182y78p-groupSlideIn{0%{opacity:0;transform:translateY(12px)}to{opacity:1;transform:translateY(0)}}.field-grid.svelte-182y78p{display:grid;grid-template-columns:1fr 1fr;gap:8px}.field-grid.svelte-182y78p>.bfao-field{animation:svelte-182y78p-fieldGridFadeIn .3s cubic-bezier(.2,.98,.28,1) both}.field-grid.svelte-182y78p>.bfao-field:nth-child(odd){animation-delay:.03s}.field-grid.svelte-182y78p>.bfao-field:nth-child(2n){animation-delay:.08s}.field-grid.svelte-182y78p>.bfao-field:nth-child(n+3){animation-delay:.13s}.field-grid.svelte-182y78p>.bfao-field:nth-child(n+5){animation-delay:.18s}.field-grid.svelte-182y78p>.bfao-field:nth-child(n+7){animation-delay:.23s}@keyframes svelte-182y78p-fieldGridFadeIn{0%{opacity:0;transform:translateY(6px)}to{opacity:1;transform:translateY(0)}}.field-grid.svelte-182y78p .bfao-field:where(.svelte-182y78p):focus-within{background:var(--ai-bg-hover);border-radius:8px;padding:6px;margin:-6px;box-shadow:var(--ai-field-active-glow);transition:background .25s ease,box-shadow .25s ease}.full.svelte-182y78p{grid-column:1 / -1;flex-direction:row;align-items:center;gap:8px}.toggle-list.svelte-182y78p{display:flex;flex-direction:column;gap:8px}.toggle-row.svelte-182y78p{display:flex;align-items:center;justify-content:space-between;gap:8px;font-size:12.5px;color:var(--ai-text-secondary);transition:background .2s ease,transform .25s cubic-bezier(.2,.98,.28,1),border-color .25s ease;border-radius:6px;margin:-4px -6px;border-left:2px solid transparent;padding:4px 6px 4px 4px}.toggle-row.svelte-182y78p>span:where(.svelte-182y78p):first-child{transition:color .2s ease;position:relative}.toggle-row.svelte-182y78p>span:where(.svelte-182y78p):first-child:after{content:"";position:absolute;bottom:-1px;left:0;width:100%;height:1px;background:linear-gradient(90deg,var(--ai-primary),var(--ai-gradient-accent));border-radius:.5px;transform:scaleX(0);transform-origin:left;transition:transform .25s cubic-bezier(.2,.98,.28,1);pointer-events:none}.toggle-row.svelte-182y78p:hover>span:where(.svelte-182y78p):first-child:after{transform:scaleX(1)}.toggle-row.svelte-182y78p:hover{background:var(--ai-bg-hover);transform:translate(3px)}.toggle-row.svelte-182y78p:hover>span:where(.svelte-182y78p):first-child{color:var(--ai-text)}.toggle-row.svelte-182y78p:has(.on){border-left-color:var(--ai-primary);box-shadow:var(--ai-glow-active-row);animation:svelte-182y78p-activeBarExpand .35s cubic-bezier(.2,.98,.28,1) both}@keyframes svelte-182y78p-activeBarExpand{0%{border-left-color:transparent}50%{border-left-color:var(--ai-border-active-glow)}to{border-left-color:var(--ai-primary)}}.sub-field.svelte-182y78p{display:flex;align-items:center;gap:8px;padding-left:23px}.sub-field-slide.svelte-182y78p{animation:svelte-182y78p-subFieldSlideIn .3s cubic-bezier(.2,.98,.28,1) both}.sub-field.sub-field-slide.svelte-182y78p{background:var(--ai-bg-hover);border-radius:8px;padding:6px 8px 6px 23px;margin:-2px -8px}@keyframes svelte-182y78p-subFieldSlideIn{0%{opacity:0;transform:translateY(-6px)}70%{opacity:1;transform:translateY(1px)}to{opacity:1;transform:translateY(0)}}.hint-fade-in.svelte-182y78p{animation:svelte-182y78p-hintFadeIn .35s ease both}@keyframes svelte-182y78p-hintFadeIn{0%{opacity:0;transform:translateY(-4px)}to{opacity:1;transform:translateY(0)}}.anim-hint.svelte-182y78p{font-size:10px;line-height:1.4;color:var(--ai-warning-dark);background:var(--ai-warning-bg);padding:6px 10px;border-radius:6px;margin-top:4px}@media(prefers-reduced-motion:reduce){.toggle-row.svelte-182y78p:hover{transform:none}.toggle-row.svelte-182y78p:has(.on){animation:none;box-shadow:none}.field-grid.svelte-182y78p>.bfao-field{animation:none}.toggle-row.svelte-182y78p>span:where(.svelte-182y78p):first-child:after{display:none}.sub-field-slide.svelte-182y78p,.hint-fade-in.svelte-182y78p{animation:none}.settings-panel.svelte-182y78p>.group{animation:none}.settings-panel.svelte-182y78p>.group+.group:before{animation:none;opacity:1;transform:scaleX(1);background-position:50% 0}.field-grid.svelte-182y78p .bfao-field:where(.svelte-182y78p):focus-within{transition:none}}.prompt-editor.svelte-avw5xh{margin-top:10px}.prompt-header.svelte-avw5xh{margin-bottom:6px;display:flex;gap:4px;align-items:center}.prompt-header.svelte-avw5xh .bfao-select:where(.svelte-avw5xh){flex:1}.prompt-action-btn.svelte-avw5xh{padding:5px 8px;border:1.5px solid var(--ai-border);border-radius:6px;background:var(--ai-bg-secondary);color:var(--ai-text-muted);cursor:pointer;display:flex;align-items:center;transition:all .2s}.prompt-action-btn.svelte-avw5xh:hover:not(:disabled){border-color:var(--ai-primary-light);color:var(--ai-primary)}.prompt-action-btn.svelte-avw5xh:disabled{opacity:.4;cursor:not-allowed}.prompt-action-btn.save-flash.svelte-avw5xh{color:var(--ai-success-dark);border-color:var(--ai-success);animation:svelte-avw5xh-saveFlash .6s ease both;position:relative}.prompt-action-btn.save-flash.svelte-avw5xh:after{content:"";position:absolute;top:-2px;right:-2px;bottom:-2px;left:-2px;border-radius:inherit;border:2px solid var(--ai-success);animation:svelte-avw5xh-saveBurst .5s ease-out both;pointer-events:none}@keyframes svelte-avw5xh-saveFlash{0%{background:var(--ai-bg-secondary)}30%{background:var(--ai-success-bg);box-shadow:0 0 8px rgba(var(--ai-success-rgb),.3)}to{background:var(--ai-bg-secondary);box-shadow:none}}@keyframes svelte-avw5xh-saveBurst{0%{transform:scale(1);opacity:1}to{transform:scale(1.6);opacity:0}}.prompt-textarea.svelte-avw5xh{width:100%;height:65px;padding:8px 10px;border:1.5px solid var(--ai-border);border-radius:8px;font-size:12px;outline:none;box-sizing:border-box;background:var(--ai-input-bg);color:var(--ai-text);resize:none;font-family:inherit;line-height:1.5;transition:border-color .3s ease,box-shadow .3s ease,height .3s cubic-bezier(.2,.98,.28,1)}.prompt-textarea.svelte-avw5xh:focus{border-color:var(--ai-primary);box-shadow:0 0 0 3px var(--ai-primary-shadow);height:72px;mask-image:linear-gradient(to bottom,transparent 0px,black 6px,black calc(100% - 6px),transparent 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0px,black 6px,black calc(100% - 6px),transparent 100%)}.prompt-textarea.svelte-avw5xh:focus:not(:placeholder-shown){animation:svelte-avw5xh-typingPulse 2s ease-in-out infinite}.custom-preset-row.svelte-avw5xh{display:flex;align-items:center;gap:4px;padding:3px 6px;border-radius:6px;background:var(--ai-bg-secondary);animation:svelte-avw5xh-presetSlideIn .25s cubic-bezier(.2,.98,.28,1) both;transition:background .2s ease,transform .15s ease}.custom-preset-row.svelte-avw5xh:nth-child(1){animation-delay:0s}.custom-preset-row.svelte-avw5xh:nth-child(2){animation-delay:.04s}.custom-preset-row.svelte-avw5xh:nth-child(3){animation-delay:.08s}.custom-preset-row.svelte-avw5xh:nth-child(4){animation-delay:.12s}.custom-preset-row.svelte-avw5xh:nth-child(n+5){animation-delay:.16s}@keyframes svelte-avw5xh-typingPulse{0%,to{border-color:var(--ai-primary)}50%{border-color:var(--ai-gradient-accent)}}@keyframes svelte-avw5xh-presetSlideIn{0%{opacity:0;transform:translate(-6px)}to{opacity:1;transform:translate(0)}}.custom-preset-row.svelte-avw5xh{position:relative}.custom-preset-row.svelte-avw5xh:after{content:"";position:absolute;bottom:0;left:6px;right:6px;height:1.5px;background:linear-gradient(90deg,var(--ai-primary),var(--ai-gradient-accent),transparent);border-radius:1px;transform:scaleX(0);transform-origin:left;transition:transform .3s cubic-bezier(.2,.98,.28,1);pointer-events:none}.custom-preset-row.svelte-avw5xh:hover:after{transform:scaleX(1)}.custom-preset-row.svelte-avw5xh:hover{background:var(--ai-bg-hover);transform:translate(2px);box-shadow:var(--ai-glow-selected)}.preset-select.svelte-avw5xh{flex:1;background:none;border:none;color:var(--ai-text-secondary);font-size:11px;cursor:pointer;text-align:left;padding:2px 0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.preset-select.svelte-avw5xh:hover{color:var(--ai-primary)}.preset-icon-btn.svelte-avw5xh{padding:2px;background:none;border:none;color:var(--ai-text-muted);cursor:pointer;display:flex;transition:color .2s}.preset-icon-btn.svelte-avw5xh:hover{color:var(--ai-primary)}.preset-icon-btn.danger.svelte-avw5xh:hover{color:var(--ai-error, #ef4444);animation:svelte-avw5xh-deleteShake .3s ease}.preset-icon-btn.svelte-avw5xh .starred{color:var(--ai-warning-dark);fill:var(--ai-warning-dark);animation:svelte-avw5xh-starBounce .35s cubic-bezier(.2,.98,.28,1)}@keyframes svelte-avw5xh-starBounce{0%{transform:scale(.5)}60%{transform:scale(1.25)}to{transform:scale(1)}}@keyframes svelte-avw5xh-deleteShake{0%,to{transform:translate(0)}25%{transform:translate(-2px)}75%{transform:translate(2px)}}.preset-manager.svelte-avw5xh{margin-top:8px;padding:8px;border:1px solid var(--ai-border-light);border-radius:8px;background:var(--ai-bg-secondary)}.manager-title.svelte-avw5xh{font-size:11px;font-weight:600;color:var(--ai-text);margin-bottom:6px;position:relative;padding-bottom:4px}.manager-title.svelte-avw5xh:after{content:"";position:absolute;bottom:0;left:0;width:100%;height:1.5px;background:linear-gradient(90deg,var(--ai-primary),var(--ai-gradient-accent),transparent);transform:scaleX(0);transform-origin:left;animation:svelte-avw5xh-titleLineExpand .4s cubic-bezier(.2,.98,.28,1) .15s both}@keyframes svelte-avw5xh-titleLineExpand{to{transform:scaleX(1)}}.manager-section.svelte-avw5xh{font-size:10px;font-weight:600;color:var(--ai-text-muted);margin:6px 0 2px;text-transform:uppercase;letter-spacing:.05em;position:relative;overflow:hidden}.manager-section.svelte-avw5xh:after{content:"";position:absolute;top:0;left:-100%;width:50%;height:100%;background:linear-gradient(90deg,transparent,var(--ai-shimmer-color),transparent);animation:svelte-avw5xh-sectionSweep 6s ease-in-out infinite;pointer-events:none}@keyframes svelte-avw5xh-sectionSweep{0%,to{left:-50%}50%{left:100%}}.hidden-preset.svelte-avw5xh{opacity:.4;text-decoration:line-through}@media(prefers-reduced-motion:reduce){.prompt-textarea.svelte-avw5xh{transition:border-color .3s ease,box-shadow .3s ease;height:65px!important}.prompt-textarea.svelte-avw5xh:focus{mask-image:none;-webkit-mask-image:none}.prompt-textarea.svelte-avw5xh:focus:not(:placeholder-shown){animation:none}.prompt-action-btn.save-flash.svelte-avw5xh{animation:none}.prompt-action-btn.save-flash.svelte-avw5xh:after{animation:none;display:none}.manager-title.svelte-avw5xh:after{animation:none;transform:scaleX(1)}.manager-section.svelte-avw5xh:after{animation:none;display:none}.custom-preset-row.svelte-avw5xh{animation:none}.custom-preset-row.svelte-avw5xh:after{transition:none;display:none}}.log-area.svelte-rc9h4j{margin-top:10px;background:var(--ai-bg-tertiary);padding:8px 10px;border-radius:10px;font-size:11px;color:var(--ai-text);height:120px;overflow-y:auto;overflow-wrap:break-word;word-break:break-word;border:1px solid var(--ai-border-light);scroll-behavior:smooth;display:flex;flex-direction:column;gap:2px;position:relative;mask-image:linear-gradient(to bottom,transparent 0%,black 8%,black 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0%,black 8%,black 100%);transition:border-color .3s ease,box-shadow .3s ease;animation:svelte-rc9h4j-logAreaFadeIn .35s cubic-bezier(.2,.98,.28,1) both}@keyframes svelte-rc9h4j-logAreaFadeIn{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}.log-area.svelte-rc9h4j:hover{border-color:var(--ai-border)}.log-area.svelte-rc9h4j:focus-within{box-shadow:var(--ai-field-active-glow);border-color:var(--ai-primary-light)}.log-entry.svelte-rc9h4j{display:flex;align-items:flex-start;gap:6px;padding:3px 8px;border-radius:6px;background:var(--ai-bg-secondary);border-left:3px solid transparent;line-height:1.5;animation:svelte-rc9h4j-logSlideIn .25s ease both;transition:background .2s ease}.log-entry.svelte-rc9h4j:last-child{animation:svelte-rc9h4j-logSlideIn .25s ease both,svelte-rc9h4j-newEntryGlow .8s ease .25s 1}.log-entry.svelte-rc9h4j:last-child:not(.log-success):not(.log-error):not(.log-warning):not(.log-info){animation:svelte-rc9h4j-logSlideIn .25s ease both,svelte-rc9h4j-newEntryGlow .8s ease .25s 1,svelte-rc9h4j-lastEntryBorderPulse 2s ease-in-out 1s infinite}.log-entry.svelte-rc9h4j:hover{background:var(--ai-bg-tertiary);border-left-width:4px;padding-left:7px;box-shadow:inset 3px 0 6px -2px rgba(var(--ai-primary-rgb),.15)}.log-time.svelte-rc9h4j{flex-shrink:0;font-size:9px;color:var(--ai-text-muted);background:var(--ai-bg-tertiary);padding:1px 5px;border-radius:8px;line-height:16px;transition:letter-spacing .2s ease,background .2s ease}.log-entry.svelte-rc9h4j:hover .log-time:where(.svelte-rc9h4j){letter-spacing:.04em;background:rgba(var(--ai-primary-rgb),.1);color:var(--ai-primary)}.log-msg.svelte-rc9h4j{flex:1;min-width:0;word-break:break-word;font-family:Menlo,Monaco,Consolas,monospace;letter-spacing:.02em}.log-success.svelte-rc9h4j{color:var(--ai-success-dark);border-left-color:var(--ai-success);animation:svelte-rc9h4j-logSlideIn .25s ease both,svelte-rc9h4j-successBounce .2s cubic-bezier(.2,.98,.28,1) .25s both}.log-entry:first-child.log-success.svelte-rc9h4j{animation:svelte-rc9h4j-logSlideIn .25s ease both,svelte-rc9h4j-readyPulse 3s ease-in-out .5s infinite}.log-error.svelte-rc9h4j{color:var(--ai-error-alt);border-left-color:var(--ai-error-alt);border-left-width:4px;padding-left:7px;background:rgba(var(--ai-error-alt-rgb),.04);animation:svelte-rc9h4j-logSlideIn .25s ease both,svelte-rc9h4j-borderGlow .6s ease .25s 2,svelte-rc9h4j-errorShake .3s ease .3s 1}.log-warning.svelte-rc9h4j{color:var(--ai-warning);border-left-color:var(--ai-warning);animation:svelte-rc9h4j-logSlideIn .25s ease both,svelte-rc9h4j-borderGlowWarn .8s ease .25s 1}.log-info.svelte-rc9h4j{color:var(--ai-info);border-left-color:var(--ai-info)}.log-cat.svelte-rc9h4j{position:absolute;bottom:4px;left:8px;right:8px;display:flex;align-items:center;gap:6px;padding:4px 10px;background:linear-gradient(to top,var(--ai-bg-tertiary) 70%,transparent);font-size:11px;color:var(--ai-primary);border-radius:0 0 8px 8px;transition:opacity .4s ease,transform .4s ease;pointer-events:none}.log-cat.svelte-rc9h4j:not(.away){animation:svelte-rc9h4j-catReturn .5s cubic-bezier(.2,.98,.28,1) both}.log-cat.away.svelte-rc9h4j{opacity:0;transform:translateY(-20px) scale(.5);pointer-events:none}.cat-emoji.svelte-rc9h4j{font-size:18px;animation:svelte-rc9h4j-catIdle 1s ease-in-out infinite alternate;transition:transform .3s cubic-bezier(.2,.98,.28,1)}.log-cat.svelte-rc9h4j:hover .cat-emoji:where(.svelte-rc9h4j){animation:svelte-rc9h4j-catIdle 1s ease-in-out infinite alternate,svelte-rc9h4j-catBounce .4s cubic-bezier(.2,.98,.28,1)}@keyframes svelte-rc9h4j-catBounce{0%{transform:scale(1)}40%{transform:scale(1.25) translateY(-4px)}70%{transform:scale(.95)}to{transform:scale(1)}}.cat-text.svelte-rc9h4j{font-family:Menlo,Monaco,Consolas,monospace;letter-spacing:.03em;transition:color .2s ease,letter-spacing .3s ease,text-shadow .3s ease}.log-cat.svelte-rc9h4j:hover .cat-text:where(.svelte-rc9h4j){color:var(--ai-gradient-accent, #9b59f6);letter-spacing:.06em;text-shadow:var(--ai-glow-text-hover)}@keyframes svelte-rc9h4j-catIdle{0%{transform:translateY(0) rotate(-3deg)}to{transform:translateY(-3px) rotate(3deg)}}@keyframes svelte-rc9h4j-logSlideIn{0%{opacity:0;transform:translate(-8px);filter:blur(3px)}to{opacity:1;transform:translate(0);filter:blur(0px)}}@keyframes svelte-rc9h4j-borderGlow{0%,to{box-shadow:none}50%{box-shadow:inset 3px 0 8px -2px var(--ai-error-alt)}}@keyframes svelte-rc9h4j-borderGlowWarn{0%,to{box-shadow:none}50%{box-shadow:inset 3px 0 6px -2px var(--ai-warning)}}@keyframes svelte-rc9h4j-readyPulse{0%,to{opacity:1}50%{opacity:.6}}@keyframes svelte-rc9h4j-newEntryGlow{0%,to{box-shadow:none}40%{box-shadow:0 0 6px rgba(var(--ai-primary-rgb),.2),inset 0 0 4px rgba(var(--ai-primary-rgb),.06)}}@keyframes svelte-rc9h4j-successBounce{0%{transform:translateY(0)}50%{transform:translateY(-2px)}to{transform:translateY(0)}}@keyframes svelte-rc9h4j-errorShake{0%,to{transform:translate(0)}20%{transform:translate(-2px)}40%{transform:translate(2px)}60%{transform:translate(-1.5px)}80%{transform:translate(1px)}}@keyframes svelte-rc9h4j-lastEntryBorderPulse{0%,to{border-left-color:var(--ai-primary)}50%{border-left-color:var(--ai-gradient-accent)}}@keyframes svelte-rc9h4j-catReturn{0%{opacity:0;transform:translateY(-16px) scale(.5)}60%{opacity:1;transform:translateY(3px) scale(1.05)}to{opacity:1;transform:translateY(0) scale(1)}}@media(prefers-reduced-motion:reduce){.log-entry:first-child.log-success.svelte-rc9h4j{animation:none}.log-entry.svelte-rc9h4j:last-child{animation:none;border-left-color:inherit}.log-success.svelte-rc9h4j,.log-error.svelte-rc9h4j{animation:none}.log-time.svelte-rc9h4j{transition:none}.log-entry.svelte-rc9h4j:hover{border-left-width:3px;padding-left:8px;box-shadow:none}.log-cat.svelte-rc9h4j:not(.away){animation:none}.log-cat.svelte-rc9h4j:hover .cat-emoji:where(.svelte-rc9h4j){animation:none}.cat-emoji.svelte-rc9h4j{transition:none}.log-area.svelte-rc9h4j{transition:none;box-shadow:none;animation:none}.log-area.svelte-rc9h4j:focus-within{box-shadow:none}.cat-text.svelte-rc9h4j{transition:none}.log-cat.svelte-rc9h4j:hover .cat-text:where(.svelte-rc9h4j){letter-spacing:.03em}}.progress-container.svelte-um4ua8{margin-top:10px;padding:8px 0;animation:svelte-um4ua8-progressEnter .4s cubic-bezier(.2,.98,.28,1) both;transform-origin:top center}@keyframes svelte-um4ua8-progressEnter{0%{opacity:0;transform:translateY(8px) scaleY(.8)}to{opacity:1;transform:translateY(0) scaleY(1)}}.progress-header.svelte-um4ua8{display:flex;justify-content:space-between;align-items:center;margin-bottom:6px}.phase-label.svelte-um4ua8{font-size:11px;font-weight:600;color:var(--ai-primary);display:inline-flex;align-items:center;gap:5px;transition:transform .25s cubic-bezier(.2,1.04,.42,1)}.phase-label.svelte-um4ua8:before{content:"";width:6px;height:6px;border-radius:50%;background:var(--ai-primary);animation:svelte-um4ua8-phaseDot 1.5s ease-in-out infinite;flex-shrink:0}@keyframes svelte-um4ua8-phaseDot{0%,to{opacity:1;box-shadow:0 0 rgba(var(--ai-primary-rgb),.4)}50%{opacity:.6;box-shadow:0 0 0 3px rgba(var(--ai-primary-rgb),0)}}.phase-label.svelte-um4ua8:hover{transform:scale(1.05)}.progress-text.svelte-um4ua8{font-size:11px;font-weight:700;color:var(--ai-text-secondary);display:inline-block}.progress-track.svelte-um4ua8{height:6px;background:var(--ai-bg-tertiary);border-radius:3px;overflow:visible;position:relative;box-shadow:var(--ai-shadow-inset);border:1px solid transparent;transition:border-color .5s ease,box-shadow .5s ease}.progress-track.svelte-um4ua8:has(.complete:where(.svelte-um4ua8)){border-color:rgba(var(--ai-success-rgb),.3);box-shadow:var(--ai-shadow-inset),0 0 8px rgba(var(--ai-success-rgb),.2)}.progress-bar.svelte-um4ua8{height:100%;background:linear-gradient(90deg,var(--ai-primary),var(--ai-gradient-accent),#d946ef,var(--ai-primary));background-size:300% 100%;border-radius:3px;transition:width .4s cubic-bezier(.19,1,.22,1);position:relative;will-change:width;animation:svelte-um4ua8-auroraFlow 3s ease-in-out infinite}.progress-bar.svelte-um4ua8:after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(90deg,transparent 0%,rgba(255,255,255,.4) 50%,transparent 100%);background-size:200% 100%;animation:svelte-um4ua8-shimmer 1.5s ease-in-out infinite}.progress-bar.complete.svelte-um4ua8{background:linear-gradient(90deg,var(--ai-success),var(--ai-success-light),var(--ai-success-lighter));animation:svelte-um4ua8-completeGlow 2s ease-in-out infinite}.token-stats.svelte-um4ua8{font-size:10px;color:var(--ai-text-muted);margin-top:4px;text-align:right;animation:svelte-um4ua8-tokenFadeIn .4s cubic-bezier(.2,.98,.28,1) both}.token-stats.svelte-um4ua8 span:where(.svelte-um4ua8){transition:color .2s ease,transform .2s ease;display:inline-block;cursor:default}.token-stats.svelte-um4ua8 span:where(.svelte-um4ua8):hover{color:var(--ai-primary);transform:scale(1.1)}.progress-cat.svelte-um4ua8{position:absolute;top:-18px;font-size:16px;line-height:1;transform:translate(-50%);animation:svelte-um4ua8-catBounce .5s ease-in-out infinite alternate;filter:drop-shadow(0 1px 3px rgba(0,0,0,.2));pointer-events:auto;cursor:pointer;transition:left .8s cubic-bezier(.19,1,.22,1),filter .2s ease,transform .2s ease}.progress-cat.svelte-um4ua8:after{content:"";position:absolute;bottom:-3px;left:50%;width:10px;height:4px;background:#00000026;border-radius:50%;transform:translate(-50%);animation:svelte-um4ua8-catShadow .5s ease-in-out infinite alternate;pointer-events:none}.progress-cat.svelte-um4ua8:hover{filter:drop-shadow(0 2px 6px rgba(0,0,0,.3)) brightness(1.2);animation:none;transform:translate(-50%) scale(1.3)}.progress-cat.svelte-um4ua8:hover:after{animation:none;opacity:.3;transform:translate(-50%) scaleX(1.4)}@keyframes svelte-um4ua8-catBounce{0%{transform:translate(-50%) translateY(0) rotate(-3deg)}to{transform:translate(-50%) translateY(-6px) rotate(3deg)}}@keyframes svelte-um4ua8-catShadow{0%{transform:translate(-50%) scaleX(1.2);opacity:.25}to{transform:translate(-50%) scaleX(.7);opacity:.12}}@keyframes svelte-um4ua8-shimmer{0%{background-position:200% 0}to{background-position:-200% 0}}@keyframes svelte-um4ua8-auroraFlow{0%{background-position:0% 0}50%{background-position:100% 0}to{background-position:0% 0}}@keyframes svelte-um4ua8-completeGlow{0%,to{box-shadow:0 0 4px rgba(var(--ai-primary-rgb),.1)}50%{box-shadow:0 0 12px #10b98159}}@keyframes svelte-um4ua8-tokenFadeIn{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}@media(prefers-reduced-motion:reduce){.progress-container.svelte-um4ua8,.progress-bar.svelte-um4ua8{animation:none}.progress-bar.svelte-um4ua8:after{animation:none}.progress-bar.complete.svelte-um4ua8,.token-stats.svelte-um4ua8{animation:none}.phase-label.svelte-um4ua8:before{animation:none;opacity:1}.progress-cat.svelte-um4ua8{animation:none}.progress-cat.svelte-um4ua8:after{animation:none;opacity:.15}.progress-track.svelte-um4ua8:has(.complete:where(.svelte-um4ua8)){box-shadow:var(--ai-shadow-inset);border-color:transparent}}.actions.svelte-15t8ntb{margin-top:12px;display:flex;flex-direction:column;gap:8px;overflow:hidden}.btn-primary.svelte-15t8ntb{width:100%;padding:12px;border:1.5px solid transparent;border-radius:14px;font-size:14px;font-weight:700;color:#fff;background:radial-gradient(circle at var(--glow-x, -100px) var(--glow-y, -100px),rgba(255,255,255,.2),transparent 60%),linear-gradient(135deg,var(--ai-primary),var(--ai-gradient-accent),var(--ai-primary));background-size:auto,500% 500%;animation:svelte-15t8ntb-gradientFlow 8s ease-in-out infinite;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;position:relative;overflow:hidden;box-sizing:border-box;transition:all .3s cubic-bezier(.2,1.04,.42,1)}.btn-primary.svelte-15t8ntb:hover{box-shadow:0 12px 32px rgba(var(--ai-primary-rgb),.3),0 5px 16px #ff6b9d29;transform:translateY(-1px)}.btn-primary.svelte-15t8ntb:not(.running):hover{animation-direction:reverse}.btn-primary.svelte-15t8ntb:active{transform:scale(.97);transition-duration:.08s}.btn-primary.running.svelte-15t8ntb{background:linear-gradient(135deg,var(--ai-error),var(--ai-error-hover),var(--ai-error));animation:svelte-15t8ntb-runningPulse 2s ease-in-out infinite;border:1.5px solid rgba(var(--ai-error-rgb),.4)}.btn-primary.running.svelte-15t8ntb:before{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:repeating-linear-gradient(45deg,var(--ai-stripe-overlay) 0px,var(--ai-stripe-overlay) 6px,transparent 6px,transparent 12px);animation:svelte-15t8ntb-runningStripes .8s linear infinite;border-radius:inherit;pointer-events:none}@keyframes svelte-15t8ntb-runningStripes{0%{background-position:0 0}to{background-position:17px 0}}.btn-primary.running.svelte-15t8ntb .kbd:where(.svelte-15t8ntb){opacity:.8;animation:svelte-15t8ntb-kbdPulse 2s ease-in-out infinite}@keyframes svelte-15t8ntb-kbdPulse{0%,to{opacity:.8}50%{opacity:1;background:#ffffff4d}}.btn-primary.running.svelte-15t8ntb svg{animation:svelte-15t8ntb-iconSwitch .35s cubic-bezier(.22,1.42,.29,1) both,svelte-15t8ntb-runningTremor .8s ease-in-out .35s infinite}@keyframes svelte-15t8ntb-runningTremor{0%,to{transform:scale(1) rotate(0)}25%{transform:scale(1) rotate(-2deg)}75%{transform:scale(1) rotate(2deg)}}.btn-primary.svelte-15t8ntb:not(.running) svg{animation:svelte-15t8ntb-iconSwitch .35s cubic-bezier(.22,1.42,.29,1) both}@keyframes svelte-15t8ntb-iconSwitch{0%{transform:scale(0);opacity:0}70%{transform:scale(1.15)}to{transform:scale(1);opacity:1}}.kbd.svelte-15t8ntb{font-size:10px;opacity:.4;background:#ffffff26;padding:1px 5px;border-radius:4px;margin-left:4px;font-family:monospace;transition:opacity .25s ease}.btn-primary.svelte-15t8ntb:hover .kbd:where(.svelte-15t8ntb){opacity:.8}.tool-row.svelte-15t8ntb{display:flex;gap:6px;animation:svelte-15t8ntb-toolRowSlideIn .3s ease both}.tool-row.svelte-15t8ntb:nth-child(2){animation-delay:0s}.tool-row.svelte-15t8ntb:nth-child(3){animation-delay:.06s}.tool-row.svelte-15t8ntb:nth-child(4){animation-delay:.12s}.btn-tool.svelte-15t8ntb{flex:1;padding:8px 6px;border:1.5px solid var(--ai-border);border-radius:10px;background:radial-gradient(circle at var(--glow-x, -100px) var(--glow-y, -100px),rgba(var(--ai-primary-rgb),.12),transparent 60%),var(--ai-bg-tertiary);color:var(--ai-text-secondary);font-size:11px;font-weight:500;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:4px;transition:all .35s cubic-bezier(.22,1.42,.29,1);position:relative;overflow:hidden}.btn-tool.svelte-15t8ntb svg{transition:transform .25s cubic-bezier(.22,1.42,.29,1)}.btn-tool.svelte-15t8ntb:after{content:"";position:absolute;bottom:3px;left:20%;width:60%;height:2px;background:linear-gradient(90deg,var(--ai-primary),var(--ai-gradient-accent));border-radius:1px;transform:scaleX(0);transform-origin:left;transition:transform .25s cubic-bezier(.2,.98,.28,1);pointer-events:none}.btn-tool.svelte-15t8ntb:hover:after{transform:scaleX(1)}.btn-tool.svelte-15t8ntb:hover{transform:translateY(-1px);box-shadow:0 4px 12px rgba(var(--ai-primary-rgb),.12);border-color:var(--ai-primary-light)}.btn-tool.svelte-15t8ntb:hover svg{transform:scale(1.2)}.tool-row.svelte-15t8ntb:nth-child(2) .btn-tool:where(.svelte-15t8ntb):nth-child(1):hover svg{transform:translateY(-2px)}.tool-row.svelte-15t8ntb:nth-child(2) .btn-tool:where(.svelte-15t8ntb):nth-child(2):hover svg{transform:scaleX(-1)}.tool-row.svelte-15t8ntb:nth-child(2) .btn-tool:where(.svelte-15t8ntb):nth-child(3):hover svg{transform:rotate(-45deg)}.tool-row.svelte-15t8ntb:nth-child(3) .btn-tool:where(.svelte-15t8ntb):nth-child(1):hover svg{transform:translateY(2px)}.tool-row.svelte-15t8ntb:nth-child(3) .btn-tool:where(.svelte-15t8ntb):nth-child(2):hover svg{transform:scaleY(1.25)}.tool-row.svelte-15t8ntb:nth-child(3) .btn-tool:where(.svelte-15t8ntb):nth-child(3):hover svg{transform:scale(1.3)}.tool-row.svelte-15t8ntb:nth-child(4) .btn-tool:where(.svelte-15t8ntb):nth-child(1):hover svg{transform:rotate(-5deg) scale(1.1)}.tool-row.svelte-15t8ntb:nth-child(4) .btn-tool:where(.svelte-15t8ntb):nth-child(2):hover svg{transform:rotate(15deg)}.tool-row.svelte-15t8ntb:nth-child(4) .btn-tool:where(.svelte-15t8ntb):nth-child(3):hover svg{transform:rotate(-120deg)}.btn-tool.svelte-15t8ntb:active{transform:scale(.9);transition-duration:.08s;box-shadow:inset 0 2px 6px #0000001a}.btn-tool.svelte-15t8ntb:disabled{opacity:.4;cursor:not-allowed;transform:none;box-shadow:none;filter:grayscale(.5);transition:opacity .3s ease,filter .3s ease}.tool-row.svelte-15t8ntb:has(.btn-tool:where(.svelte-15t8ntb):disabled){opacity:.75;transition:opacity .3s ease}.tool-row.svelte-15t8ntb:hover~.tool-row:where(.svelte-15t8ntb):not(:hover){opacity:.55;transition:opacity .25s ease}@keyframes svelte-15t8ntb-runningPulse{0%,to{box-shadow:0 4px 16px rgba(var(--ai-primary-rgb),.15);border-color:rgba(var(--ai-error-rgb),.3)}50%{box-shadow:0 8px 32px #ef444459,0 0 12px #ef444433;border-color:rgba(var(--ai-error-rgb),.6)}}@keyframes svelte-15t8ntb-gradientFlow{0%{background-position:0% 0%,0% 50%}50%{background-position:0% 0%,100% 50%}to{background-position:0% 0%,0% 50%}}@keyframes svelte-15t8ntb-toolRowSlideIn{0%{opacity:0;transform:translateY(6px)}to{opacity:1;transform:translateY(0)}}@media(prefers-reduced-motion:reduce){.btn-primary.svelte-15t8ntb{animation:none}.btn-primary.svelte-15t8ntb svg{animation:none}.btn-primary.running.svelte-15t8ntb svg{animation:none}.btn-primary.svelte-15t8ntb:not(.running) svg{animation:none}.btn-primary.running.svelte-15t8ntb .kbd:where(.svelte-15t8ntb){animation:none}.kbd.svelte-15t8ntb{transition:none}.btn-tool.svelte-15t8ntb svg{transition:none}.btn-tool.svelte-15t8ntb:hover svg{transform:none}.btn-tool.svelte-15t8ntb:after{display:none}.btn-primary.running.svelte-15t8ntb:before{animation:none;display:none}.tool-row.svelte-15t8ntb:hover~.tool-row:where(.svelte-15t8ntb):not(:hover){opacity:1}.btn-primary.svelte-15t8ntb:hover{animation-direction:normal}}.backdrop.svelte-1bxxaoh{position:fixed;top:0;right:0;bottom:0;left:0;background:var(--ai-backdrop);display:flex;align-items:center;justify-content:center;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;-webkit-backdrop-filter:blur(16px) saturate(1.4);backdrop-filter:blur(16px) saturate(1.4);overflow:hidden}.backdrop.svelte-1bxxaoh:before{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:radial-gradient(1px 1px at 15% 25%,rgba(255,255,255,.4) 50%,transparent 50%),radial-gradient(1px 1px at 45% 65%,rgba(255,255,255,.3) 50%,transparent 50%),radial-gradient(1.5px 1.5px at 72% 18%,rgba(255,255,255,.35) 50%,transparent 50%),radial-gradient(1px 1px at 88% 72%,rgba(255,255,255,.3) 50%,transparent 50%),radial-gradient(1.5px 1.5px at 30% 85%,rgba(255,255,255,.25) 50%,transparent 50%);animation:svelte-1bxxaoh-backdropStardust 4s ease-in-out infinite alternate;pointer-events:none}.modal.svelte-1bxxaoh{background:var(--ai-bg);color:var(--ai-text);border-radius:28px;box-shadow:var(--ai-shadow-modal),0 0 calc(var(--modal-scroll-depth, 0) * 40px) rgba(0,0,0,calc(var(--modal-scroll-depth, 0) * .1));max-height:85vh;display:flex;flex-direction:column;overflow:hidden;transition:box-shadow .5s ease}.modal-header.svelte-1bxxaoh{padding:18px 22px;display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid rgba(255,255,255,.1);background:linear-gradient(135deg,var(--ai-primary),var(--ai-gradient-accent),var(--ai-primary));background-size:400% 400%;animation:svelte-1bxxaoh-modal-aurora-flow 18s ease-in-out infinite;color:#fff;position:relative;overflow:hidden}.modal-header.svelte-1bxxaoh:after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(105deg,transparent 40%,rgba(255,255,255,.12) 50%,transparent 60%);background-size:200% 100%;animation:svelte-1bxxaoh-headerSweep 8s ease-in-out infinite;pointer-events:none}.modal-header.svelte-1bxxaoh h3:where(.svelte-1bxxaoh){margin:0;font-size:15px;font-weight:700;display:flex;align-items:center;gap:8px;position:relative;z-index:1;letter-spacing:0;transition:letter-spacing .35s cubic-bezier(.2,.98,.28,1)}.modal-header.svelte-1bxxaoh h3:where(.svelte-1bxxaoh) svg{animation:svelte-1bxxaoh-modalIconBounce .4s cubic-bezier(.2,1.2,.4,1) .15s both}@keyframes svelte-1bxxaoh-modalIconBounce{0%{transform:scale(0);opacity:0}70%{transform:scale(1.2)}to{transform:scale(1);opacity:1}}.modal-header.svelte-1bxxaoh:hover h3:where(.svelte-1bxxaoh){letter-spacing:1px}.close-btn.svelte-1bxxaoh{background:#fff3;border:none;color:#fff;width:28px;height:28px;border-radius:10px;cursor:pointer;display:flex;align-items:center;justify-content:center;position:relative;z-index:1;transition:background .2s ease,transform .25s cubic-bezier(.2,1,.4,1),box-shadow .25s ease}.close-btn.svelte-1bxxaoh:hover{background:#ffffff59;transform:rotate(90deg) scale(1.1);box-shadow:0 0 12px #ef44444d}.modal-body.svelte-1bxxaoh{flex:1;overflow-y:auto;overflow-x:hidden;padding:0;min-height:0;position:relative;background:radial-gradient(circle at var(--glow-x, -100px) var(--glow-y, -100px),rgba(var(--ai-primary-rgb, 115, 100, 255),.05) 0%,transparent 55%)}.modal-body.svelte-1bxxaoh:before,.modal-body.svelte-1bxxaoh:after{content:"";position:sticky;display:block;height:18px;pointer-events:none;z-index:2;opacity:0;transition:opacity .3s ease}.modal-body.svelte-1bxxaoh:before{top:0;background:linear-gradient(to bottom,var(--ai-bg),transparent);margin-bottom:-18px}.modal-body.svelte-1bxxaoh:after{bottom:0;background:linear-gradient(to top,var(--ai-bg),transparent);margin-top:-18px}.modal-body.fade-top.svelte-1bxxaoh:before{opacity:1}.modal-body.fade-bottom.svelte-1bxxaoh:after{opacity:1}.modal-footer.svelte-1bxxaoh{padding:14px 20px;border-top:none;display:flex;gap:12px;background:var(--ai-bg-secondary);box-shadow:0 -4px 12px #0000000a;animation:svelte-1bxxaoh-footerSlideUp .3s ease .15s both;position:relative}.modal-footer.svelte-1bxxaoh:before{content:"";position:absolute;top:0;left:20px;right:20px;height:1px;background:linear-gradient(90deg,transparent,var(--ai-primary-light),var(--ai-border-light),transparent);transform:scaleX(0);animation:svelte-1bxxaoh-footerDividerExpand .4s cubic-bezier(.2,.98,.28,1) .25s both;pointer-events:none}@keyframes svelte-1bxxaoh-footerDividerExpand{0%{transform:scaleX(0)}to{transform:scaleX(1)}}.modal-btn.svelte-1bxxaoh{flex:1;padding:11px;border:none;border-radius:10px;font-size:14px;font-weight:700;cursor:pointer;transition:all .35s cubic-bezier(.2,1.04,.42,1);display:flex;align-items:center;justify-content:center;gap:6px}.modal-btn.confirm.svelte-1bxxaoh{background:linear-gradient(135deg,var(--ai-success-dark),var(--ai-success),var(--ai-success-light));color:#fff}.modal-btn.confirm.svelte-1bxxaoh:hover{transform:translateY(-2px) scale(1.015);box-shadow:0 10px 28px var(--ai-success-bg)}.modal-btn.confirm.svelte-1bxxaoh{position:relative;overflow:hidden}.modal-btn.confirm.svelte-1bxxaoh:after{content:"";position:absolute;top:50%;left:50%;width:0;height:0;border-radius:50%;background:#ffffff40;transform:translate(-50%,-50%);pointer-events:none}.modal-btn.confirm.svelte-1bxxaoh:active:after{animation:svelte-1bxxaoh-confirmRipple .5s ease-out}@keyframes svelte-1bxxaoh-confirmRipple{0%{width:0;height:0;opacity:.5}to{width:300px;height:300px;opacity:0}}.modal-btn.confirm.svelte-1bxxaoh:disabled{opacity:.4;cursor:not-allowed;transform:none;box-shadow:none}.modal-btn.confirm.svelte-1bxxaoh:disabled:after{display:none}.modal-btn.cancel.svelte-1bxxaoh{background:var(--ai-border-lighter);color:var(--ai-text-muted)}.modal-btn.cancel.svelte-1bxxaoh:hover{background:var(--ai-bg-tertiary);transform:translate(-2px);opacity:.85}.modal-scroll-indicator.svelte-1bxxaoh{position:sticky;top:0;height:2px;background:linear-gradient(90deg,var(--ai-primary),var(--ai-gradient-accent));opacity:0;transform:scaleX(0);transform-origin:left;transition:opacity .35s ease,transform .35s cubic-bezier(.2,.98,.28,1),width .15s linear,box-shadow .3s ease;z-index:3;border-radius:1px;flex-shrink:0}.modal-scroll-indicator.visible.svelte-1bxxaoh{opacity:1;transform:scaleX(1);box-shadow:var(--ai-indicator-glow)}@keyframes svelte-1bxxaoh-modal-aurora-flow{0%,to{background-position:0% 50%}25%{background-position:100% 25%}50%{background-position:50% 100%}75%{background-position:0% 75%}}@keyframes svelte-1bxxaoh-headerSweep{0%,to{background-position:200% 0}50%{background-position:-200% 0}}@keyframes svelte-1bxxaoh-backdropStardust{0%{opacity:.3}to{opacity:.8}}@keyframes svelte-1bxxaoh-footerSlideUp{0%{opacity:0;transform:translateY(6px)}to{opacity:1;transform:translateY(0)}}@media(prefers-reduced-motion:reduce){.modal-header.svelte-1bxxaoh{animation:none}.modal-header.svelte-1bxxaoh:after{animation:none}.backdrop.svelte-1bxxaoh:before{animation:none;opacity:.5}.modal-header.svelte-1bxxaoh h3:where(.svelte-1bxxaoh){transition:none}.modal-header.svelte-1bxxaoh h3:where(.svelte-1bxxaoh) svg{animation:none}.modal-header.svelte-1bxxaoh:hover h3:where(.svelte-1bxxaoh){letter-spacing:0}.close-btn.svelte-1bxxaoh:hover{transform:none}.modal-body.svelte-1bxxaoh:before,.modal-body.svelte-1bxxaoh:after{transition:none}.modal-footer.svelte-1bxxaoh{animation:none}.modal-footer.svelte-1bxxaoh:before{animation:none;transform:scaleX(1)}.modal-btn.confirm.svelte-1bxxaoh:active:after{animation:none}.modal-btn.cancel.svelte-1bxxaoh:hover{transform:none;opacity:1}.modal-scroll-indicator.svelte-1bxxaoh{transition:none;transform:none}.modal-scroll-indicator.visible.svelte-1bxxaoh{transform:none;box-shadow:none}}.folder-list.svelte-jk545l{max-height:280px;overflow-y:auto;margin-bottom:14px;mask-image:linear-gradient(to bottom,transparent 0px,black 12px,black calc(100% - 12px),transparent 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0px,black 12px,black calc(100% - 12px),transparent 100%);padding-top:4px;padding-bottom:4px}.folder-group.svelte-jk545l{margin-bottom:8px;position:relative;border-left:2px solid transparent;padding-left:6px;animation:svelte-jk545l-dangerAmbient 4s ease-in-out infinite}@keyframes svelte-jk545l-dangerAmbient{0%,to{border-left-color:rgba(var(--ai-error-rgb),.3)}50%{border-left-color:rgba(var(--ai-error-rgb),.6)}}.folder-group.svelte-jk545l+.folder-group:where(.svelte-jk545l):before{content:"";display:block;height:1px;margin:4px 8px 8px;background:var(--ai-divider-gradient);opacity:.5}.folder-header.svelte-jk545l{font-size:12px;font-weight:700;color:var(--ai-text-secondary);padding:4px 0;transition:color .2s ease,letter-spacing .2s ease;cursor:default}.folder-header.svelte-jk545l:hover{color:var(--ai-text);letter-spacing:.02em}.folder-header.svelte-jk545l:after{content:"";display:inline-block;width:0;height:0;margin-left:4px;border-left:3px solid transparent;border-right:3px solid transparent;border-top:4px solid var(--ai-text-muted);vertical-align:middle;transition:transform .25s ease,border-top-color .2s ease}.folder-header.svelte-jk545l:hover:after{transform:translateY(2px);border-top-color:var(--ai-primary)}.video-item.svelte-jk545l{font-size:11px;padding:2px 4px 2px 12px;border-bottom:1px solid var(--ai-border-lighter);border-left:2px solid transparent;color:var(--ai-text-muted);border-radius:4px;transition:background .2s ease,padding-left .2s ease,box-shadow .2s ease,transform .2s ease,border-left-color .2s ease;position:relative;overflow:hidden}.video-item.svelte-jk545l:after{content:"";position:absolute;left:12px;top:50%;height:1px;width:0;background:var(--ai-error);opacity:.5;transition:width .3s cubic-bezier(.2,.98,.28,1);pointer-events:none}.video-item.svelte-jk545l:hover:after{width:calc(100% - 24px)}.video-item.svelte-jk545l:hover{background:var(--ai-bg-hover);padding-left:16px;transform:translateY(-1px);box-shadow:0 2px 8px rgba(var(--ai-primary-rgb),.08);border-left-color:var(--ai-error)}.bfao-modal-summary strong{display:inline-block;animation:svelte-jk545l-emphasisPop .4s cubic-bezier(.22,1.42,.29,1) both}.bfao-modal-summary strong:nth-of-type(1){animation-delay:.3s}.bfao-modal-summary strong:nth-of-type(2){animation-delay:.45s}@keyframes svelte-jk545l-emphasisPop{0%{transform:scale(.8);opacity:.5}60%{transform:scale(1.15)}to{transform:scale(1);opacity:1}}@media(prefers-reduced-motion:reduce){.video-item.svelte-jk545l{transition:none}.video-item.svelte-jk545l:hover{transform:none}.video-item.svelte-jk545l:after{transition:none;display:none}.folder-group.svelte-jk545l{animation:none;border-left-color:rgba(var(--ai-error-rgb),.3)}.bfao-modal-summary strong{animation:none;opacity:1}.folder-header.svelte-jk545l{transition:none}.folder-header.svelte-jk545l:hover{letter-spacing:normal}.folder-header.svelte-jk545l:after{transition:none}.folder-header.svelte-jk545l:hover:after{transform:none}}.dup-list.svelte-xs3gcd{max-height:300px;overflow-y:auto;margin-bottom:14px;mask-image:linear-gradient(to bottom,transparent 0px,black 12px,black calc(100% - 12px),transparent 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0px,black 12px,black calc(100% - 12px),transparent 100%);padding-top:4px;padding-bottom:4px;counter-reset:dup-counter}.dup-item.svelte-xs3gcd{font-size:11px;padding:5px 4px 5px 28px;border-bottom:1px solid var(--ai-border-lighter);border-radius:4px;transition:background .2s ease,padding-left .2s ease,box-shadow .2s ease,transform .2s ease;position:relative;counter-increment:dup-counter}.dup-item.svelte-xs3gcd:before{content:counter(dup-counter);position:absolute;left:4px;top:6px;width:18px;height:18px;border-radius:50%;background:var(--ai-primary-bg);color:var(--ai-primary);font-size:9px;font-weight:700;display:flex;align-items:center;justify-content:center;transition:background .2s ease,color .2s ease;animation:svelte-xs3gcd-counterPop .35s cubic-bezier(.22,1.42,.29,1) backwards;animation-delay:calc(var(--idx, 0) * .04s + .25s)}@keyframes svelte-xs3gcd-counterPop{0%{transform:scale(0);opacity:0}70%{transform:scale(1.2)}to{transform:scale(1);opacity:1}}.dup-item.svelte-xs3gcd:hover:before{background:var(--ai-primary);color:#fff;transform:scale(1.2);box-shadow:0 0 8px rgba(var(--ai-primary-rgb),.3)}.dup-item.svelte-xs3gcd:hover{background:var(--ai-bg-hover);padding-left:32px;transform:translateY(-1px);box-shadow:0 2px 8px rgba(var(--ai-primary-rgb),.08)}.dup-title.svelte-xs3gcd{color:var(--ai-text);transition:color .2s ease}.dup-item.svelte-xs3gcd:hover .dup-title:where(.svelte-xs3gcd){color:var(--ai-primary)}.dup-folders.svelte-xs3gcd{color:var(--ai-text-muted);padding-left:12px;font-size:10px;transition:opacity .2s ease,transform .2s ease;opacity:.7;position:relative}.dup-folders.svelte-xs3gcd:after{content:"";position:absolute;bottom:-1px;left:12px;right:0;height:1px;background:var(--ai-divider-gradient);transform:scaleX(0);transform-origin:left;transition:transform .3s cubic-bezier(.2,.98,.28,1)}.dup-item.svelte-xs3gcd:hover .dup-folders:where(.svelte-xs3gcd):after{transform:scaleX(1)}.dup-item.svelte-xs3gcd+.dup-item:where(.svelte-xs3gcd):before{box-shadow:0 -4px rgba(var(--ai-primary-rgb),.08)}.dup-item.svelte-xs3gcd:hover .dup-folders:where(.svelte-xs3gcd){opacity:1;transform:translate(2px)}.bfao-action-bar.svelte-xs3gcd .bfao-btn-primary:disabled:after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:repeating-linear-gradient(45deg,var(--ai-stripe-overlay) 0px,var(--ai-stripe-overlay) 6px,transparent 6px,transparent 12px);animation:svelte-xs3gcd-dupProcessingStripes .8s linear infinite;border-radius:inherit;pointer-events:none}@keyframes svelte-xs3gcd-dupProcessingStripes{0%{background-position:0 0}to{background-position:17px 0}}.bfao-modal-summary strong.svelte-xs3gcd{color:var(--ai-error);font-size:1.15em;animation:svelte-xs3gcd-dupCountPulse 2s ease-in-out .5s infinite}@keyframes svelte-xs3gcd-dupCountPulse{0%,to{opacity:1}50%{opacity:.7;text-shadow:var(--ai-glow-danger-text)}}.bfao-modal-more{animation:svelte-xs3gcd-moreReveal .4s ease .5s both}@keyframes svelte-xs3gcd-moreReveal{0%{opacity:0;transform:translateY(4px)}to{opacity:.7;transform:translateY(0)}}@media(prefers-reduced-motion:reduce){.dup-item.svelte-xs3gcd{transition:none}.dup-item.svelte-xs3gcd:hover{transform:none}.dup-item.svelte-xs3gcd:before{transition:none;animation:none;opacity:1}.dup-item.svelte-xs3gcd:hover:before{transform:none;box-shadow:none}.dup-folders.svelte-xs3gcd{transition:none}.dup-folders.svelte-xs3gcd:after{transition:none;display:none}.dup-item.svelte-xs3gcd:hover .dup-folders:where(.svelte-xs3gcd){transform:none}.bfao-action-bar.svelte-xs3gcd .bfao-btn-primary:disabled:after{animation:none;display:none}.bfao-modal-summary strong.svelte-xs3gcd{animation:none;opacity:1}.bfao-modal-more{animation:none;opacity:.7}}.hint.svelte-1237wle{font-size:12px;color:var(--ai-text-secondary);margin-bottom:12px;animation:svelte-1237wle-hintSlideIn .3s cubic-bezier(.2,.98,.28,1) both;position:relative;display:inline-block}.hint.svelte-1237wle:after{content:"";position:absolute;bottom:-3px;left:0;width:100%;height:1px;background:var(--ai-divider-gradient);transform:scaleX(0);transform-origin:left;animation:svelte-1237wle-hintLineExpand .4s cubic-bezier(.2,.98,.28,1) .4s both}@keyframes svelte-1237wle-hintLineExpand{0%{transform:scaleX(0)}to{transform:scaleX(1)}}.history-list.svelte-1237wle{display:flex;flex-direction:column;gap:6px;max-height:320px;overflow-y:auto;mask-image:linear-gradient(to bottom,transparent 0%,black 12px,black calc(100% - 12px),transparent 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0%,black 12px,black calc(100% - 12px),transparent 100%);position:relative}.history-list.processing.svelte-1237wle:after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(90deg,transparent 0%,var(--ai-shimmer-overlay) 50%,transparent 100%);background-size:200% 100%;animation:svelte-1237wle-undoShimmer 1.5s ease-in-out infinite;pointer-events:none;border-radius:8px}@keyframes svelte-1237wle-undoShimmer{0%{background-position:-200% 0}to{background-position:200% 0}}.item-info.svelte-1237wle{flex:1}.item-time.svelte-1237wle{font-size:12px;font-weight:600;color:var(--ai-text);transition:text-shadow .25s ease,transform .25s ease,color .25s ease}.bfao-selectable-item:hover .item-time.svelte-1237wle{text-shadow:var(--ai-glow-text-hover);transform:translate(1px);color:var(--ai-primary)}.bfao-selectable-item.selected .item-time.svelte-1237wle{text-shadow:var(--ai-glow-text-hover);color:var(--ai-primary)}.item-detail.svelte-1237wle{font-size:11px;color:var(--ai-text-muted);margin-top:2px}.bfao-selectable-item{transition:border-color .25s ease,background .25s ease,transform .2s cubic-bezier(.2,1.04,.42,1)!important}.bfao-selectable-item:hover:not(.selected){background:var(--ai-bg-hover)}.bfao-selectable-item.selected{transform:translate(2px);animation:svelte-1237wle-selectPulse .4s ease;box-shadow:inset 3px 0 0 var(--ai-primary),var(--ai-glow-selected)}@keyframes svelte-1237wle-selectPulse{0%{box-shadow:0 0 rgba(var(--ai-primary-rgb),.3)}50%{box-shadow:0 0 0 4px rgba(var(--ai-primary-rgb),.15)}to{box-shadow:inset 3px 0 0 var(--ai-primary),var(--ai-glow-selected)}}@keyframes svelte-1237wle-hintSlideIn{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}@media(prefers-reduced-motion:reduce){.bfao-selectable-item.selected,.hint.svelte-1237wle{animation:none}.hint.svelte-1237wle:after{animation:none;transform:scaleX(1)}.item-time.svelte-1237wle{transition:none}.bfao-selectable-item:hover .item-time.svelte-1237wle{text-shadow:none;transform:none}.history-list.processing.svelte-1237wle:after{animation:none;display:none}}.timeline.svelte-qj4dz7{position:relative;padding-left:20px}.timeline.svelte-qj4dz7:before{content:"";position:absolute;left:7px;top:0;bottom:0;width:2px;background:linear-gradient(to bottom,var(--ai-primary),var(--ai-border) 70%,transparent);transform-origin:top;animation:svelte-qj4dz7-lineGrow .6s cubic-bezier(.2,.98,.28,1) both}.timeline.svelte-qj4dz7:after{content:"";position:absolute;left:6px;top:0;width:4px;height:12px;border-radius:2px;background:var(--ai-primary);box-shadow:0 0 8px rgba(var(--ai-primary-rgb),.5);opacity:.6;animation:svelte-qj4dz7-timelineDotFadeIn .4s ease .6s both,svelte-qj4dz7-timelinePulseFlow 3s linear 1s infinite;pointer-events:none}@keyframes svelte-qj4dz7-lineGrow{0%{transform:scaleY(0)}to{transform:scaleY(1)}}@keyframes svelte-qj4dz7-timelineDotFadeIn{0%{opacity:0}to{opacity:.6}}@keyframes svelte-qj4dz7-timelinePulseFlow{0%{top:0;opacity:0}10%{opacity:.7}80%{opacity:.4}to{top:calc(100% - 12px);opacity:0}}.timeline-item.svelte-qj4dz7{position:relative;margin-bottom:16px;animation:svelte-qj4dz7-slideIn .3s ease calc(var(--i) * .05s) both}.timeline-dot.svelte-qj4dz7{position:absolute;left:-17px;top:6px;width:10px;height:10px;border-radius:50%;background:var(--ai-primary);border:2px solid var(--ai-bg);box-shadow:0 0 0 2px var(--ai-primary-light);transition:transform .3s ease,box-shadow .3s ease}.timeline-item.svelte-qj4dz7:hover .timeline-dot:where(.svelte-qj4dz7){transform:scale(1.4);box-shadow:0 0 0 3px var(--ai-primary-light),0 0 10px rgba(var(--ai-primary-rgb),.4)}.timeline-card.svelte-qj4dz7{padding:8px 12px;background:var(--ai-bg-tertiary);border-radius:10px;border:1px solid var(--ai-border-lighter);transition:transform .25s ease,box-shadow .25s ease;position:relative}.timeline-item.svelte-qj4dz7:hover .timeline-card:where(.svelte-qj4dz7){transform:translateY(-2px);box-shadow:inset 0 0 0 1px rgba(var(--ai-primary-rgb),.12),0 4px 12px rgba(var(--ai-primary-rgb),.1)}.timeline-time.svelte-qj4dz7{font-size:10px;color:var(--ai-text-muted);margin-bottom:4px;transition:letter-spacing .3s ease,color .25s ease;animation:svelte-qj4dz7-timelineContentReveal .3s ease calc(var(--i) * .05s + .05s) both}.timeline-item.svelte-qj4dz7:hover .timeline-time:where(.svelte-qj4dz7){letter-spacing:.03em;color:var(--ai-primary)}.timeline-detail.svelte-qj4dz7{font-size:12px;color:var(--ai-text);animation:svelte-qj4dz7-timelineContentReveal .3s ease calc(var(--i) * .05s + .12s) both}.timeline-detail.svelte-qj4dz7 strong:where(.svelte-qj4dz7){color:var(--ai-primary)}.timeline-cats.svelte-qj4dz7{font-size:10px;color:var(--ai-text-muted);margin-top:4px;line-height:1.4;background:var(--ai-bg-hover);border-radius:4px;padding:3px 6px;border:1px solid transparent;transition:background .2s ease,color .2s ease,transform .25s ease,border-color .25s ease;animation:svelte-qj4dz7-timelineContentReveal .3s ease calc(var(--i) * .05s + .2s) both}.timeline-item.svelte-qj4dz7:hover .timeline-cats:where(.svelte-qj4dz7){background:var(--ai-primary-bg);color:var(--ai-text-secondary);transform:translateY(-1px);border:1px solid rgba(var(--ai-primary-rgb),.15)}.clear-btn.svelte-qj4dz7:hover{color:var(--ai-error);animation:svelte-qj4dz7-clearShake .4s ease;box-shadow:0 0 12px rgba(var(--ai-error-rgb),.2)}.clear-btn.svelte-qj4dz7 svg{transition:transform .3s cubic-bezier(.2,.98,.28,1)}.clear-btn.svelte-qj4dz7:hover svg{transform:rotate(180deg)}.timeline-item.svelte-qj4dz7:first-child .timeline-card:where(.svelte-qj4dz7){border-left:2px solid var(--ai-primary);background:var(--ai-bg-hover);animation:svelte-qj4dz7-latestGlow 3s ease-in-out .8s infinite}.timeline-item.svelte-qj4dz7:first-child .timeline-card:where(.svelte-qj4dz7):after{content:"\u6700\u65B0";position:absolute;top:-6px;right:8px;font-size:8px;font-weight:700;color:#fff;background:var(--ai-primary);padding:1px 6px;border-radius:6px;letter-spacing:.05em;animation:svelte-qj4dz7-latestBadgePop .4s cubic-bezier(.22,1.42,.29,1) .6s both;pointer-events:none}@keyframes svelte-qj4dz7-latestBadgePop{0%{transform:scale(0);opacity:0}70%{transform:scale(1.15)}to{transform:scale(1);opacity:1}}@keyframes svelte-qj4dz7-timelineContentReveal{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}@keyframes svelte-qj4dz7-latestGlow{0%,to{box-shadow:inset 0 0 0 1px rgba(var(--ai-primary-rgb),.12),0 4px 12px rgba(var(--ai-primary-rgb),.1)}50%{box-shadow:inset 0 0 0 1px rgba(var(--ai-primary-rgb),.2),var(--ai-glow-breath-strong)}}.timeline-dot.svelte-qj4dz7{animation:svelte-qj4dz7-dotPulse .6s ease calc(var(--i) * .05s + .3s),svelte-qj4dz7-dotChainPulse 1.5s ease-in-out calc(var(--i) * .3s + 1s) infinite}@keyframes svelte-qj4dz7-dotChainPulse{0%,to{box-shadow:0 0 0 2px var(--ai-primary-light)}50%{box-shadow:0 0 0 4px rgba(var(--ai-primary-rgb),.25),0 0 8px rgba(var(--ai-primary-rgb),.15)}}.timeline-card.svelte-qj4dz7:before{content:"";position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,transparent,var(--ai-primary-light),transparent);transform:scaleX(0);transition:transform .3s cubic-bezier(.2,.98,.28,1);pointer-events:none}.timeline-item.svelte-qj4dz7:hover .timeline-card:where(.svelte-qj4dz7):before{transform:scaleX(1)}.bfao-modal-empty{animation:svelte-qj4dz7-emptyBreath 3s ease-in-out infinite}@keyframes svelte-qj4dz7-emptyBreath{0%,to{opacity:.5;transform:translateY(0)}50%{opacity:.8;transform:translateY(-2px)}}.timeline-cats.svelte-qj4dz7:hover{border-left:2px solid var(--ai-gradient-accent);padding-left:4px}@keyframes svelte-qj4dz7-slideIn{0%{opacity:0;transform:translate(-10px)}to{opacity:1;transform:translate(0)}}@keyframes svelte-qj4dz7-clearShake{0%,to{margin-left:0}20%{margin-left:-2px}40%{margin-left:2px}60%{margin-left:-1.5px}80%{margin-left:1px}}@keyframes svelte-qj4dz7-dotPulse{0%{box-shadow:0 0 0 2px var(--ai-primary-light)}50%{box-shadow:0 0 0 5px rgba(var(--ai-primary-rgb),.3),0 0 12px rgba(var(--ai-primary-rgb),.2)}to{box-shadow:0 0 0 2px var(--ai-primary-light)}}@media(prefers-reduced-motion:reduce){.clear-btn.svelte-qj4dz7:hover,.timeline-dot.svelte-qj4dz7{animation:none}.timeline-item.svelte-qj4dz7{animation:none;opacity:1}.timeline.svelte-qj4dz7:before{animation:none;transform:scaleY(1)}.timeline.svelte-qj4dz7:after{animation:none;display:none}.timeline-item.svelte-qj4dz7:first-child .timeline-card:where(.svelte-qj4dz7){animation:none}.timeline-time.svelte-qj4dz7{transition:none;animation:none;opacity:1}.timeline-detail.svelte-qj4dz7,.timeline-cats.svelte-qj4dz7{animation:none;opacity:1}.timeline-item.svelte-qj4dz7:first-child .timeline-card:where(.svelte-qj4dz7):after{animation:none;opacity:1}.clear-btn.svelte-qj4dz7 svg{transition:none}.clear-btn.svelte-qj4dz7:hover svg{transform:none}.timeline-cats.svelte-qj4dz7{transition:none}.timeline-cats.svelte-qj4dz7:hover{border-left:none;padding-left:6px}.timeline-item.svelte-qj4dz7:hover .timeline-cats:where(.svelte-qj4dz7){transform:none}.timeline-card.svelte-qj4dz7:before{transition:none;display:none}.bfao-modal-empty{animation:none;opacity:.5}}.health-score.svelte-l1lb8j{position:relative;display:flex;align-items:center;justify-content:center;padding:16px 0 8px}.health-ring.svelte-l1lb8j{display:block;margin:0 auto;filter:drop-shadow(0 0 8px currentColor);transition:filter .3s ease;animation:svelte-l1lb8j-ringGlow 2.5s ease-in-out 1.5s infinite;position:relative}.health-score.svelte-l1lb8j:after{content:"";position:absolute;width:5px;height:5px;border-radius:50%;background:currentColor;box-shadow:0 0 6px currentColor,0 0 12px currentColor;top:calc(50% - 38px);left:calc(50% - 2.5px);transform-origin:2.5px 54px;animation:svelte-l1lb8j-ringOrbitDot 4s linear 1.5s infinite;opacity:0;pointer-events:none}@keyframes svelte-l1lb8j-ringOrbitDot{0%{transform:rotate(0);opacity:.7}80%{opacity:.7}to{transform:rotate(360deg);opacity:.7}}@keyframes svelte-l1lb8j-ringGlow{0%,to{filter:drop-shadow(0 0 8px currentColor)}50%{filter:drop-shadow(0 0 16px currentColor) drop-shadow(0 0 4px currentColor)}}.score-overlay.svelte-l1lb8j{position:absolute;top:0;right:0;bottom:0;left:0;display:flex;flex-direction:column;align-items:center;justify-content:center;padding-top:16px}.score-number.svelte-l1lb8j{font-size:36px;font-weight:800;line-height:1;text-shadow:0 0 12px currentColor}.score-label.svelte-l1lb8j{font-size:12px;opacity:.7;margin-top:4px}.health-detail.svelte-l1lb8j{text-align:center;font-size:13px;color:var(--ai-text-secondary);margin-bottom:16px;animation:svelte-l1lb8j-healthFadeUp .5s cubic-bezier(.2,.98,.28,1) 1.2s both}@keyframes svelte-l1lb8j-healthFadeUp{0%{opacity:0;transform:translateY(6px)}to{opacity:1;transform:translateY(0)}}.stats-grid.svelte-l1lb8j{display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-bottom:16px}.stat-card.svelte-l1lb8j{padding:12px;background:var(--ai-bg-tertiary);border-radius:12px;text-align:center;border:1px solid var(--ai-border-lighter);transition:border-color .3s ease,box-shadow .3s ease,transform .3s cubic-bezier(.2,.98,.28,1);animation:svelte-l1lb8j-cardPop .35s cubic-bezier(.22,1.42,.29,1) both;position:relative}.stat-card.svelte-l1lb8j .card-shimmer:where(.svelte-l1lb8j){position:absolute;top:0;right:0;bottom:0;left:0;overflow:hidden;border-radius:inherit;pointer-events:none;z-index:1}.stat-card.svelte-l1lb8j .card-shimmer:where(.svelte-l1lb8j):before{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(120deg,transparent 0%,transparent 35%,rgba(255,255,255,.15) 50%,transparent 65%,transparent 100%);transform:translate(-100%)}.stat-card.svelte-l1lb8j:hover .card-shimmer:where(.svelte-l1lb8j):before{animation:svelte-l1lb8j-cardShimmerSweep .6s ease forwards}.stat-card.svelte-l1lb8j:nth-child(2n):before{content:"";position:absolute;left:-6px;top:20%;bottom:20%;width:1px;background:var(--ai-divider-gradient);opacity:.5}.stat-card.svelte-l1lb8j:nth-child(n+3):after{content:"";position:absolute;top:-6px;left:20%;right:20%;height:1px;background:var(--ai-divider-gradient);opacity:.5}.stats-grid.svelte-l1lb8j .stat-card:where(.svelte-l1lb8j):nth-child(1){animation-delay:.1s}.stats-grid.svelte-l1lb8j .stat-card:where(.svelte-l1lb8j):nth-child(2){animation-delay:.16s}.stats-grid.svelte-l1lb8j .stat-card:where(.svelte-l1lb8j):nth-child(3){animation-delay:.22s}.stats-grid.svelte-l1lb8j .stat-card:where(.svelte-l1lb8j):nth-child(4){animation-delay:.28s}@keyframes svelte-l1lb8j-cardPop{0%{opacity:0;transform:scale(.85) translateY(8px)}to{opacity:1;transform:scale(1) translateY(0)}}.stat-card.svelte-l1lb8j:hover{border-color:var(--ai-primary-light);box-shadow:0 0 12px rgba(var(--ai-primary-rgb),.15)}.stat-value.svelte-l1lb8j{font-size:22px;font-weight:800;color:var(--ai-primary);transition:filter .25s ease,transform .25s cubic-bezier(.2,.98,.28,1),text-shadow .25s ease}.stat-card.svelte-l1lb8j:hover .stat-value:where(.svelte-l1lb8j){filter:brightness(1.2);transform:scale(1.08);text-shadow:0 0 16px currentColor}.stat-value.danger.svelte-l1lb8j{color:var(--ai-error);transition:text-shadow .3s ease,filter .25s ease,transform .25s cubic-bezier(.2,.98,.28,1)}.stat-card.svelte-l1lb8j:hover .stat-value.danger:where(.svelte-l1lb8j){text-shadow:var(--ai-glow-danger-text)}.stat-label.svelte-l1lb8j{font-size:11px;color:var(--ai-text-muted);margin-top:2px;transition:letter-spacing .3s ease,opacity .3s ease}.stat-card.svelte-l1lb8j:hover .stat-label:where(.svelte-l1lb8j){letter-spacing:.06em;opacity:1;color:var(--ai-text-secondary)}.section-title.svelte-l1lb8j{font-size:12px;font-weight:600;color:var(--ai-text-secondary);margin-bottom:8px;position:relative;padding-bottom:6px;padding-left:14px;overflow:hidden}.section-title.svelte-l1lb8j .pulse-dot:where(.svelte-l1lb8j){position:absolute;left:0;top:50%;transform:translateY(-50%);width:6px;height:6px;border-radius:50%;background:var(--ai-primary);animation:svelte-l1lb8j-sectionPulseDot 1.5s ease-in-out infinite;pointer-events:none}@keyframes svelte-l1lb8j-sectionPulseDot{0%,to{opacity:1;box-shadow:0 0 rgba(var(--ai-primary-rgb),.4)}50%{opacity:.6;box-shadow:0 0 0 4px rgba(var(--ai-primary-rgb),0)}}.section-title.svelte-l1lb8j:before{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(120deg,transparent 30%,var(--ai-shimmer-color) 50%,transparent 70%);transform:translate(-100%);animation:svelte-l1lb8j-sectionTitleSweep 4s ease .8s infinite;pointer-events:none}@keyframes svelte-l1lb8j-sectionTitleSweep{0%,85%{transform:translate(-100%)}to{transform:translate(200%)}}.section-title.svelte-l1lb8j:after{content:"";position:absolute;bottom:0;left:0;width:40px;height:2px;background:linear-gradient(90deg,var(--ai-primary),transparent);border-radius:1px;transform:scaleX(0);transform-origin:left;animation:svelte-l1lb8j-titleLineExpand .4s cubic-bezier(.2,.98,.28,1) .35s both}@keyframes svelte-l1lb8j-titleLineExpand{0%{transform:scaleX(0)}to{transform:scaleX(1)}}.folder-breakdown.svelte-l1lb8j{max-height:200px;overflow-y:auto;mask-image:linear-gradient(to bottom,transparent 0px,black 12px,black calc(100% - 12px),transparent 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0px,black 12px,black calc(100% - 12px),transparent 100%);padding-top:4px;padding-bottom:4px;counter-reset:folder-idx}.folder-row.svelte-l1lb8j{display:flex;justify-content:space-between;padding:4px 4px 4px 24px;border-bottom:1px solid var(--ai-border-lighter);font-size:11px;border-radius:4px;transition:background .2s ease,transform .2s ease;counter-increment:folder-idx;position:relative;overflow:hidden}.folder-row.svelte-l1lb8j:after{content:"";position:absolute;left:24px;bottom:0;height:2px;width:calc(var(--ratio, 0) * (100% - 24px));background:linear-gradient(90deg,var(--ai-primary),var(--ai-gradient-accent));border-radius:1px;opacity:.35;transform:scaleX(0);transform-origin:left;animation:svelte-l1lb8j-ratioBarGrow .5s cubic-bezier(.2,.98,.28,1) .4s both;transition:opacity .2s ease}.folder-row.svelte-l1lb8j:hover:after{opacity:.7;box-shadow:0 0 4px rgba(var(--ai-primary-rgb),.3)}.folder-row.svelte-l1lb8j:before{content:counter(folder-idx);position:absolute;left:4px;top:50%;transform:translateY(-50%);width:16px;height:16px;border-radius:50%;background:var(--ai-bg-tertiary);color:var(--ai-text-muted);font-size:9px;font-weight:700;display:flex;align-items:center;justify-content:center;transition:background .2s ease,color .2s ease}.folder-row.svelte-l1lb8j:hover:before{background:var(--ai-primary);color:#fff}.folder-row.svelte-l1lb8j:hover{background:var(--ai-bg-hover);transform:translate(2px);box-shadow:inset 0 0 0 1px rgba(var(--ai-primary-rgb),.1),0 0 6px rgba(var(--ai-primary-rgb),.06)}.folder-name.svelte-l1lb8j{color:var(--ai-text);flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin-right:8px}.folder-count.svelte-l1lb8j{color:var(--ai-text-muted);white-space:nowrap}@keyframes svelte-l1lb8j-cardShimmerSweep{0%{transform:translate(-100%)}to{transform:translate(100%)}}@keyframes svelte-l1lb8j-ratioBarGrow{0%{transform:scaleX(0)}75%{transform:scaleX(1.04)}to{transform:scaleX(1)}}@media(prefers-reduced-motion:reduce){.stat-card.svelte-l1lb8j{transition:none;animation:none;opacity:1}.stat-value.svelte-l1lb8j{transition:none}.stat-card.svelte-l1lb8j:hover .stat-value:where(.svelte-l1lb8j){transform:none}.folder-row.svelte-l1lb8j{transition:none}.folder-row.svelte-l1lb8j:hover{transform:none}.folder-row.svelte-l1lb8j:before{transition:none}.folder-row.svelte-l1lb8j:after{animation:none;transform:scaleX(1)}.stat-card.svelte-l1lb8j:hover .card-shimmer:where(.svelte-l1lb8j):before{animation:none}.section-title.svelte-l1lb8j:after{animation:none;transform:scaleX(1)}.section-title.svelte-l1lb8j:before{animation:none;display:none}.section-title.svelte-l1lb8j .pulse-dot:where(.svelte-l1lb8j){animation:none;opacity:1}.health-ring.svelte-l1lb8j{animation:none}.health-score.svelte-l1lb8j:after{animation:none;display:none}.health-detail.svelte-l1lb8j{animation:none;opacity:1}}.selector-content.svelte-184y11r{padding:12px 20px 16px}.toolbar.svelte-184y11r{display:flex;align-items:center;justify-content:space-between;margin-bottom:12px}.toggle-all.svelte-184y11r{display:flex;align-items:center;gap:6px;background:none;border:1.5px solid var(--ai-border);border-radius:8px;padding:6px 12px;font-size:12px;color:var(--ai-text-secondary);cursor:pointer;transition:all .2s ease;position:relative;overflow:visible}.toggle-all.svelte-184y11r:hover{border-color:var(--ai-primary-light);background:var(--ai-bg-tertiary)}.toggle-all.svelte-184y11r:before{content:"";position:absolute;bottom:0;left:10%;right:10%;height:1.5px;background:var(--ai-divider-gradient);border-radius:1px;transform:scaleX(0);transition:transform .3s cubic-bezier(.2,.98,.28,1);pointer-events:none}.toggle-all.svelte-184y11r:hover:before{transform:scaleX(1)}.toggle-all.svelte-184y11r:after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;border-radius:8px;box-shadow:0 0 0 0 var(--ai-pulse-spread-color);opacity:0;pointer-events:none}.toggle-all.svelte-184y11r:active{transform:scale(.95);box-shadow:0 0 0 3px rgba(var(--ai-primary-rgb),.15)}.toggle-all.svelte-184y11r:active:after{animation:svelte-184y11r-togglePulse .5s ease-out}.toggle-all.svelte-184y11r svg{transition:transform .35s cubic-bezier(.2,.98,.28,1)}.toggle-all.svelte-184y11r:active svg{transform:scaleY(-1) scale(.9)}.count.svelte-184y11r{font-size:12px;color:var(--ai-text-muted);display:inline-block;animation:svelte-184y11r-countPop .4s cubic-bezier(.22,1.42,.29,1) .2s both;transition:color .25s ease}.count.has-selected.svelte-184y11r{color:var(--ai-primary);font-weight:600}@keyframes svelte-184y11r-countPop{0%{transform:scale(0);opacity:0}70%{transform:scale(1.1)}to{transform:scale(1);opacity:1}}@keyframes svelte-184y11r-countBounce{0%{transform:scale(1)}40%{transform:scale(1.15)}to{transform:scale(1)}}.folder-list.svelte-184y11r{display:flex;flex-direction:column;gap:6px;max-height:340px;overflow-y:auto;mask-image:linear-gradient(to bottom,transparent 0px,black 12px,black calc(100% - 12px),transparent 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0px,black 12px,black calc(100% - 12px),transparent 100%);padding-top:4px;padding-bottom:4px}.folder-info.svelte-184y11r{flex:1}.bfao-selectable-item{transition:transform .2s cubic-bezier(.2,1.04,.42,1),box-shadow .2s ease!important}.bfao-selectable-item:hover:not(.selected){box-shadow:inset 0 0 0 1px rgba(var(--ai-primary-rgb),.15),0 0 8px rgba(var(--ai-primary-rgb),.08)}.bfao-selectable-item.selected{transform:translate(2px);box-shadow:inset 3px 0 0 var(--ai-primary);position:relative}.bfao-selectable-item.selected:after{content:"";position:absolute;right:0;top:20%;height:60%;width:2px;background:linear-gradient(to bottom,transparent,var(--ai-primary-light),transparent);border-radius:1px;animation:svelte-184y11r-selectedArc .3s cubic-bezier(.2,.98,.28,1) both}@keyframes svelte-184y11r-selectedArc{0%{transform:scaleY(0);opacity:0}to{transform:scaleY(1);opacity:.7}}.folder-title.svelte-184y11r{font-size:13px;font-weight:600;color:var(--ai-text);transition:color .2s ease,font-weight .2s ease,letter-spacing .25s ease}.bfao-selectable-item:hover .folder-title.svelte-184y11r{letter-spacing:.03em}.bfao-selectable-item.selected .folder-title.svelte-184y11r{color:var(--ai-primary);font-weight:700}.folder-count.svelte-184y11r{font-size:11px;color:var(--ai-text-muted);margin-top:2px;transition:color .2s ease,transform .25s cubic-bezier(.22,1.42,.29,1),font-weight .2s ease}.bfao-selectable-item:hover .folder-count.svelte-184y11r{color:var(--ai-primary-light)}.bfao-selectable-item.selected .folder-count.svelte-184y11r{color:var(--ai-primary);font-weight:600;animation:svelte-184y11r-countFlash .3s cubic-bezier(.22,1.42,.29,1)}@keyframes svelte-184y11r-countFlash{0%{transform:translateY(0)}40%{transform:translateY(-2px);color:var(--ai-primary-light)}to{transform:translateY(0)}}@keyframes svelte-184y11r-togglePulse{0%{box-shadow:0 0 0 0 var(--ai-pulse-spread-color);opacity:.6}to{box-shadow:0 0 0 10px var(--ai-pulse-spread-color);opacity:0}}@media(prefers-reduced-motion:reduce){.toggle-all.svelte-184y11r:active:after{animation:none}.toggle-all.svelte-184y11r:before{transition:none;display:none}.toggle-all.svelte-184y11r svg{transition:none}.folder-title.svelte-184y11r{transition:none}.bfao-selectable-item:hover .folder-title.svelte-184y11r{letter-spacing:normal}.bfao-selectable-item.selected:after{animation:none;display:none}.folder-count.svelte-184y11r{transition:none}.bfao-selectable-item.selected .folder-count.svelte-184y11r{animation:none}.count.svelte-184y11r{transition:none}}.video-item.svelte-9tq2cj{display:flex;align-items:center;gap:10px;padding:6px 10px;border-radius:8px;background:var(--ai-bg-secondary);font-size:12px;height:60px;border-left:2px solid transparent;transition:transform .2s ease,box-shadow .2s ease,background .2s ease,border-color .25s ease}.video-item.svelte-9tq2cj:hover{transform:translateY(-1px);box-shadow:0 2px 8px #00000014;background:var(--ai-bg-tertiary);border-left-color:var(--ai-primary)}.video-item.virtual-item.svelte-9tq2cj{position:absolute;left:0;right:0}.video-thumb-wrap.svelte-9tq2cj{position:relative;width:80px;height:45px;flex-shrink:0;border-radius:6px;overflow:hidden;background:var(--ai-bg-tertiary)}.video-thumb.svelte-9tq2cj{width:100%;height:100%;object-fit:cover;cursor:zoom-in;transition:filter .2s ease,transform .25s cubic-bezier(.2,.98,.28,1)}.video-thumb-wrap.svelte-9tq2cj:hover .video-thumb:where(.svelte-9tq2cj){filter:brightness(1.1);transform:scale(1.05)}.video-thumb-placeholder.svelte-9tq2cj{width:100%;height:100%;background:linear-gradient(90deg,var(--ai-bg-tertiary) 25%,var(--ai-border-lighter) 50%,var(--ai-bg-tertiary) 75%);background-size:200% 100%;animation:svelte-9tq2cj-placeholderShimmer 1.8s ease-in-out infinite}.video-duration.svelte-9tq2cj{position:absolute;bottom:2px;right:2px;font-size:10px;background:#000000b3;color:#fff;padding:1px 4px;border-radius:3px;line-height:1.2;transition:transform .2s cubic-bezier(.2,1.04,.42,1),background .2s ease}.video-item.svelte-9tq2cj:hover .video-duration:where(.svelte-9tq2cj){transform:scale(1.08);background:#000000d9;box-shadow:0 0 6px #0006}.video-info.svelte-9tq2cj{flex:1;min-width:0;display:flex;flex-direction:column;gap:3px}.video-title.svelte-9tq2cj{color:var(--ai-text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:12px}.video-uploader.svelte-9tq2cj{font-size:11px;color:var(--ai-text-muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;transition:opacity .2s ease,transform .2s ease;opacity:.7;position:relative}.video-uploader.svelte-9tq2cj:after{content:"";position:absolute;bottom:-1px;left:0;width:100%;height:1px;background:var(--ai-primary-light);transform:scaleX(0);transform-origin:left;transition:transform .3s cubic-bezier(.2,.98,.28,1)}.video-item.svelte-9tq2cj:hover .video-uploader:where(.svelte-9tq2cj){opacity:1;transform:translate(2px)}.video-item.svelte-9tq2cj:hover .video-uploader:where(.svelte-9tq2cj):after{transform:scaleX(1)}.conf.svelte-9tq2cj{font-size:10px;font-weight:600;color:var(--ai-success-dark);background:var(--ai-success-bg);padding:1px 6px;border-radius:6px;white-space:nowrap;flex-shrink:0;animation:svelte-9tq2cj-confPop .35s cubic-bezier(.2,1.2,.4,1) both}.conf.low.svelte-9tq2cj{color:var(--ai-warning-dark);background:var(--ai-warning-bg);animation:svelte-9tq2cj-confLowPulse 2s ease-in-out infinite}.video-item.stagger-reveal.svelte-9tq2cj{animation:svelte-9tq2cj-itemReveal .3s cubic-bezier(.2,.98,.28,1) both}@keyframes svelte-9tq2cj-confLowPulse{0%,to{opacity:1;box-shadow:none}50%{opacity:.8;box-shadow:0 0 0 2px var(--ai-warning-bg)}}@keyframes svelte-9tq2cj-itemReveal{0%{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}@keyframes svelte-9tq2cj-confPop{0%{transform:scale(.5);opacity:0}70%{transform:scale(1.12)}to{transform:scale(1);opacity:1}}@keyframes svelte-9tq2cj-placeholderShimmer{0%{background-position:200% 0}to{background-position:-200% 0}}@media(prefers-reduced-motion:reduce){.video-item.svelte-9tq2cj{transition:none}.video-thumb.svelte-9tq2cj{transition:filter .15s}.video-item.stagger-reveal.svelte-9tq2cj,.conf.svelte-9tq2cj,.conf.low.svelte-9tq2cj,.video-thumb-placeholder.svelte-9tq2cj{animation:none}.video-uploader.svelte-9tq2cj:after{transition:none;display:none}}.category-group.svelte-t28wkk{border:1.5px solid rgba(var(--ai-primary-rgb),.25);border-radius:10px;overflow:hidden;background:var(--ai-bg);transition:transform .25s ease,box-shadow .25s ease,border-color .25s ease}.category-group.svelte-t28wkk:hover{transform:translateY(-1px);border-color:rgba(var(--ai-primary-rgb),.45);box-shadow:0 4px 16px rgba(var(--ai-primary-rgb),.1),0 4px 12px #00000014}.category-group.merge-source.svelte-t28wkk{border-color:var(--ai-primary);background:var(--ai-bg-tertiary);animation:svelte-t28wkk-mergeSourcePulse 2s ease-in-out infinite;box-shadow:none}.category-header.svelte-t28wkk{width:100%;display:flex;align-items:center;gap:8px;padding:10px 14px;min-height:44px;background:none;border:none;text-align:left;box-sizing:border-box}.category-header.svelte-t28wkk:hover{background:var(--ai-bg-tertiary)}.category-header.svelte-t28wkk input[type=checkbox]:where(.svelte-t28wkk){width:16px;height:16px;accent-color:var(--ai-primary);cursor:pointer;flex-shrink:0}.expand-btn.svelte-t28wkk{display:flex;color:var(--ai-text-muted);background:none;border:none;cursor:pointer;padding:2px;flex-shrink:0;border-radius:4px;transition:transform .25s ease,color .2s,box-shadow .25s ease}.expand-btn.svelte-t28wkk:hover{box-shadow:0 0 0 3px rgba(var(--ai-primary-rgb),.12)}.expand-btn.expanded.svelte-t28wkk{transform:rotate(90deg);color:var(--ai-primary);transition:transform .3s cubic-bezier(.34,1.56,.64,1),color .2s,box-shadow .25s ease}.category-name.svelte-t28wkk{flex:1;font-size:13px;font-weight:600;color:var(--ai-text);cursor:pointer;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;transition:color .25s ease}.category-header.svelte-t28wkk:hover .category-name:where(.svelte-t28wkk){color:var(--ai-primary)}.badge.svelte-t28wkk{font-size:10px;padding:1px 6px;border-radius:6px;font-weight:600;flex-shrink:0;animation:svelte-t28wkk-badgePop .35s cubic-bezier(.2,1.2,.4,1) both}.badge-existing.svelte-t28wkk{background:var(--ai-success-bg);color:var(--ai-success-dark)}.badge-new.svelte-t28wkk{background:var(--ai-error-bg, rgba(239, 68, 68, .1));color:var(--ai-error, #ef4444);position:relative;overflow:hidden}.badge-new.svelte-t28wkk:after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(90deg,transparent 0%,var(--ai-shimmer-color) 50%,transparent 100%);animation:svelte-t28wkk-badgeShimmer 3s ease-in-out .5s infinite;pointer-events:none}.conf-avg.svelte-t28wkk{font-size:10px;font-weight:600;color:var(--ai-success-dark);flex-shrink:0}.conf-avg.low.svelte-t28wkk{color:var(--ai-warning-dark);animation:svelte-t28wkk-confAvgPulse 2s ease-in-out infinite}.category-count.svelte-t28wkk{font-size:11px;color:var(--ai-text-muted);background:var(--ai-bg-secondary);padding:2px 8px;border-radius:8px;flex-shrink:0;transition:transform .25s cubic-bezier(.2,1.04,.42,1),background .25s ease,color .25s ease}.category-header.svelte-t28wkk:hover .category-count:where(.svelte-t28wkk){transform:scale(1.05);background:rgba(var(--ai-primary-rgb),.1);color:var(--ai-primary)}.remove-btn.svelte-t28wkk{display:flex;align-items:center;gap:3px;padding:3px 8px;font-size:10px;font-weight:600;border-radius:6px;border:1px solid var(--ai-border);background:var(--ai-bg-secondary);color:var(--ai-text-muted);cursor:pointer;flex-shrink:0;transition:all .2s}.remove-btn.svelte-t28wkk svg{transition:transform .25s cubic-bezier(.2,.98,.28,1)}.remove-btn.svelte-t28wkk:hover svg{transform:rotate(-90deg)}.remove-btn.svelte-t28wkk:hover{border-color:var(--ai-error, #ef4444);color:var(--ai-error, #ef4444);background:var(--ai-error-bg, rgba(239, 68, 68, .1));box-shadow:var(--ai-glow-danger);animation:svelte-t28wkk-removeShake .4s ease-in-out}.video-list.svelte-t28wkk{padding:0 12px 10px;display:flex;flex-direction:column;gap:4px;max-height:408px;overflow-y:auto;mask-image:linear-gradient(to bottom,transparent 0%,black 12px,black calc(100% - 12px),transparent 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0%,black 12px,black calc(100% - 12px),transparent 100%)}.video-list.virtual-scroll.svelte-t28wkk{overflow-y:auto;position:relative;display:block}.virtual-spacer.svelte-t28wkk{position:relative}@keyframes svelte-t28wkk-badgePop{0%{transform:scale(0);opacity:0}70%{transform:scale(1.15)}to{transform:scale(1);opacity:1}}@keyframes svelte-t28wkk-mergeSourcePulse{0%,to{border-color:var(--ai-primary);box-shadow:0 0 0 0 var(--ai-primary-shadow)}50%{border-color:var(--ai-gradient-accent);box-shadow:0 0 0 4px var(--ai-primary-shadow)}}@keyframes svelte-t28wkk-removeShake{0%,to{transform:translate(0)}20%{transform:translate(-2px)}40%{transform:translate(2px)}60%{transform:translate(-1.5px)}80%{transform:translate(1px)}}@keyframes svelte-t28wkk-confAvgPulse{0%,to{opacity:1}50%{opacity:.6}}@keyframes svelte-t28wkk-badgeShimmer{0%,to{transform:translate(-100%)}50%{transform:translate(100%)}}@media(prefers-reduced-motion:reduce){.category-group.svelte-t28wkk,.expand-btn.svelte-t28wkk,.expand-btn.expanded.svelte-t28wkk{transition:none}.conf-avg.low.svelte-t28wkk{animation:none}.badge-new.svelte-t28wkk:after{animation:none;display:none}.remove-btn.svelte-t28wkk svg{transition:none}.remove-btn.svelte-t28wkk:hover svg{transform:none}}.preview-toolbar.svelte-1wb2xl2{padding:10px 20px 12px;border-bottom:1px solid var(--ai-border-light)}.preview-stats.svelte-1wb2xl2{font-size:13px;font-weight:700;margin-bottom:8px}.preview-stats.svelte-1wb2xl2 strong:where(.svelte-1wb2xl2){color:var(--ai-primary);display:inline-block;transition:transform .25s cubic-bezier(.2,1.04,.42,1),color .2s}.search-wrap.svelte-1wb2xl2{position:relative;margin-bottom:8px}.search-wrap.svelte-1wb2xl2 .search-icon{position:absolute;left:10px;top:50%;transform:translateY(-50%);color:var(--ai-text-muted);pointer-events:none}.search-input.svelte-1wb2xl2{width:100%;padding:7px 10px 7px 30px;border-radius:8px;border:1.5px solid var(--ai-border);background:var(--ai-bg-secondary);color:var(--ai-text);font-size:12px;outline:none;box-sizing:border-box;transition:border-color .2s,box-shadow .3s cubic-bezier(.2,1,.4,1)}.search-input.svelte-1wb2xl2:focus{border-color:var(--ai-primary);box-shadow:0 0 0 3px var(--ai-primary-shadow)}.filter-row.svelte-1wb2xl2{display:flex;gap:6px;flex-wrap:wrap;margin-bottom:6px}.filter-row.svelte-1wb2xl2 .filter-btn:where(.svelte-1wb2xl2){animation:svelte-1wb2xl2-filterSlideIn .3s cubic-bezier(.2,.98,.28,1) both}.filter-row.svelte-1wb2xl2 .filter-btn:where(.svelte-1wb2xl2):nth-child(1){animation-delay:0s}.filter-row.svelte-1wb2xl2 .filter-btn:where(.svelte-1wb2xl2):nth-child(2){animation-delay:.04s}.filter-row.svelte-1wb2xl2 .filter-btn:where(.svelte-1wb2xl2):nth-child(3){animation-delay:.08s}.filter-row.svelte-1wb2xl2 .filter-btn:where(.svelte-1wb2xl2):nth-child(4){animation-delay:.12s}.filter-row.svelte-1wb2xl2 .filter-btn:where(.svelte-1wb2xl2):nth-child(5){animation-delay:.16s}.filter-btn.svelte-1wb2xl2{padding:4px 10px;font-size:11px;font-weight:600;border-radius:6px;border:1.5px solid var(--ai-border);background:var(--ai-border-lighter);color:var(--ai-text-muted);cursor:pointer;display:flex;align-items:center;gap:3px;transition:all .25s cubic-bezier(.2,1,.4,1)}.filter-btn.svelte-1wb2xl2:hover{border-color:var(--ai-primary-light);transform:translateY(-1px);box-shadow:inset 0 0 0 1px rgba(var(--ai-primary-rgb),.15),0 2px 6px #0000000f}.filter-btn.active.svelte-1wb2xl2{background:linear-gradient(135deg,var(--ai-primary),var(--ai-gradient-accent));color:#fff;border-color:transparent;transform:scale(1);box-shadow:0 2px 8px var(--ai-primary-shadow);position:relative;animation:svelte-1wb2xl2-filterActivateBounce .35s cubic-bezier(.34,1.56,.64,1)}.merge-btn.active.svelte-1wb2xl2 svg{transform:rotate(180deg);transition:transform .35s cubic-bezier(.2,1.04,.42,1)}.merge-btn.svelte-1wb2xl2 svg{transition:transform .35s cubic-bezier(.2,1.04,.42,1)}.filter-btn.active.svelte-1wb2xl2:after{content:"";position:absolute;bottom:-1px;left:15%;width:70%;height:2px;background:#fff;border-radius:1px;animation:svelte-1wb2xl2-tabUnderline .3s cubic-bezier(.2,.98,.28,1) both}.search-wrap.svelte-1wb2xl2 .search-icon{transition:color .25s ease,opacity .25s ease}.search-wrap.svelte-1wb2xl2:has(.search-input:where(.svelte-1wb2xl2):not(:placeholder-shown)) .search-icon{color:var(--ai-primary);opacity:1}.filter-count.svelte-1wb2xl2{font-size:11px;color:var(--ai-text-muted);animation:svelte-1wb2xl2-countPop .4s cubic-bezier(.2,1.2,.4,1) both;transition:color .2s ease,transform .2s cubic-bezier(.2,.98,.28,1)}.filter-count.svelte-1wb2xl2:hover{color:var(--ai-primary);transform:scale(1.08)}@keyframes svelte-1wb2xl2-tabUnderline{0%{transform:scaleX(0)}to{transform:scaleX(1)}}@keyframes svelte-1wb2xl2-countPop{0%{transform:scale(.8);opacity:0}70%{transform:scale(1.08)}to{transform:scale(1);opacity:1}}@keyframes svelte-1wb2xl2-filterActivateBounce{0%{transform:scale(.92);box-shadow:0 0 rgba(var(--ai-primary-rgb),.4)}60%{transform:scale(1.06);box-shadow:0 0 0 6px rgba(var(--ai-primary-rgb),.1)}to{transform:scale(1);box-shadow:0 2px 8px var(--ai-primary-shadow)}}@keyframes svelte-1wb2xl2-filterSlideIn{0%{opacity:0;transform:translateY(6px) scale(.92)}to{opacity:1;transform:translateY(0) scale(1)}}@media(prefers-reduced-motion:reduce){.filter-btn.active.svelte-1wb2xl2:after{animation:none}.filter-btn.active.svelte-1wb2xl2{animation:none;transform:none}.filter-count.svelte-1wb2xl2{animation:none;transition:none}.filter-count.svelte-1wb2xl2:hover{transform:none}.filter-row.svelte-1wb2xl2 .filter-btn:where(.svelte-1wb2xl2){animation:none}}.lightbox-overlay.svelte-10n7vm8{position:fixed;top:0;right:0;bottom:0;left:0;z-index:2147483645;background:#000000d9;display:flex;align-items:center;justify-content:center;cursor:zoom-out;-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);animation:svelte-10n7vm8-lightboxIn .25s ease both}.lightbox-img.svelte-10n7vm8{max-width:90vw;max-height:85vh;border-radius:12px;box-shadow:0 20px 60px #00000080;animation:svelte-10n7vm8-lightboxZoom .3s cubic-bezier(.2,.98,.28,1) both}@keyframes svelte-10n7vm8-lightboxIn{0%{opacity:0}to{opacity:1}}@keyframes svelte-10n7vm8-lightboxZoom{0%{transform:scale(.7);opacity:0}to{transform:scale(1);opacity:1}}.lightbox-overlay.closing.svelte-10n7vm8{animation:svelte-10n7vm8-lightboxOut .25s ease both}.lightbox-overlay.closing.svelte-10n7vm8 .lightbox-img:where(.svelte-10n7vm8){animation:svelte-10n7vm8-lightboxZoomOut .25s ease both}@keyframes svelte-10n7vm8-lightboxOut{0%{opacity:1}to{opacity:0}}@keyframes svelte-10n7vm8-lightboxZoomOut{0%{transform:scale(1);opacity:1}to{transform:scale(.8);opacity:0}}.preview-content.svelte-10n7vm8{padding:8px 20px 12px}.category-list.svelte-10n7vm8{display:flex;flex-direction:column;gap:10px;overflow-y:auto}.footer-custom.svelte-10n7vm8{display:flex;justify-content:space-between;align-items:center;width:100%;gap:12px}.footer-custom.svelte-10n7vm8 .modal-btn.confirm:where(.svelte-10n7vm8){flex:1;padding:11px;border:none;border-radius:10px;font-size:14px;font-weight:700;cursor:pointer;background:linear-gradient(135deg,var(--ai-success-dark),var(--ai-success),var(--ai-success-light));color:#fff;transition:all .35s cubic-bezier(.2,1.04,.42,1);display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden}.footer-custom.svelte-10n7vm8 .modal-btn.confirm:where(.svelte-10n7vm8):after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(105deg,transparent 40%,var(--ai-shimmer-color) 50%,transparent 60%);transform:translate(-100%);animation:svelte-10n7vm8-confirmShimmer 3s ease-in-out 1s infinite;pointer-events:none}@keyframes svelte-10n7vm8-confirmShimmer{0%,75%{transform:translate(-100%)}to{transform:translate(100%)}}.footer-custom.svelte-10n7vm8 .modal-btn.confirm:where(.svelte-10n7vm8):hover{transform:translateY(-2px) scale(1.015);box-shadow:0 10px 28px var(--ai-success-bg),0 0 0 3px #10b98126}.footer-custom.svelte-10n7vm8 .modal-btn.confirm:where(.svelte-10n7vm8):disabled{opacity:.4;cursor:not-allowed;transform:none;box-shadow:none}.footer-custom.svelte-10n7vm8 .modal-btn.confirm:where(.svelte-10n7vm8):disabled:after{animation:none}.footer-icons.svelte-10n7vm8{display:flex;gap:6px;flex-shrink:0}.icon-btn.svelte-10n7vm8{width:32px;height:32px;border-radius:8px;border:none;background:var(--ai-border-lighter);color:var(--ai-text-muted);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all .2s ease;position:relative;animation:svelte-10n7vm8-iconBtnSlideIn .3s cubic-bezier(.22,1.42,.29,1) backwards}.icon-btn.svelte-10n7vm8:nth-child(1){animation-delay:.05s}.icon-btn.svelte-10n7vm8:nth-child(2){animation-delay:.1s}.icon-btn.svelte-10n7vm8:nth-child(3){animation-delay:.15s}.icon-btn.svelte-10n7vm8:nth-child(4){animation-delay:.2s}@keyframes svelte-10n7vm8-iconBtnSlideIn{0%{opacity:0;transform:translateY(6px) scale(.8)}to{opacity:1;transform:translateY(0) scale(1)}}.icon-btn.svelte-10n7vm8:hover{background:var(--ai-bg-tertiary);color:var(--ai-text);transform:translateY(-2px);box-shadow:0 4px 12px #00000014}.icon-btn.svelte-10n7vm8:after{content:attr(data-tooltip);position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%) translateY(4px);background:var(--ai-text);color:var(--ai-bg);font-size:10px;white-space:nowrap;padding:3px 8px;border-radius:6px;pointer-events:none;opacity:0;transition:opacity .2s ease,transform .2s ease}.icon-btn.svelte-10n7vm8:hover:after{opacity:1;transform:translate(-50%) translateY(0)}.bfao-modal-empty.svelte-10n7vm8{animation:svelte-10n7vm8-emptyFloat 3s ease-in-out infinite,svelte-10n7vm8-emptyBreathe 4s ease-in-out infinite}@keyframes svelte-10n7vm8-emptyFloat{0%,to{transform:translateY(0)}50%{transform:translateY(-4px)}}@keyframes svelte-10n7vm8-emptyBreathe{0%,to{opacity:.5}50%{opacity:1}}@media(prefers-reduced-motion:reduce){.footer-custom.svelte-10n7vm8 .modal-btn.confirm:where(.svelte-10n7vm8):after{animation:none}.icon-btn.svelte-10n7vm8{animation:none;opacity:1}}.help-body.svelte-1lxq9cp{padding:0;max-height:60vh;overflow-y:auto;mask-image:linear-gradient(to bottom,transparent 0px,black 10px,black calc(100% - 10px),transparent 100%);-webkit-mask-image:linear-gradient(to bottom,transparent 0px,black 10px,black calc(100% - 10px),transparent 100%);counter-reset:faq-counter}.faq-item.svelte-1lxq9cp{width:100%;display:flex;align-items:center;justify-content:space-between;padding:8px 20px;border:none;border-bottom:1px solid var(--ai-border-light);border-left:3px solid transparent;background:none;cursor:pointer;transition:background .2s,padding-left .2s ease,border-left-color .2s ease;text-align:left}.faq-item.svelte-1lxq9cp:hover{background:var(--ai-bg-tertiary);padding-left:24px}.faq-item.open.svelte-1lxq9cp{border-left-color:var(--ai-primary);background:var(--ai-bg-secondary);padding-left:24px;box-shadow:var(--ai-shadow-inset)}.faq-q.svelte-1lxq9cp{display:flex;align-items:center;gap:10px;font-size:13px;font-weight:500;color:var(--ai-text)}.faq-item.svelte-1lxq9cp{counter-increment:faq-counter}.faq-icon.svelte-1lxq9cp{display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;border-radius:50%;background:var(--ai-error-bg, rgba(239, 68, 68, .1));color:var(--ai-error, #ef4444);font-size:11px;font-weight:700;flex-shrink:0;transition:transform .3s cubic-bezier(.2,.98,.28,1)}.faq-icon.svelte-1lxq9cp:before{content:counter(faq-counter)}.faq-item.open.svelte-1lxq9cp .faq-icon:where(.svelte-1lxq9cp){transform:rotateY(180deg);background:var(--ai-primary-bg);color:var(--ai-primary)}.faq-item.svelte-1lxq9cp:hover .faq-icon:where(.svelte-1lxq9cp):not(.pulse){transform:rotate(15deg) scale(1.1)}.faq-item.svelte-1lxq9cp .faq-chevron{color:var(--ai-text-muted);transition:transform .2s;flex-shrink:0}.faq-item.open.svelte-1lxq9cp .faq-chevron{transform:rotate(90deg)}.faq-a.svelte-1lxq9cp{padding:6px 20px 10px 50px;font-size:12px;line-height:1.6;color:var(--ai-text-secondary);background:var(--ai-bg-secondary);box-sizing:border-box;position:relative}.faq-item.open.svelte-1lxq9cp+.faq-a:where(.svelte-1lxq9cp){clip-path:inset(0 100% 0 0);animation:svelte-1lxq9cp-answerReveal .45s cubic-bezier(.2,.98,.28,1) .08s both}@keyframes svelte-1lxq9cp-answerReveal{0%{clip-path:inset(0 100% 0 0)}to{clip-path:inset(0 0 0 0)}}.faq-a.svelte-1lxq9cp:before{content:"";position:absolute;left:28px;top:0;bottom:0;width:2px;background:linear-gradient(to bottom,var(--ai-primary),transparent);border-radius:1px;transform:scaleY(0);transform-origin:top;animation:svelte-1lxq9cp-answerBar .35s cubic-bezier(.2,.98,.28,1) .1s both}@keyframes svelte-1lxq9cp-answerBar{0%{transform:scaleY(0)}to{transform:scaleY(1)}}.faq-icon.pulse.svelte-1lxq9cp{animation:svelte-1lxq9cp-iconPulse 1.5s ease-in-out infinite}@keyframes svelte-1lxq9cp-iconPulse{0%,to{box-shadow:0 0 #ef44444d}50%{box-shadow:0 0 0 5px #ef444400}}.help-footer.svelte-1lxq9cp{padding:12px 20px;font-size:11px;color:var(--ai-text-muted);text-align:center;animation:svelte-1lxq9cp-footerFadeIn .4s ease .6s both}.help-footer.svelte-1lxq9cp kbd:where(.svelte-1lxq9cp){display:inline-block;padding:1px 5px;font-size:10px;font-family:inherit;font-weight:600;color:var(--ai-primary);background:var(--ai-primary-bg);border:1px solid var(--ai-border-light);border-radius:4px;margin:0 1px;animation:svelte-1lxq9cp-kbdPop .3s cubic-bezier(.22,1.42,.29,1) both}.help-footer.svelte-1lxq9cp kbd:where(.svelte-1lxq9cp):nth-of-type(1){animation-delay:.7s}.help-footer.svelte-1lxq9cp kbd:where(.svelte-1lxq9cp):nth-of-type(2){animation-delay:.78s}.help-footer.svelte-1lxq9cp kbd:where(.svelte-1lxq9cp):nth-of-type(3){animation-delay:.86s}@keyframes svelte-1lxq9cp-kbdPop{0%{transform:scale(0);opacity:0}70%{transform:scale(1.15)}to{transform:scale(1);opacity:1}}@keyframes svelte-1lxq9cp-footerFadeIn{0%{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}@media(prefers-reduced-motion:reduce){.help-footer.svelte-1lxq9cp{animation:none;opacity:1}.help-footer.svelte-1lxq9cp kbd:where(.svelte-1lxq9cp){animation:none;opacity:1}.faq-icon.pulse.svelte-1lxq9cp{animation:none}.faq-item.svelte-1lxq9cp{transition:background .2s}.faq-item.svelte-1lxq9cp:hover{padding-left:20px}.faq-item.open.svelte-1lxq9cp{box-shadow:none}.faq-icon.svelte-1lxq9cp{transition:none}.faq-item.open.svelte-1lxq9cp .faq-icon:where(.svelte-1lxq9cp){transform:none}.faq-item.svelte-1lxq9cp:hover .faq-icon:where(.svelte-1lxq9cp):not(.pulse){transform:none}.faq-a.svelte-1lxq9cp{clip-path:none;animation:none}.faq-a.svelte-1lxq9cp:before{animation:none;transform:scaleY(1)}}.panel.svelte-6jyhgm{position:fixed;bottom:30px;left:30px;z-index:2147483641;width:min(400px,calc(100vw - 60px));display:flex;flex-direction:column;background:var(--ai-bg);color:var(--ai-text);box-shadow:var(--ai-shadow-lg);transition:box-shadow .5s ease;border-radius:28px;overflow:visible;will-change:transform,opacity;-webkit-backdrop-filter:blur(20px) saturate(1.2);backdrop-filter:blur(20px) saturate(1.2);border:1px solid transparent;animation:svelte-6jyhgm-panelBorderBreathe 8s ease-in-out infinite}.panel.svelte-6jyhgm:before{content:"";position:absolute;top:0;right:0;bottom:0;left:0;border-radius:inherit;background:radial-gradient(ellipse at 30% 20%,rgba(var(--ai-primary-rgb, 115, 100, 255),.06) 0%,transparent 60%),radial-gradient(ellipse at 70% 80%,rgba(155,89,246,.04) 0%,transparent 50%);transform:translateY(var(--parallax-y, 0px));pointer-events:none;z-index:0;will-change:transform}.panel-content.svelte-6jyhgm{position:relative;z-index:1;flex:1 1 0%;min-height:0;max-height:60vh;overflow-y:auto;overflow-x:hidden;overscroll-behavior:contain;border-bottom-left-radius:26px;border-bottom-right-radius:26px;mask-image:linear-gradient(to bottom,black 0%,black calc(100% - 12px),transparent 100%);-webkit-mask-image:linear-gradient(to bottom,black 0%,black calc(100% - 12px),transparent 100%);background:radial-gradient(circle at var(--glow-x, -100px) var(--glow-y, -100px),rgba(var(--ai-primary-rgb, 115, 100, 255),.04) 0%,transparent 50%)}.panel.svelte-6jyhgm .gsap-draggable{cursor:default}.scroll-indicator.svelte-6jyhgm{position:sticky;top:0;height:2px;min-height:2px;background:linear-gradient(90deg,var(--ai-primary),var(--ai-gradient-accent));border-radius:0 1px 1px 0;z-index:3;opacity:0;transform:scaleX(0);transform-origin:left;transition:opacity .35s ease,transform .35s cubic-bezier(.2,.98,.28,1),width .1s linear,box-shadow .3s ease;pointer-events:none;margin-bottom:-2px}.scroll-indicator.visible.svelte-6jyhgm{opacity:1;transform:scaleX(1);box-shadow:var(--ai-indicator-glow)}.settings-wrapper.svelte-6jyhgm{will-change:transform,opacity}.main-area.svelte-6jyhgm{padding:0 15px 15px}.main-area.svelte-6jyhgm>*{animation:svelte-6jyhgm-mainContentFadeIn .35s ease both}.main-area.svelte-6jyhgm>*:nth-child(1){animation-delay:.05s}.main-area.svelte-6jyhgm>*:nth-child(2){animation-delay:.1s}.main-area.svelte-6jyhgm>*:nth-child(3){animation-delay:.15s}.main-area.svelte-6jyhgm>*:nth-child(4){animation-delay:.2s}@keyframes svelte-6jyhgm-mainContentFadeIn{0%{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}.nebula-drift.svelte-6jyhgm{position:absolute;top:0;right:0;bottom:0;left:0;pointer-events:none;overflow:hidden;border-radius:inherit;z-index:0}.nebula-particle.svelte-6jyhgm{position:absolute;width:calc(3px + var(--i) * .5px);height:calc(3px + var(--i) * .5px);border-radius:50%;background:rgba(var(--ai-primary-rgb, 115, 100, 255),.12);box-shadow:0 0 6px rgba(var(--ai-primary-rgb, 115, 100, 255),.08);left:calc(10% + var(--i) * 10%);top:calc(15% + var(--i) * 8%);animation:svelte-6jyhgm-nebula-float calc(12s + var(--i) * 3s) ease-in-out calc(var(--i) * -2s) infinite alternate;opacity:calc(.3 + var(--scroll-alpha, 0) * .4);filter:blur(calc(var(--scroll-depth, 0) * 2px));transition:background .5s ease,box-shadow .5s ease,opacity .5s ease,filter .5s ease}@keyframes svelte-6jyhgm-panelBorderBreathe{0%,to{border-color:transparent}50%{border-color:rgba(var(--ai-primary-rgb, 115, 100, 255),.15)}}@keyframes svelte-6jyhgm-nebula-float{0%{transform:translate(0) scale(1)}33%{transform:translate(calc(8px - var(--i) * 2px),calc(-12px + var(--i) * 1.5px)) scale(1.1)}66%{transform:translate(calc(-6px + var(--i) * 1px),calc(8px - var(--i) * 1px)) scale(.9)}to{transform:translate(calc(4px - var(--i) * .5px),calc(-6px + var(--i) * .8px)) scale(1.05)}}@media(prefers-reduced-motion:reduce){.panel.svelte-6jyhgm{animation:none;border-color:transparent}.nebula-particle.svelte-6jyhgm{animation:none;filter:none}.scroll-indicator.svelte-6jyhgm{transition:none;transform:none}.scroll-indicator.visible.svelte-6jyhgm{transform:none;box-shadow:none}.main-area.svelte-6jyhgm>*{animation:none}}.toast-container.svelte-1ig2a9j{position:fixed;top:20px;right:20px;display:flex;flex-direction:column;gap:8px;pointer-events:none}.toast.svelte-1ig2a9j{pointer-events:auto;display:flex;align-items:center;gap:8px;padding:10px 16px;border-radius:14px;font-size:13px;font-weight:500;cursor:pointer;-webkit-backdrop-filter:blur(12px) saturate(1.3);backdrop-filter:blur(12px) saturate(1.3);border:1px solid rgba(255,255,255,.15);box-shadow:0 8px 32px #0000001f,0 2px 8px #0000000f;position:relative;overflow:hidden;max-width:340px;will-change:transform,opacity;transition:box-shadow .2s ease,transform .2s ease}.toast.svelte-1ig2a9j:hover{box-shadow:0 12px 40px #0000002e,0 4px 12px #0000001a;transform:scale(1.02);padding-right:28px}.toast.svelte-1ig2a9j:hover .toast-timer:where(.svelte-1ig2a9j){animation-play-state:paused}.toast.svelte-1ig2a9j:before{content:"\u23F8";position:absolute;top:2px;left:2px;width:16px;height:16px;border-radius:50%;background:#00000059;color:#fff;font-size:7px;display:flex;align-items:center;justify-content:center;opacity:0;transform:scale(.5);transition:opacity .2s ease,transform .2s ease;pointer-events:none;z-index:1}.toast.svelte-1ig2a9j:hover:before{opacity:1;transform:scale(1)}.toast-success.svelte-1ig2a9j{background:rgba(var(--ai-success-rgb),.9);color:#fff;border-left:3px solid var(--ai-success-light, #6ee7b7);animation:svelte-1ig2a9j-toastSuccessPulse 2s ease-in-out 1s infinite}@keyframes svelte-1ig2a9j-toastSuccessPulse{0%,to{filter:brightness(1)}50%{filter:brightness(1.06)}}.toast-error.svelte-1ig2a9j{background:rgba(var(--ai-error-alt-rgb),.9);color:#fff;border-left:3px solid var(--ai-error-hover, #fca5a5)}.toast-warning.svelte-1ig2a9j{background:rgba(var(--ai-warning-rgb),.9);color:#fff;border-left:3px solid var(--ai-warning, #fbbf24)}.toast-info.svelte-1ig2a9j{background:rgba(var(--ai-primary-rgb),.9);color:#fff;border-left:3px solid var(--ai-primary-light, #b0a8ff)}.toast.svelte-1ig2a9j:after{content:"\xD7";position:absolute;right:10px;top:50%;transform:translateY(-50%) scale(.8);font-size:14px;font-weight:700;opacity:0;transition:opacity .2s ease,transform .2s ease;pointer-events:none;color:#ffffffb3}.toast.svelte-1ig2a9j:hover:after{opacity:1;transform:translateY(-50%) scale(1)}.toast-icon.svelte-1ig2a9j{font-size:14px;flex-shrink:0;display:inline-block;transition:outline-offset .2s ease,outline-color .2s ease;border-radius:50%}.toast.svelte-1ig2a9j:hover .toast-icon:where(.svelte-1ig2a9j){outline:2px solid rgba(255,255,255,.15);outline-offset:3px}.toast-success.svelte-1ig2a9j .toast-icon:where(.svelte-1ig2a9j){animation:svelte-1ig2a9j-toastIconBounce .5s cubic-bezier(.2,1,.4,1) .3s both}.toast-error.svelte-1ig2a9j .toast-icon:where(.svelte-1ig2a9j){animation:svelte-1ig2a9j-toastIconShake .4s ease .3s both}.toast-warning.svelte-1ig2a9j .toast-icon:where(.svelte-1ig2a9j){animation:svelte-1ig2a9j-toastIconWobble .5s ease .3s both}.toast-info.svelte-1ig2a9j .toast-icon:where(.svelte-1ig2a9j){animation:svelte-1ig2a9j-toastIconPulse .5s cubic-bezier(.2,1,.4,1) .3s both}.toast-msg.svelte-1ig2a9j{flex:1;min-width:0;line-height:1.4;clip-path:inset(0 100% 0 0);animation:svelte-1ig2a9j-toastTextReveal .5s cubic-bezier(.2,.98,.28,1) .15s both}.toast-timer.svelte-1ig2a9j{position:absolute;bottom:0;left:0;height:2px;background:linear-gradient(90deg,#ffffffb3,#ffffff4d);animation:svelte-1ig2a9j-toast-timer linear forwards;border-radius:0 0 14px 14px;transition:opacity .2s ease;overflow:hidden}.toast-timer.svelte-1ig2a9j:after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(90deg,transparent 0%,var(--ai-timer-shimmer, rgba(255,255,255,.5)) 50%,transparent 100%);animation:svelte-1ig2a9j-timerShimmer 2s ease-in-out infinite;pointer-events:none}@keyframes svelte-1ig2a9j-toast-timer{0%{width:100%}to{width:0%}}@keyframes svelte-1ig2a9j-toastIconBounce{0%{transform:scale(0)}60%{transform:scale(1.3)}to{transform:scale(1)}}@keyframes svelte-1ig2a9j-toastIconShake{0%,to{transform:translate(0)}20%{transform:translate(-3px)}40%{transform:translate(3px)}60%{transform:translate(-2px)}80%{transform:translate(2px)}}@keyframes svelte-1ig2a9j-toastIconWobble{0%,to{transform:rotate(0)}25%{transform:rotate(-12deg)}50%{transform:rotate(8deg)}75%{transform:rotate(-4deg)}}@keyframes svelte-1ig2a9j-toastIconPulse{0%{transform:scale(.6);opacity:.4}50%{transform:scale(1.25);opacity:1}to{transform:scale(1);opacity:1}}@keyframes svelte-1ig2a9j-toastTextReveal{0%{clip-path:inset(0 100% 0 0)}to{clip-path:inset(0 0 0 0)}}@keyframes svelte-1ig2a9j-timerShimmer{0%{transform:translate(-100%)}to{transform:translate(100%)}}@media(prefers-reduced-motion:reduce){.toast.svelte-1ig2a9j{transition:none}.toast.svelte-1ig2a9j:hover{box-shadow:0 8px 32px #0000001f,0 2px 8px #0000000f;transform:none}.toast.svelte-1ig2a9j:before{display:none}.toast-success.svelte-1ig2a9j .toast-icon:where(.svelte-1ig2a9j),.toast-error.svelte-1ig2a9j .toast-icon:where(.svelte-1ig2a9j),.toast-warning.svelte-1ig2a9j .toast-icon:where(.svelte-1ig2a9j),.toast-info.svelte-1ig2a9j .toast-icon:where(.svelte-1ig2a9j){animation:none}.toast-timer.svelte-1ig2a9j:after{animation:none}.toast-msg.svelte-1ig2a9j{animation:none;clip-path:none}.toast-success.svelte-1ig2a9j{animation:none;filter:none}.toast.svelte-1ig2a9j:after{display:none}.toast.svelte-1ig2a9j:hover .toast-icon:where(.svelte-1ig2a9j){outline:none}}.bfao-app.svelte-1n46o8q{all:initial;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;position:fixed;top:0;right:0;bottom:0;left:0;pointer-events:none;z-index:2147483640}.bfao-app.svelte-1n46o8q ::selection{background:var(--ai-selection-bg);color:inherit}.bfao-app.svelte-1n46o8q *{pointer-events:auto}.cursor-spotlight.svelte-1n46o8q{position:fixed;width:300px;height:300px;border-radius:50%;background:radial-gradient(circle,rgba(var(--ai-primary-rgb, 115, 100, 255),.12) 0%,rgba(var(--ai-primary-rgb, 115, 100, 255),.05) 30%,transparent 65%);pointer-events:none;transform:translate(-50%,-50%);opacity:0;transition:opacity .3s ease,background .5s ease;z-index:2147483647;will-change:left,top} ');
...
scale: 0,
  ...
  delegate(["click"]);
  const formsCss = '.bfao-field{display:flex;flex-direction:column;gap:4px}.bfao-label{font-size:12px;color:var(--ai-text-secondary);font-weight:500;transition:color .25s ease,font-weight .25s ease,transform .25s cubic-bezier(.2,.98,.28,1)}.bfao-field:focus-within .bfao-label{color:var(--ai-primary);font-weight:600;transform:translate(2px)}.bfao-input,.bfao-select{padding:7px 10px;border:1.5px solid var(--ai-border);border-radius:8px;font-size:12px;outline:none;box-sizing:border-box;background:var(--ai-input-bg);color:var(--ai-text);transition:all .3s cubic-bezier(.2,.98,.28,1)}.bfao-input:hover:not(:focus),.bfao-select:hover:not(:focus){border-color:var(--ai-primary-light);transform:translateY(-.5px)}.bfao-input:focus,.bfao-select:focus{border-color:var(--ai-primary);box-shadow:0 0 0 3px var(--ai-primary-shadow);animation:focusRipple .4s cubic-bezier(.2,.98,.28,1)}@keyframes focusRipple{0%{box-shadow:0 0 0 0 var(--ai-focus-ripple)}50%{box-shadow:0 0 0 6px var(--ai-focus-ripple)}to{box-shadow:0 0 0 3px var(--ai-primary-shadow)}}textarea.bfao-input:focus{border-color:var(--ai-primary);box-shadow:0 0 0 3px var(--ai-primary-shadow),inset 0 0 0 .5px var(--ai-gradient-accent)}.bfao-input[type=number]:hover:not(:focus){box-shadow:var(--ai-shadow-inset)}.bfao-select{cursor:pointer;width:100%}.bfao-input-row{display:flex;gap:6px;align-items:center;position:relative}.bfao-input-row:after{content:"";position:absolute;bottom:0;left:10%;width:80%;height:1.5px;background:linear-gradient(90deg,transparent,var(--ai-primary),transparent);transform:scaleX(0);transition:transform .3s cubic-bezier(.2,.98,.28,1);pointer-events:none;border-radius:1px}.bfao-input-row:focus-within:after{transform:scaleX(1)}.bfao-input-flex{flex:1}.bfao-input-small{width:80px}.bfao-icon-btn{padding:6px;border:1.5px solid var(--ai-border);border-radius:8px;background:var(--ai-bg);color:var(--ai-text-secondary);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all .25s cubic-bezier(.2,.98,.28,1);flex-shrink:0;position:relative;overflow:visible}.bfao-icon-btn:hover{border-color:var(--ai-primary);color:var(--ai-primary);background:var(--ai-primary-bg);box-shadow:0 2px 8px var(--ai-primary-shadow)}.bfao-icon-btn:after{content:"";position:absolute;bottom:2px;left:20%;width:60%;height:1.5px;background:linear-gradient(90deg,var(--ai-primary),var(--ai-gradient-accent));border-radius:1px;transform:scaleX(0);transform-origin:center;transition:transform .25s cubic-bezier(.2,.98,.28,1);pointer-events:none}.bfao-icon-btn:hover:after{transform:scaleX(1)}.bfao-icon-btn:hover:not(:disabled) svg{transform:rotate(12deg) scale(1.05)}.bfao-icon-btn:disabled{opacity:.4;cursor:not-allowed;transform:none;filter:grayscale(.3);box-shadow:none;transition:opacity .3s ease,filter .3s ease,box-shadow .3s ease}.bfao-icon-btn:disabled:hover{transform:none;border-color:var(--ai-border);color:var(--ai-text-secondary)}.bfao-checkbox-label{display:flex;align-items:center;gap:8px;font-size:12px;color:var(--ai-text-secondary);cursor:pointer;-webkit-user-select:none;user-select:none}.bfao-checkbox-label input[type=checkbox]{accent-color:var(--ai-primary);width:15px;height:15px;cursor:pointer;transition:box-shadow .2s ease;border-radius:3px}.bfao-checkbox-label:hover input[type=checkbox]{box-shadow:0 0 0 4px rgba(var(--ai-primary-rgb),.18);transform:scale(1.05)}.bfao-checkbox-label input[type=checkbox]:hover{box-shadow:0 0 0 4px rgba(var(--ai-primary-rgb),.18)}.bfao-checkbox-label input[type=checkbox]:checked{animation:checkPop .25s cubic-bezier(.22,1.42,.29,1)}@keyframes checkPop{0%{transform:scale(1)}50%{transform:scale(1.2)}to{transform:scale(1)}}.bfao-input:disabled,.bfao-select:disabled{opacity:.5;cursor:not-allowed;filter:grayscale(.3);background:var(--ai-bg-tertiary)}.bfao-input::placeholder{color:var(--ai-text-muted);opacity:.6;transition:opacity .25s ease}.bfao-input:focus::placeholder{opacity:.3}.bfao-select:hover:not(:focus){background-position:right 8px center}.bfao-select:focus{background-position:right 6px center}@media(prefers-reduced-motion:reduce){.bfao-label{transition:none}.bfao-field:focus-within .bfao-label{transform:none}.bfao-input:hover:not(:focus),.bfao-select:hover:not(:focus){transform:none}.bfao-input-row:after{transition:none}.bfao-input:focus,.bfao-select:focus{animation:none}.bfao-icon-btn:hover{transform:none}.bfao-icon-btn:after{display:none}.bfao-icon-btn:hover:not(:disabled) svg{transform:none}.bfao-icon-btn:disabled{transition:none;filter:none}.bfao-checkbox-label input[type=checkbox]{transition:none}.bfao-checkbox-label:hover input[type=checkbox]{box-shadow:none;transform:none}.bfao-checkbox-label input[type=checkbox]:checked{animation:none}.bfao-input::placeholder{transition:none}.bfao-input:disabled,.bfao-select:disabled{filter:none}}';
  importCSS(formsCss);
  ...
  function SettingsGroup($$anchor, $$props) {
    ...
    function toggle() {
      ...
      if (shouldAnimate()) {
          ...
          if (h <= 0) {
            ...
            gsap.to(get(bodyEl), {
              ...
              onComplete: () => {
                ...
                const children = get(bodyEl).querySelectorAll(":scope > *");
        ...
        if (get(chevronEl)) {
          if (get(open)) {
            gsap.to(get(chevronEl), { rotation: 90, duration: 0.3, ease: EASINGS.velvetSpring });
          } else {
            gsap.to(get(chevronEl), {
              ...
              ease: "power2.in",
              onComplete: () => {
                gsap.to(get(chevronEl), { rotation: 0, duration: 0.25, ease: EASINGS.velvetSpring });
              }
            });
          }
        }
...
响应片段: ${snippet2}`));
  ...
  var root_5$8 = from_html(`<input class="model-search svelte-1rt0kwk" type="text" placeholder="搜索模型..."/>`);
  var root_6$5 = from_html(`<button> </button>`);
  var root_7$5 = from_html(`<div class="model-empty svelte-1rt0kwk">无匹配模型</div>`);
  ...
  var root_1$8 = from_html(`<option class="svelte-14s97jl"> </option>`);
  var root_2$c = from_html(`<a target="_blank" rel="noopener noreferrer" class="link-btn svelte-14s97jl" title="申请 API Key"><!></a>`);
  var root_3$b = from_html(`<div class="bfao-field field-slide-in svelte-14s97jl"><label class="bfao-label svelte-14s97jl" for="bfao-custom-url">API 地址</label> <input id="bfao-custom-url" class="bfao-input svelte-14s97jl" type="text" placeholder="https://your-api.com/v1"/></div>`);
  var root$e = from_html(`<div class="provider-config svelte-14s97jl"><div class="bfao-field svelte-14s97jl"><label class="bfao-label svelte-14s97jl" for="bfao-provider">AI 服务商</label> <div class="bfao-input-row svelte-14s97jl"><select id="bfao-provider" class="bfao-select svelte-14s97jl"></select> <!></div></div> <!> <div class="bfao-field svelte-14s97jl"><label class="bfao-label svelte-14s97jl" for="bfao-api-key">API Key</label> <div class="bfao-input-row svelte-14s97jl"><input id="bfao-api-key" class="bfao-input bfao-input-flex svelte-14s97jl"/> <button class="bfao-icon-btn svelte-14s97jl"><!></button></div></div> <!> <div class="bfao-field svelte-14s97jl"><label class="bfao-label svelte-14s97jl" for="bfao-concurrency">AI 并发数</label> <input id="bfao-concurrency" class="bfao-input bfao-input-small svelte-14s97jl" type="number" min="1" max="20"/></div></div>`);
  ...
  delegate(["click"]);
  var root_3$a = from_html(`<option class="svelte-182y78p"> </option>`);
  var root_4$a = from_html(`<option class="svelte-182y78p"> </option>`);
  var root_5$7 = from_html(`<input class="bfao-input bfao-input-small sub-field-slide svelte-182y78p" type="number" min="10" max="5000"/>`);
  var root_2$b = from_html(`<div class="field-grid svelte-182y78p"><div class="bfao-field svelte-182y78p"><label class="bfao-label svelte-182y78p" for="bfao-chunk-size">AI 批次大小</label> <input id="bfao-chunk-size" class="bfao-input svelte-182y78p" type="number" min="1" max="9999" list="bfao-chunk-presets"/> <datalist id="bfao-chunk-presets" class="svelte-182y78p"></datalist></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label svelte-182y78p" for="bfao-fetch-delay">请求速度</label> <select id="bfao-fetch-delay" class="bfao-select svelte-182y78p"></select></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label svelte-182y78p" for="bfao-write-delay">写操作间隔 (ms)</label> <input id="bfao-write-delay" class="bfao-input svelte-182y78p" type="number" min="500" max="10000" step="100"/></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label svelte-182y78p" for="bfao-move-chunk">每次移动视频数</label> <input id="bfao-move-chunk" class="bfao-input svelte-182y78p" type="number" min="1" max="100"/></div> <div class="bfao-field full svelte-182y78p"><label class="bfao-checkbox-label svelte-182y78p"><input type="checkbox" class="svelte-182y78p"/> <span class="svelte-182y78p">限制处理数量</span></label> <!></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label svelte-182y78p" for="bfao-rest-interval">批量休息间隔</label> <select id="bfao-rest-interval" class="bfao-select svelte-182y78p"><option class="svelte-182y78p">50次</option><option class="svelte-182y78p">80次</option><option class="svelte-182y78p">100次</option><option class="svelte-182y78p">150次</option><option class="svelte-182y78p">200次</option><option class="svelte-182y78p">300次</option></select></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label svelte-182y78p" for="bfao-rest-minutes">休息时长 (分)</label> <select id="bfao-rest-minutes" class="bfao-select svelte-182y78p"><option class="svelte-182y78p">0.5分钟</option><option class="svelte-182y78p">1分钟</option><option class="svelte-182y78p">1.5分钟</option><option class="svelte-182y78p">2分钟</option><option class="svelte-182y78p">3分钟</option><option class="svelte-182y78p">5分钟</option></select></div></div>`);
  var root_7$4 = from_html(`<div class="sub-field sub-field-slide svelte-182y78p"><label class="bfao-label svelte-182y78p" for="bfao-cache-interval">缓存间隔 (分)</label> <select id="bfao-cache-interval" class="bfao-select bfao-input-small svelte-182y78p"><option class="svelte-182y78p">5</option><option class="svelte-182y78p">15</option><option class="svelte-182y78p">30</option><option class="svelte-182y78p">60</option></select></div>`);
  ...
  var root_5$6 = from_html(`<div class="manager-section svelte-avw5xh">自定义</div> <!>`, 1);
  ...
  var root_7$3 = from_html(`<div class="custom-preset-row svelte-avw5xh"><button> </button> <!></div>`);
  ...
  function PromptEditor($$anchor, $$props) {
    ...
    Save(node_2, { size: 12 });
    action(button, ($$node) => pressEffect == null ? void 0 : pressEffect($$node));
    action(button, ($$node) => ripple == null ? void 0 : ripple($$node));
    var button_1 = sibling(button, 2);
...
life: 0,
  ...
  function Modal($$anchor, $$props) {
    ...
    function updateScrollFade() {
      ...
      if (get(modalEl)) {
        get(modalEl).style.setProperty("--modal-scroll-depth", String(get(scrollProgress)));
      }
    }
    onMount(() => {
      ctx = gsap.context(() => {
  ...
  var root_5$5 = from_html(`<div class="bfao-modal-more svelte-jk545l"> </div>`);
  var root_3$8 = from_html(`<div class="folder-group svelte-jk545l"><div class="folder-header svelte-jk545l"> </div> <!> <!></div>`);
  var root_2$7 = from_html(`<div class="bfao-modal-body svelte-jk545l"><div class="bfao-modal-summary svelte-jk545l">发现 <strong class="svelte-jk545l"> </strong> 个失效视频，分布在 <strong class="svelte-jk545l"> </strong> 个收藏夹中</div> <div class="folder-list svelte-jk545l"></div> <div class="bfao-action-bar svelte-jk545l"><button class="bfao-btn bfao-btn-primary svelte-jk545l"><!> </button> <button class="bfao-btn bfao-btn-danger svelte-jk545l"><!> </button> <span class="bfao-modal-hint svelte-jk545l">移动到专用收藏夹便于日后查看；删除不可撤销</span></div></div>`);
  ...
  var root_4$6 = from_html(`<div class="bfao-modal-more svelte-xs3gcd"> </div>`);
  var root_2$6 = from_html(`<div class="bfao-modal-body svelte-xs3gcd"><div class="bfao-modal-summary svelte-xs3gcd">发现 <strong class="svelte-xs3gcd"> </strong> 个重复视频</div> <div class="dup-list svelte-xs3gcd"><!> <!></div> <div class="bfao-action-bar svelte-xs3gcd"><button class="bfao-btn bfao-btn-primary svelte-xs3gcd"> </button> <span class="bfao-modal-hint svelte-xs3gcd">保留首次出现的收藏夹，从其他收藏夹删除副本</span></div></div>`);
    ...
    let showCount = user_derived(() => Math.min($$props.duplicates.length, 50));
    {
      ...
      Modal($$anchor, {
        ...
        children: ($$anchor2, $$slotProps) => {
          ...
          each(node, 17, () => $$props.duplicates.slice(0, get(showCount)), index, ($$anchor3, d, i) => {
            var div_3 = root_3$7();
            set_style(div_3, `--idx: ${i}`);
            var div_4 = child(div_3);
  ...
  var root_5$4 = from_html(`<label><input type="radio" class="svelte-1237wle"/> <div class="item-info svelte-1237wle"><div class="item-time svelte-1237wle"> </div> <div class="item-detail svelte-1237wle"> </div></div></label>`);
  var root_4$5 = from_html(`<div class="hint svelte-1237wle">选择要撤销的操作，撤销将把所有视频移回原收藏夹：</div> <div></div>`, 1);
          ...
          var node = child(div);
          {
            ...
            var alternate = ($$anchor3) => {
              ...
              each(div_2, 21, () => $$props.history, index, ($$anchor4, record, i) => {
                ...
                template_effect(() => {
                  classes_1 = set_class(label, 1, "bfao-selectable-item svelte-1237wle", null, classes_1, { selected: get(selectedIndex) === i });
              ...
              template_effect(() => classes = set_class(div_2, 1, "history-list svelte-1237wle", null, classes, { processing: processing() }));
  ...
  var root_7$2 = from_html(`<div class="timeline-cats svelte-qj4dz7"> </div>`);
  ...
  var root_5$3 = from_html(`<div class="timeline svelte-qj4dz7"></div>`);
  ...
  var root_9 = from_html(`<div class="folder-breakdown svelte-l1lb8j"><div class="section-title svelte-l1lb8j"><span class="pulse-dot svelte-l1lb8j" aria-hidden="true"></span>收藏夹分布</div> <!></div>`);
  var root_4$3 = from_html(`<div class="bfao-modal-body svelte-l1lb8j"><!> <div class="stats-grid svelte-l1lb8j"><div class="stat-card svelte-l1lb8j"><span class="card-shimmer svelte-l1lb8j" aria-hidden="true"></span> <div class="stat-value svelte-l1lb8j"> </div> <div class="stat-label svelte-l1lb8j">收藏夹</div></div> <div class="stat-card svelte-l1lb8j"><span class="card-shimmer svelte-l1lb8j" aria-hidden="true"></span> <div class="stat-value svelte-l1lb8j" data-locale="true"> </div> <div class="stat-label svelte-l1lb8j">视频总数</div></div> <div class="stat-card svelte-l1lb8j"><span class="card-shimmer svelte-l1lb8j" aria-hidden="true"></span> <div> </div> <div class="stat-label svelte-l1lb8j">失效视频</div></div> <div class="stat-card svelte-l1lb8j"><span class="card-shimmer svelte-l1lb8j" aria-hidden="true"></span> <div class="stat-value svelte-l1lb8j"> </div> <div class="stat-label svelte-l1lb8j">失效率</div></div></div> <!></div>`);
  function StatsDialog($$anchor, $$props) {
    push($$props, true);
    let mode = prop($$props, "mode", 3, "stats");
    let maxFolderCount = user_derived(() => $$props.folders.length > 0 ? Math.max(...$$props.folders.map((f) => f.media_count)) : 1);
          ...
          var node_4 = sibling(div_5, 2);
          {
            var consequent_4 = ($$anchor3) => {
              ...
              each(node_5, 17, () => $$props.folders, index, ($$anchor4, f) => {
                ...
                template_effect(() => {
                  styles_1 = set_style(div_15, "", styles_1, { "--ratio": get(f).media_count / get(maxFolderCount) });
  ...
  var root_7$1 = from_html(`<label><input type="checkbox" class="svelte-184y11r"/> <div class="folder-info svelte-184y11r"><div class="folder-title svelte-184y11r"> </div> <div class="folder-count svelte-184y11r"> </div></div></label>`);
  var root_2$3 = from_html(`<div class="selector-content svelte-184y11r"><div class="toolbar svelte-184y11r"><button class="toggle-all svelte-184y11r"><!></button> <span><!></span></div> <div class="folder-list svelte-184y11r"></div></div>`);
  function FolderSelector($$anchor, $$props) {
    ...
    let countEl = state(void 0);
    let prevSize = 0;
    user_effect(() => {
      const size = get(selected).size;
      if (get(countEl) && size !== prevSize) {
        get(countEl).classList.remove("bounce");
        void get(countEl).offsetWidth;
        get(countEl).classList.add("bounce");
        prevSize = size;
      }
    });
    {
      ...
      Modal($$anchor, {
        ...
        children: ($$anchor2, $$slotProps) => {
          ...
          var node_3 = child(span);
          {
            var consequent_1 = ($$anchor3) => {
              var text$1 = text();
              template_effect(() => set_text(text$1, `已选 ${get(selected).size ?? ""} / ${folders().length ?? ""}`));
              append($$anchor3, text$1);
            };
            var alternate_1 = ($$anchor3) => {
              var text_1 = text();
              template_effect(() => set_text(text_1, `共 ${folders().length ?? ""} 个收藏夹`));
              append($$anchor3, text_1);
            };
            if_block(node_3, ($$render) => {
              if (get(selected).size > 0) $$render(consequent_1);
              else $$render(alternate_1, -1);
            });
          }
          bind_this(span, ($$value) => set(countEl, $$value), () => get(countEl));
          var div_2 = sibling(div_1, 2);
          each(div_2, 21, folders, (folder) => folder.id, ($$anchor3, folder) => {
            ...
            template_effect(
              ($02, $1) => {
                classes_1 = set_class(label, 1, "bfao-selectable-item svelte-184y11r", null, classes_1, $02);
                set_checked(input, $1);
                set_text(text_2, get(folder).title);
                set_text(text_3, `${get(folder).media_count ?? ""} 个视频`);
              },
              [
          ...
          template_effect(() => classes = set_class(span, 1, "count svelte-184y11r", null, classes, { "has-selected": get(selected).size > 0 }));
  ...
  delegate(["input", "click"]);
  var root_3$1 = from_html(`<div class="footer-custom svelte-10n7vm8"><button class="modal-btn confirm svelte-10n7vm8"> </button> <div class="footer-icons svelte-10n7vm8"><button class="icon-btn svelte-10n7vm8" data-tooltip="复制到剪贴板" title="复制到剪贴板"><!></button> <button class="icon-btn svelte-10n7vm8" data-tooltip="下载 JSON" title="下载 JSON"><!></button> <button class="icon-btn svelte-10n7vm8" data-tooltip="导出 Markdown" title="导出 Markdown"><!></button> <button class="icon-btn svelte-10n7vm8" data-tooltip="取消" title="取消"><!></button></div></div>`);
  ...
  var root_7 = from_html(`<div><img class="lightbox-img svelte-10n7vm8" alt=""/></div>`);
  ...
  function PreviewConfirm($$anchor, $$props) {
    ...
    function openLightbox(src) {
      ...
      set(lightboxClosing, false);
    }
    function closeLightbox() {
      set(lightboxClosing, true);
      setTimeout(
        () => {
...
`);
    ...
    var node_7 = sibling(node, 2);
    {
      var consequent_1 = ($$anchor2) => {
        ...
        var img = child(div_5);
        template_effect(() => {
          classes = set_class(div_5, 1, "lightbox-overlay svelte-10n7vm8", null, classes, { closing: get(lightboxClosing) });
          set_attribute(img, "src", get(lightboxSrc));
        });
  ...
  var root_2$1 = from_html(`<div class="help-body svelte-1lxq9cp"><!> <div class="help-footer svelte-1lxq9cp">快捷键: <kbd class="svelte-1lxq9cp">Alt+B</kbd> 开关面板 · <kbd class="svelte-1lxq9cp">ESC</kbd> 关闭 · <kbd class="svelte-1lxq9cp">Ctrl+Enter</kbd> 开始</div></div>`);
...
${JSON.stringify(videoData)}`
  ...
  function Panel($$anchor, $$props) {
    ...
    function updateScrollIndicator() {
      ...
      set(scrollProgress, maxScroll > 0 ? scrollTop / maxScroll : 0, true);
      if (get(panelEl)) {
        get(panelEl).style.setProperty("--scroll-alpha", String(get(scrollProgress)));
        get(panelEl).style.setProperty("--scroll-depth", String(get(scrollProgress)));
      }
    }
  ...
  delegate(["click"]);
  const variablesCss = ".bfao-app{--ai-bg: #fff;--ai-bg-secondary: #f9f7ff;--ai-bg-tertiary: #f0eafa;--ai-bg-hover: rgba(115, 100, 255, .04);--ai-input-bg: #fff;--ai-text: #181233;--ai-text-secondary: #38305a;--ai-text-muted: #868199;--ai-border: #e4ddf5;--ai-border-light: #f0eafa;--ai-border-lighter: #f9f7ff;--ai-primary: #7364ff;--ai-primary-light: #b0a8ff;--ai-primary-bg: rgba(115, 100, 255, .06);--ai-primary-rgb: 115, 100, 255;--ai-primary-shadow: rgba(115, 100, 255, .12);--ai-gradient-accent: #9b59f6;--ai-success: #10b981;--ai-success-rgb: 16, 185, 129;--ai-success-dark: #059669;--ai-success-light: #34d399;--ai-success-lighter: #6ee7b7;--ai-success-bg: rgba(5, 150, 105, .1);--ai-error: #e74c3c;--ai-error-rgb: 231, 76, 60;--ai-error-alt: #f43f5e;--ai-error-alt-rgb: 244, 63, 94;--ai-error-hover: #ef5757;--ai-warning: #f59e0b;--ai-warning-rgb: 245, 158, 11;--ai-warning-dark: #d97706;--ai-warning-bg: rgba(217, 119, 6, .1);--ai-info: #818cf8;--ai-backdrop: rgba(24, 18, 51, .58);--ai-selection-bg: rgba(115, 100, 255, .2);--ai-shadow-md: 0 8px 32px rgba(0, 0, 0, .12);--ai-shadow-lg: 0 24px 68px rgba(0, 0, 0, .11), 0 10px 28px rgba(0, 0, 0, .07);--ai-shadow-modal: 0 44px 110px rgba(0, 0, 0, .2), 0 18px 44px rgba(0, 0, 0, .11);--ai-shadow-inset: inset 0 1px 3px rgba(0, 0, 0, .06);--ai-divider-gradient: linear-gradient(90deg, transparent, var(--ai-primary-light), transparent);--ai-pulse-spread-color: rgba(115, 100, 255, .35);--ai-glow-selected: inset 0 0 12px rgba(115, 100, 255, .08);--ai-glow-breath: 0 0 10px rgba(115, 100, 255, .12);--ai-glow-breath-strong: 0 0 18px rgba(115, 100, 255, .2);--ai-shimmer-color: rgba(255, 255, 255, .45);--ai-indicator-glow: 0 0 8px rgba(115, 100, 255, .25), 0 0 3px rgba(115, 100, 255, .15);--ai-timer-shimmer: rgba(255, 255, 255, .5);--ai-glow-danger: 0 0 14px rgba(231, 76, 60, .25), 0 0 4px rgba(231, 76, 60, .15);--ai-field-active-glow: inset 0 0 8px rgba(115, 100, 255, .06), 0 0 0 1px rgba(115, 100, 255, .08);--ai-glow-title: 0 0 20px rgba(255, 255, 255, .15);--ai-focus-ripple: rgba(115, 100, 255, .2);--ai-glow-icon-breath: 0 0 10px rgba(115, 100, 255, .2);--ai-danger-ambient: rgba(231, 76, 60, .08);--ai-glow-control-hover: 0 0 12px rgba(115, 100, 255, .15);--ai-border-active-glow: rgba(115, 100, 255, .35);--ai-glow-text-hover: 0 0 8px rgba(115, 100, 255, .2);--ai-shimmer-overlay: rgba(255, 255, 255, .08);--ai-glow-danger-text: 0 0 10px rgba(231, 76, 60, .25);--ai-stripe-overlay: rgba(255, 255, 255, .12);--ai-shadow-depth-scroll: 0 32px 80px rgba(0, 0, 0, .15);--ai-glow-active-row: 0 0 8px rgba(115, 100, 255, .1)}.bfao-app[data-theme=dark]{--ai-bg: #1a1130;--ai-bg-secondary: #221845;--ai-bg-tertiary: #2a1f50;--ai-bg-hover: rgba(115, 100, 255, .08);--ai-input-bg: #221845;--ai-text: #e8e4f0;--ai-text-secondary: #c4bdd5;--ai-text-muted: #8a82a0;--ai-border: #3d3260;--ai-border-light: #332a55;--ai-border-lighter: #2a1f50;--ai-primary: #8b7fff;--ai-primary-light: #a89eff;--ai-primary-bg: rgba(139, 127, 255, .1);--ai-primary-rgb: 139, 127, 255;--ai-primary-shadow: rgba(139, 127, 255, .2);--ai-gradient-accent: #a87bf5;--ai-success: #34d399;--ai-success-rgb: 52, 211, 153;--ai-success-dark: #10b981;--ai-success-light: #6ee7b7;--ai-success-lighter: #a7f3d0;--ai-success-bg: rgba(16, 185, 129, .15);--ai-error: #f87171;--ai-error-rgb: 248, 113, 113;--ai-error-alt: #fb7185;--ai-error-alt-rgb: 251, 113, 133;--ai-error-hover: #fca5a5;--ai-warning: #fbbf24;--ai-warning-rgb: 251, 191, 36;--ai-warning-dark: #f59e0b;--ai-warning-bg: rgba(245, 158, 11, .15);--ai-info: #a5b4fc;--ai-backdrop: rgba(10, 6, 20, .72);--ai-selection-bg: rgba(139, 127, 255, .3);--ai-shadow-md: 0 8px 32px rgba(0, 0, 0, .3);--ai-shadow-lg: 0 24px 68px rgba(0, 0, 0, .35), 0 10px 28px rgba(0, 0, 0, .2);--ai-shadow-modal: 0 44px 110px rgba(0, 0, 0, .5), 0 18px 44px rgba(0, 0, 0, .3);--ai-shadow-inset: inset 0 1px 3px rgba(0, 0, 0, .15);--ai-divider-gradient: linear-gradient(90deg, transparent, var(--ai-primary-light), transparent);--ai-pulse-spread-color: rgba(139, 127, 255, .4);--ai-glow-selected: inset 0 0 12px rgba(139, 127, 255, .12);--ai-glow-breath: 0 0 10px rgba(139, 127, 255, .18);--ai-glow-breath-strong: 0 0 18px rgba(139, 127, 255, .28);--ai-shimmer-color: rgba(255, 255, 255, .2);--ai-indicator-glow: 0 0 8px rgba(139, 127, 255, .35), 0 0 3px rgba(139, 127, 255, .2);--ai-timer-shimmer: rgba(255, 255, 255, .35);--ai-glow-danger: 0 0 14px rgba(248, 113, 113, .3), 0 0 4px rgba(248, 113, 113, .2);--ai-field-active-glow: inset 0 0 8px rgba(139, 127, 255, .1), 0 0 0 1px rgba(139, 127, 255, .12);--ai-glow-title: 0 0 20px rgba(255, 255, 255, .2);--ai-focus-ripple: rgba(139, 127, 255, .25);--ai-glow-icon-breath: 0 0 10px rgba(139, 127, 255, .3);--ai-danger-ambient: rgba(248, 113, 113, .12);--ai-glow-control-hover: 0 0 12px rgba(139, 127, 255, .22);--ai-border-active-glow: rgba(139, 127, 255, .45);--ai-glow-text-hover: 0 0 8px rgba(139, 127, 255, .3);--ai-shimmer-overlay: rgba(255, 255, 255, .05);--ai-glow-danger-text: 0 0 10px rgba(248, 113, 113, .35);--ai-stripe-overlay: rgba(255, 255, 255, .08);--ai-shadow-depth-scroll: 0 32px 80px rgba(0, 0, 0, .35);--ai-glow-active-row: 0 0 8px rgba(139, 127, 255, .15)}.bfao-app *::-webkit-scrollbar{width:0;height:0}.bfao-app *{scrollbar-width:none}.bfao-app[data-theme]{transition:background-color .3s ease,color .3s ease,border-color .3s ease}.bfao-app button:focus-visible,.bfao-app [role=button]:focus-visible{outline:2px solid var(--ai-primary);outline-offset:2px;animation:focusRingIn .2s cubic-bezier(.2,.98,.28,1) both}.bfao-app button:focus:not(:focus-visible),.bfao-app [role=button]:focus:not(:focus-visible){outline:none}@keyframes focusRingIn{0%{outline-offset:0px;outline-color:transparent}to{outline-offset:2px;outline-color:var(--ai-primary)}}@media(prefers-reduced-motion:reduce){.bfao-app[data-theme]{transition:none}.bfao-app button:focus-visible,.bfao-app [role=button]:focus-visible{animation:none}}";
  importCSS(variablesCss);
  const modalCss = '.bfao-modal-body{padding:16px 20px}.bfao-modal-summary{font-size:13px;font-weight:700;margin-bottom:12px}.bfao-modal-summary strong{color:var(--ai-primary);display:inline-block;animation:summaryPop .5s cubic-bezier(.22,1.42,.29,1) .3s both;text-shadow:0 0 12px rgba(var(--ai-primary-rgb),.25)}@keyframes summaryPop{0%{transform:scale(.5);opacity:0;filter:blur(4px)}60%{transform:scale(1.18);filter:blur(0px)}80%{transform:scale(.95)}to{transform:scale(1);opacity:1;filter:blur(0px)}}.bfao-modal-empty{text-align:center;color:var(--ai-text-muted);padding:32px 0 24px;font-size:13px;animation:emptyFadeIn .5s cubic-bezier(.2,.98,.28,1) both}.bfao-modal-empty:before{content:"😺";display:block;font-size:36px;margin-bottom:8px;animation:emptyCatBreath 2s ease-in-out infinite;filter:drop-shadow(0 2px 6px rgba(var(--ai-primary-rgb),.15))}@keyframes emptyFadeIn{0%{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}@keyframes emptyCatBreath{0%,to{transform:scale(1) translateY(0)}50%{transform:scale(1.08) translateY(-4px)}}.bfao-modal-more{font-size:10px;color:var(--ai-text-muted);padding:4px 0;animation:morePulse 2.5s ease-in-out infinite}@keyframes morePulse{0%,to{opacity:.6}50%{opacity:1}}.bfao-modal-hint{font-size:10px;color:var(--ai-text-muted);line-height:1.3;display:inline-block;animation:hintFadeUp .4s ease .3s both;position:relative}.bfao-modal-hint:after{content:"";position:absolute;bottom:-2px;left:0;width:100%;height:1px;background:var(--ai-divider-gradient);transform:scaleX(0);transform-origin:left;animation:hintLineExpand .5s cubic-bezier(.2,.98,.28,1) .6s both}@keyframes hintLineExpand{0%{transform:scaleX(0)}to{transform:scaleX(1)}}@keyframes hintFadeUp{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}.bfao-action-bar{display:flex;gap:8px;align-items:center;flex-wrap:wrap;position:relative;padding-top:12px}.bfao-action-bar:before{content:"";position:absolute;top:0;left:0;right:0;height:1px;background:var(--ai-divider-gradient);opacity:.5;transform:scaleX(0);animation:actionBarLine .4s cubic-bezier(.2,.98,.28,1) .2s both}@keyframes actionBarLine{0%{transform:scaleX(0)}to{transform:scaleX(1)}}.bfao-btn{padding:8px 14px;font-size:12px;font-weight:600;border:none;border-radius:8px;cursor:pointer;display:flex;align-items:center;gap:4px;transition:all .2s ease}.bfao-btn svg{transition:transform .2s cubic-bezier(.2,.98,.28,1)}.bfao-btn:hover:not(:disabled) svg{transform:translateY(-1px)}.bfao-btn:disabled{opacity:.5;cursor:not-allowed;filter:grayscale(.3);box-shadow:none;transition:opacity .3s ease,filter .3s ease,box-shadow .3s ease}.bfao-btn-primary{background:linear-gradient(135deg,var(--ai-primary),var(--ai-gradient-accent));color:#fff;position:relative;overflow:hidden}.bfao-btn-primary:hover:not(:disabled){box-shadow:0 4px 12px rgba(var(--ai-primary-rgb),.3)}.bfao-btn-primary:hover:not(:disabled):after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(105deg,transparent 35%,rgba(255,255,255,.2) 50%,transparent 65%);animation:btnShimmerSweep .6s ease-out both;pointer-events:none}@keyframes btnShimmerSweep{0%{transform:translate(-100%)}to{transform:translate(100%)}}.bfao-btn-primary:disabled{animation:processingGlow 2s ease-in-out infinite}@keyframes processingGlow{0%,to{box-shadow:0 0 rgba(var(--ai-primary-rgb),.1)}50%{box-shadow:0 0 12px 2px rgba(var(--ai-primary-rgb),.25)}}.bfao-btn-danger{background:var(--ai-error);color:#fff}.bfao-btn-danger:hover:not(:disabled){box-shadow:0 4px 12px rgba(var(--ai-error-rgb),.3);animation:dangerGlow 1.5s ease-in-out infinite}@keyframes dangerGlow{0%,to{box-shadow:0 4px 12px rgba(var(--ai-error-rgb),.3)}50%{box-shadow:var(--ai-glow-danger),0 4px 12px rgba(var(--ai-error-rgb),.3)}}.bfao-btn:active:not(:disabled){transform:scale(.95);transition-duration:.08s}.bfao-btn-muted{background:var(--ai-border-lighter);color:var(--ai-text-muted);font-size:12px}.bfao-btn-muted:hover{background:var(--ai-bg-tertiary);color:var(--ai-text-secondary);box-shadow:0 2px 8px rgba(var(--ai-primary-rgb),.06)}.bfao-selectable-item{display:flex;align-items:flex-start;gap:10px;padding:10px 12px;border:1.5px solid var(--ai-border);border-radius:10px;cursor:pointer;transition:all .2s ease;background:var(--ai-bg)}.bfao-selectable-item:hover{border-color:var(--ai-primary-light);transform:scale(1.005) translateY(-2px);box-shadow:0 6px 16px #0000000f,0 2px 6px rgba(var(--ai-primary-rgb),.08)}.bfao-selectable-item.selected{border-color:var(--ai-primary);background:var(--ai-bg-tertiary);box-shadow:var(--ai-glow-selected);animation:selectedGlow 2.5s ease-in-out infinite}@keyframes selectedGlow{0%,to{box-shadow:var(--ai-glow-selected)}50%{box-shadow:inset 0 0 18px rgba(var(--ai-primary-rgb),.12)}}@media(prefers-reduced-motion:reduce){.bfao-modal-empty{animation:none;opacity:1}.bfao-modal-empty:before{animation:none}.bfao-modal-summary strong{animation:none;opacity:1;transform:none;filter:none}.bfao-btn:disabled{transition:none;filter:none;animation:none}.bfao-modal-hint{animation:none;opacity:1}.bfao-modal-hint:after{animation:none;transform:scaleX(1)}.bfao-modal-more{animation:none;opacity:.6}.bfao-btn svg{transition:none}.bfao-action-bar:before{animation:none;transform:scaleX(1)}.bfao-selectable-item.selected{animation:none}.bfao-selectable-item:hover{transform:none;box-shadow:none}.bfao-btn-primary:hover:not(:disabled):after{animation:none;display:none}.bfao-btn-danger:hover:not(:disabled){animation:none}.bfao-btn:active:not(:disabled){transform:none}}';
  importCSS(modalCss);
