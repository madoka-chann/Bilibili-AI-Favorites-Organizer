...
响应片段: ${snippet2}`));
  ...
  var root_2$b = from_html(`<div class="field-grid svelte-182y78p"><div class="bfao-field svelte-182y78p"><label class="bfao-label" for="bfao-chunk-size">AI 批次大小</label> <input id="bfao-chunk-size" class="bfao-input" type="number" min="1" max="9999" list="bfao-chunk-presets"/> <datalist id="bfao-chunk-presets"></datalist></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label" for="bfao-fetch-delay">请求速度</label> <select id="bfao-fetch-delay" class="bfao-select"></select></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label" for="bfao-write-delay">写操作间隔 (ms)</label> <input id="bfao-write-delay" class="bfao-input" type="number" min="500" max="10000" step="100"/></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label" for="bfao-move-chunk">每次移动视频数</label> <input id="bfao-move-chunk" class="bfao-input" type="number" min="1" max="100"/></div> <div class="bfao-field full svelte-182y78p"><label class="bfao-checkbox-label"><input type="checkbox"/> <span>限制处理数量</span></label> <!></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label" for="bfao-rest-interval">批量休息间隔</label> <select id="bfao-rest-interval" class="bfao-select"><option>50次</option><option>80次</option><option>100次</option><option>150次</option><option>200次</option><option>300次</option></select></div> <div class="bfao-field svelte-182y78p"><label class="bfao-label" for="bfao-rest-minutes">休息时长 (分)</label> <select id="bfao-rest-minutes" class="bfao-select"><option>0.5分钟</option><option>1分钟</option><option>1.5分钟</option><option>2分钟</option><option>3分钟</option><option>5分钟</option></select></div></div>`);
  var root_7$4 = from_html(`<div class="sub-field sub-field-slide svelte-182y78p"><label class="bfao-label" for="bfao-cache-interval">缓存间隔 (分)</label> <select id="bfao-cache-interval" class="bfao-select bfao-input-small"><option>5</option><option>15</option><option>30</option><option>60</option></select></div>`);
